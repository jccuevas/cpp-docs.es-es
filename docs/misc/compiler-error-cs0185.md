...
'type' no es el tipo de referencia que requiere la instrucción lock  
 ...
 La instrucción [lock](../Topic/lock%20Statement%20\(C%23%20Reference\).md) solo puede evaluar tipos de referencia. Para obtener más información, consulte [Sincronización de subprocesos](../Topic/Thread%20Synchronization%20\(C%23%20and%20Visual%20Basic\).md) y [Tipos de referencia](../Topic/Reference%20Types%20\(C%23%20Reference\).md).  
