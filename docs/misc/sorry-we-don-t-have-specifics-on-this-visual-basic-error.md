...
Lo sentimos, pero no tenemos información específica acerca de este error.  Puede buscar en Internet el número de error y el texto del mensaje para encontrar más información.  También puede consultar a otros desarrolladores mediante uno de estos foros:  
 ...
 Proporciona un foro donde plantear preguntas y debate en general acerca del compilador y la sintaxis del lenguaje [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)].  
  
 [Interoperabilidad y actualización de Visual Basic](http://go.microsoft.com/fwlink/?LinkId=145966)  
 Proporciona un foro para preguntas y problemas referentes a la actualización de [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] y el uso de las características de interoperabilidad.  
  
 [IDE de Visual Basic](http://go.microsoft.com/fwlink/?LinkId=145971)  
 Proporciona un foro donde plantear preguntas sobre la forma de trabajar en el entorno de [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)].  
  
 [General de Visual Basic](http://go.microsoft.com/fwlink/?LinkId=145973)  
 Proporciona un foro donde plantear preguntas y problemas referentes a [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] que no se debaten en otros foros.  
  
 [StackOverflow](http://stackoverflow.com/questions/tagged/vb.net)  
 Ofrece un foro de preguntas y problemas con [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)].  
  
 Consulte también:  
 [Recursos adicionales para programadores de Visual Basic](../Topic/Additional%20Resources%20for%20Visual%20Basic%20Programmers.md)  
  
## Vea también  
 [Guía de programación en Visual Basic](../Topic/Visual%20Basic%20Programming%20Guide.md)   
 [Referencia de Visual Basic](../Topic/Reference%20\(Visual%20Basic\).md)