...
'variable': un campo no puede ser a la vez volátil y de solo lectura  
 ...
 El uso de las palabras claves [volatile](../Topic/volatile%20\(C%23%20Reference\).md) y [readonly](../Topic/readonly%20\(C%23%20Reference\).md) es mutuamente excluyente.  
