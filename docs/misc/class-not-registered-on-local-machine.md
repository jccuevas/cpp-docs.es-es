...
Normalmente se encuentra este error como resultado de un archivo dañado. Puede que necesite volver a instalar [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)].  
