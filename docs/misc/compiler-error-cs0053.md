...
Incoherencia de accesibilidad: el tipo de propiedad 'tipo' es menos accesible que la propiedad 'propiedad'  
 ...
 Una construcción pública debe devolver un objeto accesible públicamente. Para obtener más información, consulte [Modificadores de acceso](../Topic/Access%20Modifiers%20\(C%23%20Programming%20Guide\).md).  
