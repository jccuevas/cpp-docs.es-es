...
El lado derecho de una asignación de instrucción fixed puede no ser una expresión de conversión  
 ...
 Es posible que el lado derecho de una expresión [fixed](../Topic/fixed%20Statement%20\(C%23%20Reference\).md) no pueda usar una conversión. Para obtener más información, consulta [Código no seguro y punteros](../Topic/Unsafe%20Code%20and%20Pointers%20\(C%23%20Programming%20Guide\).md).  
