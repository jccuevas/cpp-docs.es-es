...
La palabra clave 'base' no está disponible en ningún método estático  
 ...
 La palabra clave [base](../Topic/base%20\(C%23%20Reference\).md) se usaba en un método [static](../Topic/static%20\(C%23%20Reference\).md).`base` solo se puede llamar en un constructor de instancia, un método de instancia o un descriptor de acceso de instancia.  
