...
La herramienta ALink, a la que llama el compilador [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)], notifica un error al generar el ensamblado. Una posible causa es que un ensamblado firmado hace referencia a un ensamblado no firmado.  
