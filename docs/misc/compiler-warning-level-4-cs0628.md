...
'member': nuevo miembro protegido declarado en la clase sealed  
 ...
 Una clase [sealed](../Topic/sealed%20\(C%23%20Reference\).md) no puede introducir un miembro [protected](../Topic/protected%20\(C%23%20Reference\).md) porque ninguna otra clase podría heredar de la clase `sealed` y usar el miembro `protected`.  
