...
'miembro': los miembros de la interfaz no pueden tener una definición  
 ...
 Los métodos que se declaran en una [interfaz](../Topic/interface%20\(C%23%20Reference\).md) debe implementarse en una clase que hereda de ella y no en la propia interfaz.  
