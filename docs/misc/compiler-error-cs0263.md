...
Las declaraciones parciales de 'tipo' no deben especificar clases base diferentes.  
 ...
 Al definir un tipo en declaraciones parciales, especifique los mismos tipos bases en cada una de las declaraciones parciales. Para obtener más información, consulta [Clases y métodos parciales](../Topic/Partial%20Classes%20and%20Methods%20\(C%23%20Programming%20Guide\).md).  
