...
No se puede especificar el atributo DefaultMember en un tipo que contenga un indizador  
 ...
 Si una clase u otro tipo especifica **System.Reflection.DefaultMemberAttribute**, no puede contener un indexador. Para obtener más información, vea [Propiedades](../Topic/Properties%20\(C%23%20Programming%20Guide\).md).  
