...
Los punteros y los búferes de tamaño fijo solo se pueden utilizar en un contexto no seguro  
 ...
 Solo se pueden usar punteros con la palabra clave [unsafe](../Topic/unsafe%20\(C%23%20Reference\).md). Para obtener más información, consulta [Código no seguro y punteros](../Topic/Unsafe%20Code%20and%20Pointers%20\(C%23%20Programming%20Guide\).md).  
