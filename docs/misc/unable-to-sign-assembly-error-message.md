...
El compilador de [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] llama a Assembly Linker \(Al.exe, también denominado Alink\) para generar un ensamblado con un manifiesto. El enlazador ha informado de un error al firmar el ensamblado después de su creación. Puede deberse a una clave no válida.  
