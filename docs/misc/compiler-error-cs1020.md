...
Se esperaba un operador binario sobrecargable  
 ...
 Se ha intentado definir una [sobrecarga de operador](../Topic/Overloadable%20Operators%20\(C%23%20Programming%20Guide\).md), pero el operador no era binario, que toma dos parámetros.  
