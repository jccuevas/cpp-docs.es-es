...
No se ha encontrado en un elemento `<Service>` el atributo de identificador necesario para todo servicio de inicio.  Por ejemplo:  
  
```  
<Service ID="{0000-0000-0000-00000000-000000000000}"/>  
```  
  
 Esto indica que el archivo de proyecto está dañado.  
...
-   Guarde el archivo de proyecto.  
     ...
     No se escribirá la sección defectuosa y no ocurrirá este error la próxima vez que abra el proyecto.  
