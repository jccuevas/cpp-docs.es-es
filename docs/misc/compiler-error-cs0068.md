...
'evento': el evento de una interfaz no puede tener un inicializador  
 ...
 Un evento de una interfaz no puede tener un inicializador. Para obtener más información, consulte [Interfaces](../Topic/Interfaces%20\(C%23%20Programming%20Guide\).md).  
