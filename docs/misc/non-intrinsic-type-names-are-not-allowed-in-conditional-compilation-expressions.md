...
La expresión de compilación condicional hace referencia a un tipo no intrínseco, pero se permiten solo tipos intrínsecos.  
 ...
 Para más información sobre el tipo intrínseco en [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)], vea [Resumen de tipos de datos](../Topic/Data%20Types%20Summary%20\(Visual%20Basic\).md).  
...
## Vea también  
 ...
 [Resumen de tipos de datos](../Topic/Data%20Types%20Summary%20\(Visual%20Basic\).md)