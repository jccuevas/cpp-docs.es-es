...
El comentario XML en 'construcción' tiene una etiqueta de parámetro duplicada para 'parámetro'.  
 ...
 Al usar la opción de compilador [\/doc](../Topic/-doc%20\(C%23%20Compiler%20Options\).md), se hallaron múltiples comentarios para el mismo parámetro de método. Quite una de las líneas duplicadas.  
