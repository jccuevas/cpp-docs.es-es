...
'clase' no implementa el miembro de interfaz 'miembro'.  
 ...
 Se derivó una [clase](../Topic/class%20\(C%23%20Reference\).md) de una [interfaz](../Topic/interface%20\(C%23%20Reference\).md), pero la clase no implementó uno o varios de los miembros de la interfaz. Una clase debe implementar todos los miembros de las interfaces de la que deriva, o bien se la debe declarar como `abstract`.  
