...
El delegado 'del' no toma argumentos 'number'  
 ...
 El número de argumentos pasados a una invocación [delegate](../Topic/delegate%20\(C%23%20Reference\).md) no coincide con el número de parámetros de la declaración de delegado.  
