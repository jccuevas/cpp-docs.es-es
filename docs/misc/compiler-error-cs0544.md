...
'property override': no se puede reemplazar porque 'non\-property' no es una propiedad  
 ...
 Se intentó reemplazar un tipo de datos que no era de propiedad como una [propiedad](../Topic/Properties%20\(C%23%20Programming%20Guide\).md), lo que no está permitido.  
