...
Este error suele producirse cuando un complemento provoca un error al intentar llamar a un controlador de eventos.  
  
### Para corregir este error  
  
1.  Haga clic en **Sí** para cerrar la aplicación e inténtelo de nuevo.  
