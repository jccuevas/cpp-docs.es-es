...
No se permiten restricciones en declaraciones no genéricas  
 ...
 La sintaxis encontrada solo puede usarse en una declaración genérica para aplicar restricciones al parámetro de tipo. Para obtener más información, consulte [Genéricos](../Topic/Generics%20\(C%23%20Programming%20Guide\).md).  
