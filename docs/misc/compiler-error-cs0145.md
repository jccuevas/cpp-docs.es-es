...
El campo const requiere que se proporcione un valor  
 ...
 Debe inicializar una variable [const](../Topic/const%20\(C%23%20Reference\).md). Para obtener más información, consulta [Constantes](../Topic/Constants%20\(C%23%20Programming%20Guide\).md).  
