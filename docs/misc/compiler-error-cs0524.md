...
'type': las interfaces no pueden declarar tipos  
 ...
 Una [interfaz](../Topic/interface%20\(C%23%20Reference\).md) no puede contener un tipo definido por el usuario; debe contener solo los métodos y las propiedades.  
