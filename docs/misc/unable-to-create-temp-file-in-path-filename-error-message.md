...
El compilador de [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] llama a Assembly Linker \(Al.exe, también denominado Alink\) para generar un ensamblado con un manifiesto. El vinculador notificó un error al crear un archivo o escribir un recurso en memoria en este. Podría tratarse de un problema de configuración.  
