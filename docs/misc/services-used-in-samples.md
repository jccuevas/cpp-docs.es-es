...
Los ejemplos incluidos en [!INCLUDE[vsipsdk](../mfc/includes/vsipsdk_md.md)] hace uso de muchos servicios.  La lista siguiente muestra varios servicios de uso general y ejemplos que los usan.  
...
|<xref:Microsoft.VisualStudio.Shell.Interop.SVsActivityLog>|[Cómo: utilizar el registro de actividad](../Topic/How%20to:%20Use%20the%20Activity%20Log.md)|  
...
## Vea también  
 [Lista de servicios disponibles](../Topic/List%20of%20Available%20Services.md)   
