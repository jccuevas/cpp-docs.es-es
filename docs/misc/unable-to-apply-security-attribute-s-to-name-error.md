...
3.  Si el error continúa, guarde el trabajo y reinicie [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)].  
  
4.  Si el error se vuelve a producir, reinstale [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)].  
