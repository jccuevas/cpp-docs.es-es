...
Un argumento out o ref debe ser una variable asignable.  
 ...
 Solo una variable puede pasarse como un parámetro [ref](../Topic/ref%20\(C%23%20Reference\).md) en una llamada al método. Un valor `ref` es similar a pasar un puntero.  
