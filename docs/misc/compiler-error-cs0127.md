...
Debido a que 'función' devuelve void, una palabra clave return no debe ir seguida de una expresión de objeto.  
 ...
 Un método con un tipo de valor devuelto [void](../Topic/void%20\(C%23%20Reference\).md) no puede devolver un valor. Para obtener más información, consulta [Métodos](../Topic/Methods%20\(C%23%20Programming%20Guide\).md).  
