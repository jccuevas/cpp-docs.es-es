...
Se especificó la opción del compilador con el valor `+` o `-`; estos valores no se admiten.  
 ...
 Para más información sobre las opciones del compilador y los valores que admiten, consulte [Opciones del compilador de Visual Basic, por orden alfabético](../Topic/Visual%20Basic%20Compiler%20Options%20Listed%20Alphabetically.md).  
...
## Vea también  
 [Opciones del compilador de Visual Basic, por orden alfabético](../Topic/Visual%20Basic%20Compiler%20Options%20Listed%20Alphabetically.md)