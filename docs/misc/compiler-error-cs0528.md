...
'interfaz\!' ya aparece en la lista de interfaces.  
 ...
 Una lista de herencia de interfaces incluye un duplicado. Una [interfaz](../Topic/interface%20\(C%23%20Reference\).md) solo puede especificarse una vez en la lista de herencia.  
