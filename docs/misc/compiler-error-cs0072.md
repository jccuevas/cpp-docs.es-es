...
'evento': no se puede invalidar; 'método' no es un evento.  
 ...
 Un [evento](../Topic/event%20\(C%23%20Reference\).md) solo puede reemplazar a otro evento. Para obtener más información, consulta [Eventos](../Topic/Events%20\(C%23%20Programming%20Guide\).md).  
