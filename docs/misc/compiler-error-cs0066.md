...
'evento': el evento debe ser de tipo delegado  
 ...
 La palabra clave event requiere un tipo [delegate](../Topic/delegate%20\(C%23%20Reference\).md). Para obtener más información, vea [Eventos](../Topic/Events%20\(C%23%20Programming%20Guide\).md) y [Delegados](../Topic/Delegates%20\(C%23%20Programming%20Guide\).md).  
