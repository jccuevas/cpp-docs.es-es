...
Se esperaba disable o restore  
 ...
 Este error se produce si una cláusula de advertencia \#pragma tiene un formato incorrecto, por ejemplo, si se omitió disable o restore. Para más información, vea el tema [\#pragma warning](../Topic/%23pragma%20warning%20\(C%23%20Reference\).md).  
