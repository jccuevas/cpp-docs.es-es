...
ms.locfileid: "78215487"
---
# <a name="x86-intrinsics-list"></a>Lista de intrínsecos de x86

En este documento se enumeran los intrínsecos queC++ admite el compilador de Microsoft C/cuando el destino es x86.
...
|Nombre de función intrínseca|Tecnología|Encabezado|Prototipo de función|
|--------------------|----------------|------------|------------------------|
...
|_m_to_float|3DNOW|intrin.h|_m_to_float flotante (\__m64)|
