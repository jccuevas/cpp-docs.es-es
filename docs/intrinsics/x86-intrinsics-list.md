---
title: "x86 lista de intrínsecos | Documentos de Microsoft"
ms.custom: 
ms.date: 1/02/2018
ms.reviewer: 
ms.suite: 
...
- [Intel Architecture Instruction Set Extensions Programming Reference (Referencia de programación de extensiones de conjuntos de instrucciones de arquitectura Intel)](http://go.microsoft.com/fwlink/p/?LinkId=506627)
...
|[_InterlockedAddLargeStatistic](../intrinsics/interlockedaddlargestatistic.md)||intrin.h|_InterlockedAddLargeStatistic largo (\__int64 volatile *, long)|
