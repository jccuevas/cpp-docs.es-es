...
ms.locfileid: "59982400"
---
# <a name="x86-intrinsics-list"></a>x86 lista de intrínsecos

Este documento enumeran las funciones intrínsecas que Microsoft C /C++ compilador admite cuando se destina x86.
...
|[__addfsbyte](addfsbyte-addfsword-addfsdword.md)||intrin.h|void __addfsbyte (char sin signo sin signo, long)|
|[__addfsdword](addfsbyte-addfsword-addfsdword.md)||intrin.h|void __addfsdword (long long sin signo, sin signo)|
|[__addfsword](addfsbyte-addfsword-addfsdword.md)||intrin.h|void __addfsword (corto sin signo sin signo, long)|
|[_AddressOfReturnAddress](addressofreturnaddress.md)||intrin.h|void \* _AddressOfReturnAddress(void)|
|[_andn_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_andn_u32)|BMI [1]|ammintrin.h|unsigned int _andn_u32 (unsigned int, int sin signo)|
...
|[_mm_monitor](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_monitor)|SSE3|intrin.h|void _mm_monitor (const void * sin signo de int, int sin signo)|
...
|[__readfsbyte](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|__readfsbyte(unsigned long) char sin signo|
|[__readfsdword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|__readfsdword(unsigned long) long sin signo|
|[__readfsword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|__readfsword(unsigned long) corto sin signo|
...
|[_udiv64](udiv64.md)||intrin.h|int sin signo \_udiv64 (unsigned \__int64, int sin signo, unsigned int \*)|
...
|[__writedr](writedr.md)||intrin.h|void __writedr (sin firmar, sin signo)|
|[__writeeflags](writeeflags.md)||intrin.h|void __writeeflags(unsigned)|
|[__writefsbyte](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void __writefsbyte (char sin signo sin signo, long)|
|[__writefsdword](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void __writefsdword (long long sin signo, sin signo)|
|[__writefsword](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void __writefsword (corto sin signo sin signo, long)|
