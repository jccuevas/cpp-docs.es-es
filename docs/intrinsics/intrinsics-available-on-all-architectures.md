...
ms.locfileid: "70217538"
---
# <a name="intrinsics-available-on-all-architectures"></a>Intrínsecos disponibles en todas las arquitecturas

El compiladorC++ de Microsoft c/y la biblioteca en tiempo de ejecución de c universal (UCRT) hacen que algunos intrínsecos estén disponibles en todas las arquitecturas.
...
## <a name="ucrt-intrinsics"></a>Intrínsecos UCRT
