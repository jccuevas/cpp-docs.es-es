...
ms.locfileid: "70217666"
---
# <a name="_interlockedexchangeadd-intrinsic-functions"></a>Funciones intrínsecas _InterlockedExchangeAdd

**Específicos de Microsoft**

Proporcione compatibilidad intrínseca del compilador para la función de [funciones intrínsecas](../intrinsics/interlockedexchangeadd-intrinsic-functions.md) de Win32 Windows SDK _InterlockedExchangeAdd.
...
*Addend*\
[in, out] Valor que se va a agregar a; reemplazado por el resultado de la suma.
...
Estas rutinas solo están disponibles como intrínsecos. Son intrínsecos incluso cuando se utiliza [/OI](../build/reference/oi-generate-intrinsic-functions.md) o [#pragma intrínseco](../preprocessor/intrinsic.md) . No es posible usar [#pragma función](../preprocessor/function-c-cpp.md) en estos intrínsecos.

## <a name="example"></a>Ejemplo

Para obtener un ejemplo de cómo usar `_InterlockedExchangeAdd`, vea [_InterlockedDecrement](../intrinsics/interlockeddecrement-intrinsic-functions.md).
