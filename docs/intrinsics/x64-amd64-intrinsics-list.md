...
- [Introducción a las extensiones de Vector avanzadas de Intel](https://go.microsoft.com/fwlink/p/?linkid=874961)

- [Guías para desarrolladores AMD, manuales y documentos ISA](https://go.microsoft.com/fwlink/p/?linkid=874958)
...
|--------------------|----------------|------------|------------------------|
|_addcarry_u16||intrin.h|unsigned char _addcarry_u16 (unsigned char c_in, src1 corto sin signo, src2 corto sin signo, entero corto sin signo \*suma)|
|[_addcarry_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u32)||intrin.h|unsigned char _addcarry_u32 (unsigned char c_in, src1 int sin signo, src2 unsigned int, int sin signo \*suma)|
|[_addcarry_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarry_u64)||intrin.h|unsigned char _addcarry_u64 (unsigned char c_in, unsigned \__int64 src1, unsigned \__int64 src2, unsigned \__int64 \*suma)|
|_addcarry_u8||intrin.h|unsigned char _addcarry_u8 (unsigned char c_in, src1 char sin signo, src2 char sin signo, char sin signo \*suma)|
|[_addcarryx_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u32)|ADX [2]|immintrin.h|unsigned char _addcarryx_u32 (unsigned char c_in, src1 int sin signo, src2 unsigned int, int sin signo \*suma)|
|[_addcarryx_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_addcarryx_u64)|ADX [2]|immintrin.h|unsigned char _addcarryx_u64 (unsigned char c_in, unsigned \__int64 src1, unsigned \__int64 src2, unsigned \__int64 \*suma)|
...
|[__addgsqword](../intrinsics/addgsbyte-addgsword-addgsdword-addgsqword.md)||intrin.h|void __addgsqword (unsigned long, unsigned \___int64)|
...
|[_BitScanForward](../intrinsics/bitscanforward-bitscanforward64.md)||intrin.h|BOOLEANO _BitScanForward (OUT ULONG\* máscara ULONG de índice, IN)|
|[_BitScanForward64](../intrinsics/bitscanforward-bitscanforward64.md)||intrin.h|BOOLEANO _BitScanForward64 (OUT ULONG\* máscara ULONG64 de índice, IN)|
|[_BitScanReverse](../intrinsics/bitscanreverse-bitscanreverse64.md)||intrin.h|BOOLEANO _BitScanReverse (OUT ULONG\* máscara ULONG de índice, IN)|
|[_BitScanReverse64](../intrinsics/bitscanreverse-bitscanreverse64.md)||intrin.h|BOOLEANO _BitScanReverse64 (OUT ULONG\* máscara ULONG64 de índice, IN)|
|[_bittest](../intrinsics/bittest-bittest64.md)||intrin.h|unsigned char _bittest (long const \*, long (b).|
|[_bittest64](../intrinsics/bittest-bittest64.md)||intrin.h|char sin signo _bittest64 (\__int64 const \*,\__int64 b).|
...
|[_bittestandcomplement64](../intrinsics/bittestandcomplement-bittestandcomplement64.md)||intrin.h|char sin signo _bittestandcomplement64 (\__int64 \*,\__int64 b).|
|[_bittestandreset](../intrinsics/bittestandreset-bittestandreset64.md)||intrin.h|unsigned char _bittestandreset (long \*, long (b).|
|[_bittestandreset64](../intrinsics/bittestandreset-bittestandreset64.md)||intrin.h|char sin signo _bittestandreset64 (\__int64 \*,\__int64 b).|
|[_bittestandset](../intrinsics/bittestandset-bittestandset64.md)||intrin.h|unsigned char _bittestandset (long \*, long (b).|
|[_bittestandset64](../intrinsics/bittestandset-bittestandset64.md)||intrin.h|char sin signo _bittestandset64 (\__int64 \*,\__int64 b).|
|_blcfill_u32|ABM [1]|ammintrin.h|unsigned int _blcfill_u32(unsigned int)|
|_blcfill_u64|ABM [1]|ammintrin.h|unsigned __int64 _blcfill_u64 (unsigned \___int64)|
|_blci_u32|ABM [1]|ammintrin.h|unsigned int _blci_u32(unsigned int)|
|_blci_u64|ABM [1]|ammintrin.h|unsigned __int64 _blci_u64 (unsigned \___int64)|
|_blcic_u32|ABM [1]|ammintrin.h|unsigned int _blcic_u32(unsigned int)|
|_blcic_u64|ABM [1]|ammintrin.h|unsigned __int64 _blcic_u64 (unsigned \___int64)|
|_blcmsk_u32|ABM [1]|ammintrin.h|unsigned int _blcmsk_u32(unsigned int)|
|_blcmsk_u64|ABM [1]|ammintrin.h|unsigned __int64 _blcmsk_u64 (unsigned \___int64)|
|_blcs_u32|ABM [1]|ammintrin.h|unsigned int _blcs_u32(unsigned int)|
|_blcs_u64|ABM [1]|ammintrin.h|unsigned __int64 _blcs_u64 (unsigned \___int64)|
|_blsfill_u32|ABM [1]|ammintrin.h|unsigned int _blsfill_u32(unsigned int)|
|_blsfill_u64|ABM [1]|ammintrin.h|unsigned __int64 _blsfill_u64 (unsigned \___int64)|
...
|[_blsi_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsi_u64)|BMI|ammintrin.h, immintrin.h|unsigned __int64 _blsi_u64 (unsigned \___int64)|
|_blsic_u32|ABM [1]|ammintrin.h|unsigned int _blsic_u32(unsigned int)|
|_blsic_u64|ABM [1]|ammintrin.h|unsigned __int64 _blsic_u64 (unsigned \___int64)|
...
|[_blsmsk_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsmsk_u64)|BMI|ammintrin.h, immintrin.h|unsigned __int64 _blsmsk_u64 (unsigned \___int64)|
...
|[_blsr_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_blsr_u64)|BMI|ammintrin.h, immintrin.h|unsigned __int64 _blsr_u64 (unsigned \___int64)|
...
|[__emulu](../intrinsics/emul-emulu.md)||intrin.h|__int64 sin signo [pascal/cdecl]\__emulu (unsigned int, int sin signo)|
...
|[__inbytestring](../intrinsics/inbytestring.md)||intrin.h|void __inbytestring (puerto short sin signo, unsigned char \*del búfer, unsigned long recuento)|
...
|[__indwordstring](../intrinsics/indwordstring.md)||intrin.h|void __indwordstring (unsigned short puerto, unsigned long \*del búfer, unsigned long recuento)|
...
|[_InterlockedAnd_HLEAcquire](../intrinsics/interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedAnd_HLEAcquire largo (long volatile \*, long)|
|[_InterlockedAnd_HLERelease](../intrinsics/interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedAnd_HLERelease largo (long volatile \*, long)|
|[_InterlockedAnd_np](../intrinsics/interlockedand-intrinsic-functions.md)||intrin.h|_InterlockedAnd_np largo (long \*, long)|
|[_InterlockedAnd16](../intrinsics/interlockedand-intrinsic-functions.md)||intrin.h|short _InterlockedAnd16 (short volatile \*, short)|
|[_InterlockedAnd16_np](../intrinsics/interlockedand-intrinsic-functions.md)||intrin.h|_InterlockedAnd16_np corto (short \*, short)|
|[_InterlockedAnd64](../intrinsics/interlockedand-intrinsic-functions.md)||intrin.h|__int64 _InterlockedAnd64 (\___int64 volatile \*,\___int64)|
|[_InterlockedAnd64_HLEAcquire](../intrinsics/interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedAnd64_HLEAcquire (\___int64 volatile \*,\___int64)|
|[_InterlockedAnd64_HLERelease](../intrinsics/interlockedand-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedAnd64_HLERelease (\___int64 volatile \*,\___int64)|
|[_InterlockedAnd64_np](../intrinsics/interlockedand-intrinsic-functions.md)||intrin.h|__int64 _InterlockedAnd64_np (\__int64 \*,\___int64)|
...
|[_interlockedbittestandreset64](../intrinsics/interlockedbittestandreset-intrinsic-functions.md)||intrin.h|char sin signo _interlockedbittestandreset64 (\__int64 \*,\__int64 b).|
|[_interlockedbittestandreset64_HLEAcquire](../intrinsics/interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|char sin signo _interlockedbittestandreset64_HLEAcquire (\__int64 \*,\__int64 b).|
|[_interlockedbittestandreset64_HLERelease](../intrinsics/interlockedbittestandreset-intrinsic-functions.md)|HLE [2]|immintrin.h|char sin signo _interlockedbittestandreset64_HLERelease (\__int64 \*,\__int64 b).|
...
|[_interlockedbittestandset64](../intrinsics/interlockedbittestandset-intrinsic-functions.md)||intrin.h|char sin signo _interlockedbittestandset64 (\__int64 \*,\__int64 b).|
|[_interlockedbittestandset64_HLEAcquire](../intrinsics/interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|char sin signo _interlockedbittestandset64_HLEAcquire (\__int64 \*,\__int64 b).|
|[_interlockedbittestandset64_HLERelease](../intrinsics/interlockedbittestandset-intrinsic-functions.md)|HLE [2]|immintrin.h|char sin signo _interlockedbittestandset64_HLERelease (\__int64 \*,\__int64 b).|
|[_InterlockedCompareExchange](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|_InterlockedCompareExchange largo (long volatile \*, long, long)|
|[_InterlockedCompareExchange_HLEAcquire](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedCompareExchange_HLEAcquire largo (long volatile \*, long, long)|
|[_InterlockedCompareExchange_HLERelease](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedCompareExchange_HLERelease largo (long volatile \*, long, long)|
|[_InterlockedCompareExchange_np](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|_InterlockedCompareExchange_np largo (long \*, long, long)|
|[_InterlockedCompareExchange128](../intrinsics/interlockedcompareexchange128.md)||intrin.h|_InterlockedCompareExchange128 char sin signo (\___int64 volatile \*,\__int64,\__int64,\__int64\*)|
|[_InterlockedCompareExchange128_np](../intrinsics/interlockedcompareexchange128.md)||intrin.h|_InterlockedCompareExchange128 char sin signo (\___int64 volatile \*,\__int64,\__int64,\__int64\*)|
|[_InterlockedCompareExchange16](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|_InterlockedCompareExchange16 corto (short volatile \*destino, Exchange short, short Comparand)|
|[_InterlockedCompareExchange16_np](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|_InterlockedCompareExchange16_np corto (short volatile \*destino, Exchange short, short Comparand)|
|[_InterlockedCompareExchange64](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|__int64 _InterlockedCompareExchange64 (\___int64 volatile \*,\__int64,\___int64)|
|[_InterlockedCompareExchange64_HLEAcquire](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedCompareExchange64_HLEAcquire (\___int64 volatile \*,\__int64,\___int64)|
|[_InterlockedCompareExchange64_HLERelease](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedCompareExchange64_HLERelease (\___int64 volatile \*,\__int64,\___int64)|
|[_InterlockedCompareExchange64_np](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|__int64 _InterlockedCompareExchange64_np (\__int64 \*,\__int64,\___int64)|
|[_InterlockedCompareExchange8](../intrinsics/interlockedcompareexchange-intrinsic-functions.md)||intrin.h|Char _InterlockedCompareExchange8 (volátil char \*Comparand de char de destino, Exchange, char)|
|[_InterlockedCompareExchangePointer](../intrinsics/interlockedcompareexchangepointer-intrinsic-functions.md)||intrin.h|void \*_InterlockedCompareExchangePointer (void \*volátil \*, void \*, void \*)|
|[_InterlockedCompareExchangePointer_HLEAcquire](../intrinsics/interlockedcompareexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|void * _InterlockedCompareExchangePointer_HLEAcquire (void \*volátil \*, void \*, void \*)|
|[_InterlockedCompareExchangePointer_HLERelease](../intrinsics/interlockedcompareexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|void * _InterlockedCompareExchangePointer_HLERelease (void \*volátil \*, void \*, void \*)|
...
|[_InterlockedDecrement](../intrinsics/interlockeddecrement-intrinsic-functions.md)||intrin.h|_InterlockedDecrement largo (long volatile \*)|
|[_InterlockedDecrement16](../intrinsics/interlockeddecrement-intrinsic-functions.md)||intrin.h|_InterlockedDecrement16 corto (short volatile \*sumando)|
|[_InterlockedDecrement64](../intrinsics/interlockeddecrement-intrinsic-functions.md)||intrin.h|__int64 _InterlockedDecrement64 (\___int64 volatile \*)|
|[_InterlockedExchange](../intrinsics/interlockedexchange-intrinsic-functions.md)||intrin.h|_InterlockedExchange largo (long volatile \*, long)|
|[_InterlockedExchange_HLEAcquire](../intrinsics/interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedExchange_HLEAcquire largo (long volatile \*, long)|
|[_InterlockedExchange_HLERelease](../intrinsics/interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedExchange_HLERelease largo (long volatile \*, long)|
|[_InterlockedExchange16](../intrinsics/interlockedexchange-intrinsic-functions.md)||intrin.h|_InterlockedExchange16 corto (short volatile \*, short)|
|[_InterlockedExchange64](../intrinsics/interlockedexchange-intrinsic-functions.md)||intrin.h|__int64 _InterlockedExchange64 (\___int64 volatile \*,\___int64)|
|[_InterlockedExchange64_HLEAcquire](../intrinsics/interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedExchange64_HLEAcquire (\___int64 volatile \*,\___int64)|
|[_InterlockedExchange64_HLERelease](../intrinsics/interlockedexchange-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedExchange64_HLERelease (\___int64 volatile \*,\___int64)|
...
|[_InterlockedExchangeAdd](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)||intrin.h|_InterlockedExchangeAdd largo (long volatile \*, long)|
|[_InterlockedExchangeAdd_HLEAcquire](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedExchangeAdd_HLEAcquire largo (long volatile \*, long)|
|[_InterlockedExchangeAdd_HLERelease](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedExchangeAdd_HLERelease largo (long volatile \*, long)|
...
|[_InterlockedExchangeAdd64](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)||intrin.h|__int64 _InterlockedExchangeAdd64 (\___int64 volatile \*,\___int64)|
|[_InterlockedExchangeAdd64_HLEAcquire](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedExchangeAdd64_HLEAcquire (\___int64 volatile \*,\___int64)|
|[_InterlockedExchangeAdd64_HLERelease](../intrinsics/interlockedexchangeadd-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedExchangeAdd64_HLERelease (\___int64 volatile \*,\___int64)|
...
|[_InterlockedExchangePointer](../intrinsics/interlockedexchangepointer-intrinsic-functions.md)||intrin.h|void \* _InterlockedExchangePointer (void \*volátil \*, void \*)|
|[_InterlockedExchangePointer_HLEAcquire](../intrinsics/interlockedexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|void \* _InterlockedExchangePointer_HLEAcquire (void \*volátil \*, void \*)|
|[_InterlockedExchangePointer_HLERelease](../intrinsics/interlockedexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|void * _InterlockedExchangePointer_HLERelease (void \*volátil \*, void \*)|
|[_InterlockedIncrement](../intrinsics/interlockedincrement-intrinsic-functions.md)||intrin.h|_InterlockedIncrement largo (long volatile \*)|
|[_InterlockedIncrement16](../intrinsics/interlockedincrement-intrinsic-functions.md)||intrin.h|_InterlockedIncrement16 corto (short volatile \*sumando)|
|[_InterlockedIncrement64](../intrinsics/interlockedincrement-intrinsic-functions.md)||intrin.h|__int64 _InterlockedIncrement64 (\___int64 volatile \*)|
|[_InterlockedOr](../intrinsics/interlockedor-intrinsic-functions.md)||intrin.h|Long _InterlockedOr (long volatile \*, long)|
|[_InterlockedOr_HLEAcquire](../intrinsics/interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedOr_HLEAcquire largo (long volatile \*, long)|
|[_InterlockedOr_HLERelease](../intrinsics/interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedOr_HLERelease largo (long volatile \*, long)|
|[_InterlockedOr_np](../intrinsics/interlockedor-intrinsic-functions.md)||intrin.h|_InterlockedOr_np largo (long \*, long)|
|[_InterlockedOr16](../intrinsics/interlockedor-intrinsic-functions.md)||intrin.h|short _InterlockedOr16 (short volatile \*, short)|
|[_InterlockedOr16_np](../intrinsics/interlockedor-intrinsic-functions.md)||intrin.h|_InterlockedOr16_np corto (short \*, short)|
|[_InterlockedOr64](../intrinsics/interlockedor-intrinsic-functions.md)||intrin.h|__int64 _InterlockedOr64 (\___int64 volatile \*,\___int64)|
|[_InterlockedOr64_HLEAcquire](../intrinsics/interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedOr64_HLEAcquire (\___int64 volatile \*,\___int64)|
|[_InterlockedOr64_HLERelease](../intrinsics/interlockedor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedOr64_HLERelease (\___int64 volatile \*,\___int64)|
|[_InterlockedOr64_np](../intrinsics/interlockedor-intrinsic-functions.md)||intrin.h|__int64 _InterlockedOr64_np (\__int64 \*,\___int64)|
...
|[_InterlockedXor_HLEAcquire](../intrinsics/interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedXor_HLEAcquire largo (long volatile \*, long)|
|[_InterlockedXor_HLERelease](../intrinsics/interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|_InterlockedXor_HLERelease largo (long volatile \*, long)|
|[_InterlockedXor_np](../intrinsics/interlockedxor-intrinsic-functions.md)||intrin.h|_InterlockedXor_np largo (long \*, long)|
|[_InterlockedXor16](../intrinsics/interlockedxor-intrinsic-functions.md)||intrin.h|short _InterlockedXor16 (short volatile \*, short)|
|[_InterlockedXor16_np](../intrinsics/interlockedxor-intrinsic-functions.md)||intrin.h|_InterlockedXor16_np corto (short \*, short)|
|[_InterlockedXor64](../intrinsics/interlockedxor-intrinsic-functions.md)||intrin.h|__int64 _InterlockedXor64 (\___int64 volatile \*,\___int64)|
|[_InterlockedXor64_HLEAcquire](../intrinsics/interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedXor64_HLEAcquire (\___int64 volatile \*,\___int64)|
|[_InterlockedXor64_HLERelease](../intrinsics/interlockedxor-intrinsic-functions.md)|HLE [2]|immintrin.h|__int64 _InterlockedXor64_HLERelease (\___int64 volatile \*,\___int64)|
|[_InterlockedXor64_np](../intrinsics/interlockedxor-intrinsic-functions.md)||intrin.h|__int64 _InterlockedXor64_np (\__int64 \*,\___int64)|
...
|[__inwordstring](../intrinsics/inwordstring.md)||intrin.h|void __inwordstring (unsigned short puerto, entero corto sin signo \*del búfer, unsigned long recuento)|
|_lgdt||intrin.h|void _lgdt (void\*)|
|[__lidt](../intrinsics/lidt.md)||intrin.h|void __lidt (void\*)|
|[__ll_lshift](../intrinsics/ll-lshift.md)||intrin.h|__int64 sin signo [pascal/cdecl] \__ll_lshift (unsigned \__int64, int)|
...
|[_lzcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_lzcnt_u64)|BMI|ammintrin.h, immintrin.h|unsigned __int64 _lzcnt_u64 (unsigned \___int64)|
|[__lzcnt16](../intrinsics/lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|unsigned short __lzcnt16(unsigned short)|
|[__lzcnt64](../intrinsics/lzcnt16-lzcnt-lzcnt64.md)|LZCNT|intrin.h|__int64 sin signo \__lzcnt64 (unsigned \___int64)|
...
|[_mm_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_i32gather_epi32 (const int \*base,\__m128i índice, escala de const int)|
...
|[_mm_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i32gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_i32gather_pd (const doble \*base,\__m128i índice, escala de const int)|
...
|[_mm_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_i64gather_epi32 (const int \*base,\__m128i índice, escala de const int)|
...
|[_mm_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_i64gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_i64gather_pd (const doble \*base,\__m128i índice, escala de const int)|
...
|[_mm_loaddup_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_loaddup_pd)|SSE3|intrin.h|__m128d _mm_loaddup_pd (const doble\*)|
...
|[_mm_mask_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i32gather_epi32 (\__m128i src, const int \*base,\__m128i índice,\__m128i máscara, escala de const int)|
...
|[_mm_mask_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_mask_i32gather_pd (\__m128d src, const doble \*base,\__m128i índice,\__m128d máscara, escala de const int)|
|[_mm_mask_i32gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i32gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_mask_i32gather_ps (\__m128 src, float const \*base,\__m128i índice,\_máscara _m128, scale de const int)|
|[_mm_mask_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm_mask_i64gather_epi32 (\__m128i src, const int \*base,\__m128i índice,\__m128i máscara, escala de const int)|
...
|[_mm_mask_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_pd)|AVX2 [2]|immintrin.h|__m128d _mm_mask_i64gather_pd (\__m128d src, const doble \*base,\__m128i índice,\__m128d máscara, escala de const int)|
|[_mm_mask_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_mask_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm_mask_i64gather_ps (\__m128 src, float const \*base,\__m128i índice,\_máscara _m128, scale de const int)|
...
|[_mm_maskstore_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_maskstore_pd)|AVX [2]|immintrin.h|void _mm_maskstore_pd (doble \*,\__m128i,\__m128d)|
...
|[_mm_popcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_popcnt_u64)|POPCNT|intrin.h|__int64 _mm_popcnt_u64 (unsigned \___int64)|
...
|[_mm_store_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_store_pd)|SSE2|intrin.h|void _mm_store_pd (doble\*,\__m128d)|
...
|[_mm_store_sd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_store_sd)|SSE2|intrin.h|void _mm_store_sd (doble\*,\__m128d)|
...
|[_mm_store1_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_store1_pd)|SSE2|intrin.h|void _mm_store1_pd (doble\*,\__m128d)|
|[_mm_storeh_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_storeh_pd)|SSE2|intrin.h|void _mm_storeh_pd (doble\*,\__m128d)|
...
|[_mm_storel_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_storel_pd)|SSE2|intrin.h|void _mm_storel_pd (doble\*,\__m128d)|
...
|[_mm_storer_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_storer_pd)|SSE2|intrin.h|void _mm_storer_pd (doble\*,\__m128d)|
...
|[_mm_storeu_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_storeu_pd)|SSE2|intrin.h|void _mm_storeu_pd (doble\*,\__m128d)|
...
|[_mm_stream_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_stream_pd)|SSE2|intrin.h|void _mm_stream_pd (doble\*,\__m128d)|
...
|[_mm_stream_sd](../intrinsics/mm-stream-sd.md)|SSE4a|intrin.h|void _mm_stream_sd (doble\*,\__m128d)|
...
|[_mm_stream_si64x](../intrinsics/mm-stream-si64x.md)|SSE2|intrin.h|void _mm_stream_si64x (\__int64 \*,\___int64)|
...
|[_mm256_extracti128_si256](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_extracti128_si256)|AVX2 [2]|immintrin.h|__m128i _mm256_extracti128_si256 (\__m256i un, desplazamiento int)|
...
|[_mm256_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_i32gather_epi32 (const int \*base,\__m256i índice, escala de const int)|
...
|[_mm256_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i32gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_i32gather_pd (const doble \*base,\__m128i índice, escala de const int)|
...
|[_mm256_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_i64gather_epi32 (const int \*base,\__m256i índice, escala de const int)|
...
|[_mm256_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_i64gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_i64gather_pd (const doble \*base,\__m256i índice, escala de const int)|
...
|[_mm256_mask_i32gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_epi32)|AVX2 [2]|immintrin.h|__m256i _mm256_mask_i32gather_epi32 (\__m256i src, const int \*base,\__m256i índice,\__m256i máscara, escala de const int)|
...
|[_mm256_mask_i32gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i32gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_mask_i32gather_pd (\__m256d src, const doble \*base,\__m128i índice,\__m256d máscara, escala de const int)|
...
|[_mm256_mask_i64gather_epi32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_epi32)|AVX2 [2]|immintrin.h|__m128i _mm256_mask_i64gather_epi32 (\__m128i src, const int \*base,\__m256i índice,\__m128i máscara, escala de const int)|
...
|[_mm256_mask_i64gather_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_pd)|AVX2 [2]|immintrin.h|__m256d _mm256_mask_i64gather_pd (\__m256d src, const doble \*base,\__m256i índice,\__m256d máscara, escala de const int)|
|[_mm256_mask_i64gather_ps](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_mask_i64gather_ps)|AVX2 [2]|immintrin.h|__m128 _mm256_mask_i64gather_ps (\__m128 src, float const \*base,\__m256i índice,\_máscara _m128, scale de const int)|
...
|[_mm256_maskstore_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_maskstore_pd)|AVX [2]|immintrin.h|void _mm256_maskstore_pd (doble \*,\__m256i,\__m256d)|
...
|[_mm256_store_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_store_pd)|AVX [2]|immintrin.h|void _mm256_store_pd (doble \*,\__m256d)|
...
|[_mm256_storeu_pd](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm256_storeu_pd)|AVX [2]|immintrin.h|void _mm256_storeu_pd (doble \*,\__m256d)|
...
|[__movsb](../intrinsics/movsb.md)||intrin.h|VOID __movsb (IN PBYTE, IN bytes const \*, SIZE_T IN)|
|[__movsd](../intrinsics/movsd.md)||intrin.h|VOID __movsd (IN PDWORD, DWORD en const \*, SIZE_T IN)|
|[__movsq](../intrinsics/movsq.md)||intrin.h|VOID __movsq (PDWORD64 IN, mm DWORD64 const \*, SIZE_T IN)|
|[__movsw](../intrinsics/movsw.md)||intrin.h|VOID __movsw (contraseña de la India, IN WORD const \*, SIZE_T IN)|
|[_mul128](../intrinsics/mul128.md)||intrin.h|__int64 _mul128 (\__int64 multiplicador,\__int64 multiplicando,\__int64 \*highproduct)|
|[__mulh](../intrinsics/mulh.md)||intrin.h|__int64 \__mulh (\__int64,\___int64)|
...
|[__outbytestring](../intrinsics/outbytestring.md)||intrin.h|void __outbytestring (puerto short sin signo, unsigned char \*del búfer, unsigned long recuento)|
|[__outdword](../intrinsics/outdword.md)||intrin.h|void __outdword(unsigned short Port,unsigned long Data)|
|[__outdwordstring](../intrinsics/outdwordstring.md)||intrin.h|void __outdwordstring (unsigned short puerto, unsigned long \*del búfer, unsigned long recuento)|
|[__outword](../intrinsics/outword.md)||intrin.h|void __outword(unsigned short Port,unsigned short Data)|
|[__outwordstring](../intrinsics/outwordstring.md)||intrin.h|void __outwordstring (unsigned short puerto, entero corto sin signo \*del búfer, unsigned long recuento)|
...
|[__popcnt64](../intrinsics/popcnt16-popcnt-popcnt64.md)|POPCNT|intrin.h|__int64 sin signo \__popcnt64 (unsigned \___int64)|
...
|[__rdtsc](../intrinsics/rdtsc.md)||intrin.h|__int64 sin signo \__rdtsc(void)|
|[__rdtscp](../intrinsics/rdtscp.md)|RDTSCP|intrin.h|__int64 sin signo \__rdtscp (unsigned int\*)|
|[_ReadBarrier](../intrinsics/readbarrier.md)||intrin.h|void _ReadBarrier(void)|
|[__readcr0](../intrinsics/readcr0.md)||intrin.h|__int64 sin signo \__readcr0(void)|
|[__readcr2](../intrinsics/readcr2.md)||intrin.h|__int64 sin signo \__readcr2(void)|
|[__readcr3](../intrinsics/readcr3.md)||intrin.h|__int64 sin signo \__readcr3(void)|
|[__readcr4](../intrinsics/readcr4.md)||intrin.h|__int64 sin signo \__readcr4(void)|
|[__readcr8](../intrinsics/readcr8.md)||intrin.h|__int64 sin signo \__readcr8(void)|
|[__readdr](../intrinsics/readdr.md)||intrin.h|__int64 sin signo \__readdr(unsigned)|
|[__readeflags](../intrinsics/readeflags.md)||intrin.h|__int64 sin signo \__readeflags(void)|
...
|[__readgsqword](../intrinsics/readgsbyte-readgsdword-readgsqword-readgsword.md)||intrin.h|__int64 sin signo \__readgsqword (desplazamiento long sin signo)|
...
|[__readmsr](../intrinsics/readmsr.md)||intrin.h|__int64 sin signo \__readmsr (largo sin signo)|
|[__readpmc](../intrinsics/readpmc.md)||intrin.h|__int64 sin signo \__readpmc(unsigned long a)|
...
|[__shiftleft128](../intrinsics/shiftleft128.md)||intrin.h|__int64 sin signo \__shiftleft128 (unsigned \_parte inferior de _int64, unsigned \__int64 HighPart, unsigned char MAYÚS)|
|[__shiftright128](../intrinsics/shiftright128.md)||intrin.h|__int64 sin signo \__shiftright128 (unsigned \_parte inferior de _int64, unsigned \__int64 HighPart, unsigned char MAYÚS)|
...
|_store_be_u64<br /><br /> [_storebe_i64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_storebe_i64&expand=5143)|MOVBE|immintrin.h|void _store_be_u64 (void \*sin signo \__int64);<br /><br /> void _storebe_i64 (void \*, \__int64); [3]|
...
|_subborrow_u16||intrin.h|unsigned char _subborrow_u16 (unsigned char b_in, src1 corto sin signo, src2 corto sin signo, entero corto sin signo \*diff)|
|[_subborrow_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_subborrow_u32)||intrin.h|unsigned char _subborrow_u32 (unsigned char b_in, src1 int sin signo, src2 unsigned int, int sin signo \*diff)|
|[_subborrow_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_subborrow_u64)||intrin.h|unsigned char _subborrow_u64 (unsigned char b_in, unsigned \__int64 src1, unsigned \__int64 src2, sin signo \__int64 \*diff)|
|_subborrow_u8||intrin.h|unsigned char _subborrow_u8 (unsigned char b_in, src1 char sin signo, src2 char sin signo, char sin signo \*diff)|
...
|_t1mskc_u64|ABM [1]|ammintrin.h|unsigned __int64 _t1mskc_u64 (unsigned \___int64)|
...
|[_tzcnt_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_tzcnt_u64)|BMI|ammintrin.h, immintrin.h|unsigned __int64 _tzcnt_u64 (unsigned \___int64)|
|_tzmsk_u32|ABM [1]|ammintrin.h|unsigned int _tzmsk_u32(unsigned int)|
|_tzmsk_u64|ABM [1]|ammintrin.h|unsigned __int64 _tzmsk_u64 (unsigned \___int64)|
|[__ud2](../intrinsics/ud2.md)||intrin.h|void __ud2(void)|
|[__ull_rshift](../intrinsics/ull-rshift.md)||intrin.h|__int64 sin signo [pascal/cdecl] \__ull_rshift (unsigned \__int64, int)|
|[_umul128](../intrinsics/umul128.md)||intrin.h|unsigned __int64 _umul128 (unsigned \__int64 multiplicador, no firmado \__int64 multiplicando, unsigned \__int64 \*highproduct)|
|[__umulh](../intrinsics/umulh.md)||intrin.h|__int64 sin signo \__umulh (unsigned \__int64, unsigned \___int64)|
...
|[__writecr0](../intrinsics/writecr0.md)||intrin.h|void __writecr0 (unsigned \___int64)|
|[__writecr3](../intrinsics/writecr3.md)||intrin.h|void __writecr3 (unsigned \___int64)|
|[__writecr4](../intrinsics/writecr4.md)||intrin.h|void __writecr4 (unsigned \___int64)|
|[__writecr8](../intrinsics/writecr8.md)||intrin.h|void __writecr8 (unsigned \___int64)|
|[__writedr](../intrinsics/writedr.md)||intrin.h|void __writedr (sin firmar, sin signo \___int64)|
|[__writeeflags](../intrinsics/writeeflags.md)||intrin.h|void __writeeflags (unsigned \___int64)|
...
|[_writefsbase_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writefsbase_u64)|FSGSBASE [2]|immintrin.h|void _writefsbase_u64 (unsigned \___int64)|
...
|[_writegsbase_u64](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_writegsbase_u64)|FSGSBASE [2]|immintrin.h|void _writegsbase_u64 (unsigned \___int64)|
...
|[__writegsqword](../intrinsics/writegsbyte-writegsdword-writegsqword-writegsword.md)||intrin.h|void __writegsqword (unsigned long desplazamiento, sin signo \__int64 datos)|
...
|[__writemsr](../intrinsics/writemsr.md)||intrin.h|void __writemsr (unsigned long, unsigned \___int64)|
