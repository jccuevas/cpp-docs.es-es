...
## <a name="general-information-about-visual-c"></a>Información general sobre Visual C++  
 ...
 Obtenga información sobre las mejoras de conformidad de C++ en Visual Studio 2017. 
 ...
 [Compatibilidad con las características de C++11/14/17 (C++ moderno)](cpp/support-for-cpp11-14-17-features-modern-cpp.md)  
...
## <a name="writing-applications-in-c"></a>Escribir aplicaciones en C++  
