...
Puede utilizar la herramienta de línea de comandos vcpkg para simplificar notablemente la detección e instalación de más de 600 bibliotecas de código abierto de C++. Para obtener más información, consulte [Vcpkg: Administrador de paquetes de C++ para Windows](vcpkg.md).
