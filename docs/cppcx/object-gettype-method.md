...
## Comentarios  
 ...
 Utiliza el operador [typeid](../Topic/typeid%20%20\(C++%20Component%20Extensions\).md) para devolver un objeto de `Platform::Type` para un nombre de clase, por ejemplo, al navegar entre páginas XAML:  
