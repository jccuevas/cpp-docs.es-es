...
|[\/FU](../Topic/-FU%20\(Name%20Forced%20%23using%20File\).md) *archivo*|Fuerza la inclusión del módulo especificado o el archivo .winmd. Es decir, no hay que especificar `#using`*archivo* en el código fuente. El compilador fuerza automáticamente la inclusión de su propio archivo de metadatos de Windows, Platform.winmd.|  
