...
|[Platform::FailureException \(Clase\)](../cppcx/platform-failureexception-class.md)|Se produce cuando hay un error en la operación. Es el equivalente del HRESULT E\_FAIL.|  
