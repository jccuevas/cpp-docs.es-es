...
## Desarrollo de [!INCLUDE[cppwrl_short](../cppcx/includes/cppwrl-short-md.md)]  
 Para obtener más información sobre la creación y la utilización de componentes de [!INCLUDE[cppwrl_short](../cppcx/includes/cppwrl-short-md.md)], consulta [Biblioteca de plantillas de Windows Runtime C\+\+ \(WRL\)](http://msdn.microsoft.com/library/b915afce-553b-44a7-b8dc-0ab601758eb0).  
