...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3>Instalar Visual Studio y seleccionar las cargas de trabajo de C++</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3>Introducción a Visual Studio y C++</h3>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1>Documentación de Visual C++</h1>
        <ul class="pivots">
            <li>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Desarrolle aplicaciones para la Plataforma universal de Windows (UWP) con C++.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Cree clásicas aplicaciones de escritorio, bibliotecas estáticas y archivos DLL de Windows mediante Win32, MFC, ATL, COM y C++/CLI.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Desarrollo de Linux</h3>
                                                    <p>Cree aplicaciones para varias distribuciones de Linux.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Cree aplicaciones móviles para iOS, Android y UWP.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Cree juegos y aplicaciones gráficas con DirectX, Unreal y Cocos2D, entre otros.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <li>
                ...
                <ul id="features">
                    <li>
                        <a href="#features1">Características</a>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Escriba, refactorice, explore y entienda el código mediante el editor de código.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Compilar</h3>
                                                    <p>Compile y vincule el código, y optimícelo para el rendimiento máximo.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Depuración</h3>
                                                    <p>Depure el código de C++ con el depurador de Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Prueba</h3>
                                                    <p>Cree pruebas unitarias para el código de C++.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Implementar</h3>
                                                    <p>Distribuya el programa terminado a los usuarios finales.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Identifique los cuellos de botella y optimice el rendimiento del código mediante las herramientas de diagnóstico.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Portabilidad y actualizaciones</h3>
                                                    <p>Actualice a la versión más reciente de Visual Studio y migre aplicaciones heredadas a plataformas modernas.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <li>
                <a href="#langlib">Lenguajes y bibliotecas</a>
                <ul id="langlib">
                    <li>
                        <a href="#langlib1">Lenguajes y bibliotecas</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Lenguaje C/C++ y bibliotecas estándar</h3>
                                                    <p>Implementación de Microsoft de los lenguajes de programación y las bibliotecas de C/C++.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Extensiones de componente de C++: C++/CLI para la programación de .NET y C++/CX para la programación de UWP.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Bibliotecas de escritorio de Windows</h3>
                                                    <p>Microsoft Foundation Classes (MFC) y Active Template Library (ATL)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Bibliotecas de programación en paralelo</h3>
                                                    <p>Bibliotecas de Concrt, AMP y OpenMP para la programación en paralelo.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Bibliotecas de la Plataforma universal de Windows</h3>
                                                    <p>La biblioteca de plantillas de C++ de Windows Runtime (WRL) es una biblioteca de plantillas que proporciona una manera de bajo nivel de crear y usar componentes de Windows Runtime.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
