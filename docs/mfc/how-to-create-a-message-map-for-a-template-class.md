...
## <a name="example"></a>Ejemplo  
 ...
 El siguiente ejemplo muestra el uso del ejemplo de la `CSyncListBox` clase mediante un `CStringList` objeto:  
  
 [!code-cpp[NVC_MFC_CListBox#47](../mfc/codesnippet/cpp/how-to-create-a-message-map-for-a-template-class_6.cpp)]  
  
 Para completar la prueba, el `StringizeElement` función debe haberse especializada para trabajar con la `CStringList` clase:  
