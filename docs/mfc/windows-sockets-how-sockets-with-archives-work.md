---
title: 'Windows Sockets: Cómo funcionan los Sockets con archivos de almacenamiento | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
![CArchive, CSocketFile y CSocket](../mfc/media/vc38ia1.gif "vc38ia1") CArchive, CSocketFile y CSocket
