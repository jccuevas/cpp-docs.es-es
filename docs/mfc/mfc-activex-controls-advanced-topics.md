...
8.  En el **función Get** y **establecer función** cuadros, escriba nombres únicos para sus funciones Get y Set o acepte los nombres predeterminados.  
