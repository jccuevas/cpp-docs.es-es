...
9. Haga clic en **finalizar** para crear la clase.  
 ...
 Tenga en cuenta que se debe incrementar el segundo parámetro de la macro BEGIN_PROPPAGEIDS (recuento de páginas de propiedades) de 1 a 2.  
