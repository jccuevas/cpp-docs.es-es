...
[Tutorial: Usar los nuevos controles de Shell MFC](../mfc/walkthrough-using-the-new-mfc-shell-controls.md)<br/>
...
[Tutorial: Insertar controles en barras de herramientas](../mfc/walkthrough-putting-controls-on-toolbars.md)<br/>
...
[Tutorial: Agregar objetos D2D a un proyecto MFC](../mfc/walkthrough-adding-a-d2d-object-to-an-mfc-project.md)<br/>
Muestra cómo agregar un objeto D2D a un proyecto, así como el uso de D2D.

[Tutorial: Agregar animación a un proyecto MFC](../mfc/walkthrough-adding-animation-to-an-mfc-project.md)<br/>
