---
title: Objetos de la interfaz de usuario e identificadores de comando | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
![Comandos en el marco](../mfc/media/vc385p1.gif "vc385p1") comandos en el marco de trabajo
...
![Comando de actualización en el marco de trabajo](../mfc/media/vc385p2.png "vc385p2") comando Actualizar en el marco de trabajo
