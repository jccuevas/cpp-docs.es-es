...
### <a name="example"></a>Ejemplo  
 [!code-cpp[NVC_MFC_CTreeCtrl Nº 5](../../mfc/reference/codesnippet/cpp/ctreectrl-class_5.cpp)]  
...
##  <a name="getbkcolor"></a>CTreeCtrl::GetBkColor  
 Esta función miembro implementa el comportamiento del mensaje de Win32 [TVM_GETBKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773570), tal y como se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="example"></a>Ejemplo  
 [!code-cpp[NVC_MFC_CTreeCtrl Nº 11](../../mfc/reference/codesnippet/cpp/ctreectrl-class_11.cpp)]  
...
##  <a name="getinsertmarkcolor"></a>CTreeCtrl::GetInsertMarkColor  
 Esta función miembro implementa el comportamiento del mensaje de Win32 [TVM_GETINSERTMARKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773590), tal y como se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="getitemheight"></a>CTreeCtrl::GetItemHeight  
 Esta función miembro implementa el comportamiento del mensaje de Win32 [TVM_GETITEMHEIGHT](http://msdn.microsoft.com/library/windows/desktop/bb773599), tal y como se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="example"></a>Ejemplo  
 ...
 [!code-cpp[NVC_MFC_CTreeCtrl_s1 Nº 5](../../mfc/reference/codesnippet/cpp/ctreectrl-class_18.cpp)]  
...
### <a name="remarks"></a>Comentarios  
 Este método envía el [TVM_GETNEXTITEM](http://msdn.microsoft.com/library/windows/desktop/bb773622) mensaje, que se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]. Para obtener más información, consulte el `TVGN_LASTVISIBLE` se marcan en el `flag` parámetro de ese mensaje.  
...
##  <a name="getlinecolor"></a>CTreeCtrl::GetLineColor  
 Esta función miembro implementa el comportamiento del mensaje de win32 [TVM_GETLINECOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773619), tal y como se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="example"></a>Ejemplo  
 ...
 [!code-cpp[NVC_MFC_CTreeCtrl Nº 20](../../mfc/reference/codesnippet/cpp/ctreectrl-class_23.cpp)]  
...
### <a name="remarks"></a>Comentarios  
 Esta función miembro implementa el comportamiento del mensaje de win32 [TVM_GETSCROLLTIME](http://msdn.microsoft.com/library/windows/desktop/bb773625), tal y como se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="gettextcolor"></a>CTreeCtrl::GetTextColor  
 Esta función miembro implementa el comportamiento del mensaje de Win32 [TVM_GETTEXTCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773633), tal y como se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="gettooltips"></a>CTreeCtrl::GetToolTips  
 Esta función miembro implementa el comportamiento del mensaje de Win32 [TVM_GETTOOLTIPS](http://msdn.microsoft.com/library/windows/desktop/bb773729), tal y como se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
 ...
 *lpInsertStruct*  
 ...
 `nMask`  
 Entero que especifica qué atributos que se van a establecer. Consulte la `TVITEM` estructura en la [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
 ...
 `nState`  
 Especifica los valores de los Estados del elemento. Estados de elemento de Control en vista de árbol de vea en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)] para obtener una lista de Estados adecuados.  
  
 `nStateMask`  
 Especifica qué estados que se van a establecer. Consulte la `TVITEM` estructura en la [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="setbkcolor"></a>CTreeCtrl::SetBkColor  
 Esta función miembro implementa el comportamiento del mensaje de Win32 [TVM_SETBKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773741), tal y como se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="setinsertmark"></a>CTreeCtrl::SetInsertMark  
 Esta función miembro implementa el comportamiento del mensaje de Win32 [TVM_SETINSERTMARK](http://msdn.microsoft.com/library/windows/desktop/bb773753), tal y como se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="setinsertmarkcolor"></a>CTreeCtrl::SetInsertMarkColor  
 Esta función miembro implementa el comportamiento del mensaje de Win32 [TVM_SETINSERTMARKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773755), tal y como se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="parameters"></a>Parámetros  
 `pItem`  
 Un puntero a un [estructura TVITEM](http://msdn.microsoft.com/library/windows/desktop/bb773456) estructura que contiene el nuevo elemento de atributos, como se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
 `hItem`  
 Identificador del elemento cuyos atributos que se van a establecer. Consulte la **hItem** miembro de la `TVITEM` estructura en la [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 ...
 Si el **máscara** miembro o `nMask` parámetro especifica la `TVIF_TEXT` valor, el **pszText** miembro o el `lpszItem` es la dirección de una cadena terminada en null y el **cchTextMax** miembro se omite. Si **máscara** (o `nMask`) especifica la `TVIF_STATE` valor, el **stateMask** miembro o el `nStateMask` parámetro especifica qué elemento indica para cambiar y el **estado** miembro o `nState` parámetro contiene los valores de esos Estados.  
...
##  <a name="setitemheight"></a>CTreeCtrl::SetItemHeight  
 Esta función miembro implementa el comportamiento del mensaje de Win32 [TVM_SETITEMHEIGHT](http://msdn.microsoft.com/library/windows/desktop/bb773761), tal y como se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Este método envía el [TVM_SETITEM](http://msdn.microsoft.com/library/windows/desktop/bb773758) mensaje, que se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]. Este método asigna la `uStateEx` parámetro a la `uStateEx` miembro de un [TVITEMEX](http://msdn.microsoft.com/library/windows/desktop/bb773459) estructura y, a continuación, utiliza ese estructura en el mensaje.  
...
### <a name="remarks"></a>Comentarios  
 Esta función miembro implementa el comportamiento del mensaje de win32 [TVM_SETLINECOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773764), tal y como se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Esta función miembro implementa el comportamiento del mensaje de win32 [TVM_SETSCROLLTIME](http://msdn.microsoft.com/library/windows/desktop/bb773767), tal y como se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
##  <a name="settextcolor"></a>CTreeCtrl::SetTextColor  
 Esta función miembro implementa el comportamiento del mensaje de Win32 [TVM_SETTEXTCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773769), tal y como se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="settooltips"></a>CTreeCtrl::SetToolTips  
 Esta función miembro implementa el comportamiento del mensaje de Win32 [TVM_SETTOOLTIPS](http://msdn.microsoft.com/library/windows/desktop/bb773772), tal y como se describe en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Para obtener más información acerca de las diferencias entre la información sobre herramientas y recuadros informativos, busque el tema "Información sobre herramientas y recuadros informativos" en [Microsoft Developer Network](http://go.microsoft.com/fwlink/linkid=56322).  
