...
### <a name="parameters"></a>Parámetros  
 [in] *bMostrar*  
 `TRUE` Para activar la ventana del marco se muestra; `FALSE` para ocultar la ventana del marco.  
