---
title: CSocket (clase) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|Name|Descripción|
|----------|-----------------|
|[Múltiple](#onmessagepending)|Se llama para procesar los mensajes pendientes mientras se esperaba una llamada de bloqueo en completarse.|
