...
|[CMFCRibbonPanel::GetElements](#getelements)|Recupera todos los elementos que se encuentran en el panel de la cinta de opciones.|  
...
|[CMFCRibbonPanel::MakeGalleryItemVisible](#makegalleryitemvisible)|Desplaza la Galería para hacer visible el elemento especificado de la cinta de opciones.|  
...
|[CMFCRibbonPanel::RemoveAll](#removeall)|Quita todos los elementos desde el panel de la cinta de opciones.|  
|[CMFCRibbonPanel::Replace](#replace)|Reemplaza un elemento con otro basándose en sus valores de índice respectivos.|  
|[CMFCRibbonPanel::ReplaceByID](#replacebyid)|Reemplaza un elemento por otro en función de un identificador de comando especificado.|  
...
|[CMFCRibbonPanel::SetElementRTC](#setelementrtc)|Agrega un elemento de la cinta especificado por la información de clase en tiempo de ejecución proporcionado en el panel de la cinta.|  
|[CMFCRibbonPanel::SetElementRTCByID](#setelementrtcbyid)|Agrega un elemento de la cinta especificado por la información de clase en tiempo de ejecución proporcionado en el panel de la cinta.|  
|[CMFCRibbonPanel::SetFocused](#setfocused)|Establece el foco en el elemento especificado de la cinta de opciones.|  
|[CMFCRibbonPanel::SetJustifyColumns](#setjustifycolumns)|Habilita o deshabilita la justificación a la columna.|  
...
## <a name="remarks"></a>Comentarios  
 Paneles de cinta son agrupaciones lógicas de tareas relacionadas que crean dentro de las categorías de la cinta de opciones. Como el tamaño de los cambios de la cinta de opciones, el diseño del panel se ajusta automáticamente para mostrar tantos elementos como sea posible.  
...
## <a name="example"></a>Ejemplo  
 En el ejemplo siguiente se muestra cómo configurar un `CMFCRibbonPanel` objeto con varios métodos en la `CMFCRibbonPanel` clase. En el ejemplo se muestra cómo establecer el método abreviado de teclado que muestra el panel de la cinta de opciones, alinear los elementos en el panel verticalmente por columna y habilitar la justificación a la columna. Este fragmento de código forma parte de la [ejemplo de demostración de MS Office 2007](../../visual-cpp-samples.md).  
...
### <a name="parameters"></a>Parámetros  
 ...
 [in] *uiColdResID*  
 Especifica el identificador de recursos de imágenes inactivos de la barra de herramientas.  
  
 [in] *uiHotResID*  
 Especifica el identificador de recursos de imágenes activas de la barra de herramientas.  
  
 [in] *uiDisabledResID*  
 Especifica el identificador de recursos de imágenes deshabilitado de la barra de herramientas.  
  
### <a name="return-value"></a>Valor devuelto  
 Llamar a este método para agregar una barra de herramientas en el panel de la cinta. La barra de herramientas se agregará al lado del elemento de la cinta de opciones agregado por la llamada anterior a [cmfcribbonpanel:: Add](#add).  
...
### <a name="parameters"></a>Parámetros  
 [in] *lpszName*  
 El nombre del panel de la cinta.  
...
### <a name="return-value"></a>Valor devuelto  
 El alto, en píxeles, de un título para el panel de la cinta.  
...
### <a name="return-value"></a>Valor devuelto  
 Puntero al elemento de la cinta de opciones que tiene el menú emergente desplegado; en caso contrario `NULL` si ningún elemento de la cinta de opciones tiene su menú emergente desplegada.  
...
### <a name="parameters"></a>Parámetros  
 [out] *arElements*  
 Una matriz para rellenar con todos los elementos de la cinta de opciones que se encuentran en el panel de la cinta de opciones.  
...
### <a name="parameters"></a>Parámetros  
 [out] *lstItems*  
 La lista de identificadores de comando para los elementos de la cinta de opciones que se encuentran en el panel de la cinta de opciones.  
...
### <a name="return-value"></a>Valor devuelto  
 Un puntero a un elemento de la cinta si el usuario presiona actualmente en caso contrario, `NULL`.  
...
### <a name="return-value"></a>Valor devuelto  
 Índice de base cero del elemento de la cinta de opciones que tiene el punto especificado que se encuentra en él; en caso contrario,-1.  
...
### <a name="return-value"></a>Valor devuelto  
 `TRUE` Si se ha quitado y elimina el elemento (si *bEliminar* es `TRUE`); `FALSE` si no se quitó el elemento o si no hay ningún elemento de la cinta se encuentra en *nIndex*.  
...
### <a name="parameters"></a>Parámetros  
 [in] *uiCmdID*  
 Especifica el identificador de comando del elemento de la cinta de opciones en el menú se agrega.  
...
### <a name="return-value"></a>Valor devuelto  
 El elemento de la cinta de opciones que se creó mediante la información de clase en tiempo de ejecución especificado.  
...
### <a name="remarks"></a>Comentarios  
 Si desea agregar un elemento personalizado (por ejemplo, un botón de color) al panel de cinta de opciones, debe especificar la información de clase en tiempo de ejecución del elemento personalizado. Almacena esta información de la cinta de opciones, crea el elemento personalizado y reemplaza un elemento existente que se encuentra el identificador del comando especificado. A continuación, se devuelve un puntero al elemento recién creado.  
...
### <a name="parameters"></a>Parámetros  
 [in] *lpszKeys*  
 La sugerencia de tecla para el botón predeterminado del panel de cinta de opciones.  
...
### <a name="return-value"></a>Valor devuelto  
 Puntero al menú emergente del panel de cinta de opciones si el método se realizó correctamente; en caso contrario, `NULL`.  
