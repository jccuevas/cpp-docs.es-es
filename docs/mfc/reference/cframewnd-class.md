...
|[CFrameWnd:: LoadBarState](#loadbarstate)|La llamada para restaurar la configuración de la barra de control.|  
...
### <a name="parameters"></a>Parámetros  
 ...
 `dwStyle`  
 Especifica la ventana [estilo](../../mfc/reference/window-styles.md) atributos. Incluir el **FWS_ADDTOTITLE** si desea que la barra de título para mostrar automáticamente el nombre del documento representado en la ventana de estilo.  
 ...
 *lpszMenuName*  
 ...
 `dwExStyle`  
 Especifica la ventana extendida [estilo](../../mfc/reference/extended-window-styles.md) atributos.  
