...
|[CD2DBitmapBrush::Detach](#detach)|Separa la interfaz de recurso del objeto|  
|[CD2DBitmapBrush::Get](#get)|Interfaz de ID2D1BitmapBrush devuelve|  
|[CD2DBitmapBrush::GetBitmap](#getbitmap)|Obtiene el origen del mapa de bits que usa este pincel para dibujar|  
|[CD2DBitmapBrush::GetExtendModeX](#getextendmodex)|Obtiene el método mediante el cual el pincel mosaicos horizontalmente esas áreas que se extienden más allá de su mapa de bits|  
|[CD2DBitmapBrush::GetExtendModeY](#getextendmodey)|Obtiene el método mediante el cual el pincel iconos verticalmente las áreas que se extienden más allá de su mapa de bits|  
|[CD2DBitmapBrush::GetInterpolationMode](#getinterpolationmode)|Obtiene el método de interpolación utilizado cuando se escala o gira el mapa de bits de pincel|  
|[CD2DBitmapBrush::SetBitmap](#setbitmap)|Especifica el origen del mapa de bits que usa este pincel para dibujar|  
|[CD2DBitmapBrush::SetExtendModeX](#setextendmodex)|Especifica cómo el pincel horizontalmente iconos esas áreas que se extienden más allá de su mapa de bits|  
...
|[CD2DBitmapBrush::SetInterpolationMode](#setinterpolationmode)|Especifica el modo de interpolación usado cuando se escala o gira el mapa de bits de pincel|  
...
##  <a name="dtor"></a>  CD2DBitmapBrush:: ~ CD2DBitmapBrush  
 Destructor. Se llama cuando se destruye un objeto de pincel de mapa de bits de D2D.  
...
### <a name="return-value"></a>Valor devuelto  
 Puntero a una interfaz ID2D1BitmapBrush o NULL si el objeto todavía no está inicializado.  
  
##  <a name="getbitmap"></a>  CD2DBitmapBrush::GetBitmap  
 Obtiene el origen del mapa de bits que usa este pincel para dibujar  
...
### <a name="return-value"></a>Valor devuelto  
 Puntero a un objeto CD2DBitmap o NULL si el objeto todavía no está inicializado.  
  
##  <a name="getextendmodex"></a>  CD2DBitmapBrush::GetExtendModeX  
 Obtiene el método mediante el cual el pincel mosaicos horizontalmente esas áreas que se extienden más allá de su mapa de bits  
...
##  <a name="getextendmodey"></a>  CD2DBitmapBrush::GetExtendModeY  
 Obtiene el método mediante el cual el pincel iconos verticalmente las áreas que se extienden más allá de su mapa de bits  
...
##  <a name="getinterpolationmode"></a>  CD2DBitmapBrush::GetInterpolationMode  
 Obtiene el método de interpolación utilizado cuando se escala o gira el mapa de bits de pincel  
...
### <a name="return-value"></a>Valor devuelto  
 El método de interpolación utilizado cuando se escala o gira el mapa de bits de pincel  
...
##  <a name="setbitmap"></a>  CD2DBitmapBrush::SetBitmap  
 Especifica el origen del mapa de bits que usa este pincel para dibujar  
...
##  <a name="setextendmodex"></a>  CD2DBitmapBrush::SetExtendModeX  
 Especifica cómo el pincel horizontalmente iconos esas áreas que se extienden más allá de su mapa de bits  
...
##  <a name="setinterpolationmode"></a>  CD2DBitmapBrush::SetInterpolationMode  
 Especifica el modo de interpolación usado cuando se escala o gira el mapa de bits de pincel  
