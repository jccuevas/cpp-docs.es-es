...
> [!NOTE]
>  Además de los mensajes definidos por el usuario, `ON_MESSAGE` controla los mensajes de Windows menos comunes. Para obtener más información, vea el artículo de Knowledge Base [99848: INFO: Use ON_MESSAGE() Macro a los mensajes de menos común de mapa](http://go.microsoft.com/fwlink/p/?linkid=192022).  
