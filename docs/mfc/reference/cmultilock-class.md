 ...
 *dwTimeOut*  
 ...
 `dwWakeMask`  
 Especifica otras condiciones que pueden anular la espera. Para obtener una lista completa de las opciones disponibles para este parámetro, vea [MsgWaitForMultipleObjects](http://msdn.microsoft.com/library/windows/desktop/ms684242) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
