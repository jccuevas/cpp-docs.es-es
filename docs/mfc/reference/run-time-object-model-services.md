...
### <a name="see-also"></a>Vea también  
 [Biblioteca de controles de aislamiento de MFC Common](../isolation-of-the-mfc-common-controls-library.md) [AFX_COMCTL32_IF_EXISTS2](#afx_comctl32_if_exists2)
...
### <a name="see-also"></a>Vea también  
 [Biblioteca de controles de aislamiento de MFC Common](../isolation-of-the-mfc-common-controls-library.md) [AFX_COMCTL32_IF_EXISTS](#afx_comctl32_if_exists)
...
### <a name="remarks"></a>Comentarios  
 ...
 Si usa el **DECLARE**_ **dinámica** y `IMPLEMENT_DYNAMIC` macros tal como se describe a continuación, puede usar el `RUNTIME_CLASS` macro y `CObject::IsKindOf` función para determinar la clase de los objetos en ejecución hora.  
