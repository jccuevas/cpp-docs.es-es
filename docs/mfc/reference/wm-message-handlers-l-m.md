---
title: 'Controladores de mensajes WM_: L - M | Documentos de Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|ON_WM_MENUCHAR()|afx_msg larga [OnMenuChar](../../mfc/reference/cwnd-class.md#onmenuchar)(UINT, UINT, CMenu *);|  
