---
title: CCreateContext (estructura) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
Para obtener más información sobre `CCreateContext`, vea el ejemplo de MFC [VIEWEX](../../visual-cpp-samples.md).
