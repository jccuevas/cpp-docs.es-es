...
> [!NOTE]
> Si declara los miembros después `DECLARE_DISPATCH_MAP`, debe especificar un nuevo tipo de acceso ( **público**, **privada**, o **protegido**) para ellos.
