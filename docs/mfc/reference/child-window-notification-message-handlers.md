---
title: Controladores de mensajes de notificación de ventana secundaria | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|--------------|-----------------|  
|[Identificador de control genérico](../../mfc/reference/generic-control-handler.md)|Controlador para los códigos de notificación de control genérico.|  
...
|[Controladores de cuadro combinado](../../mfc/reference/combo-box-handlers.md)|Controladores para los códigos de notificación de cuadro combinado.|  
