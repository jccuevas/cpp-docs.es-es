...
|[CMFCRibbonButton::CanBeStretched](#canbestretched)|(Reemplaza [CMFCRibbonBaseElement::CanBeStretched](../../mfc/reference/cmfcribbonbaseelement-class.md#canbestretched).)|
|[CMFCRibbonButton::CleanUpSizes](#cleanupsizes)|(Reemplaza [CMFCRibbonBaseElement::CleanUpSizes](../../mfc/reference/cmfcribbonbaseelement-class.md#cleanupsizes).)|
|[CMFCRibbonButton::ClosePopupMenu](#closepopupmenu)|(Reemplaza [CMFCRibbonBaseElement::ClosePopupMenu](../../mfc/reference/cmfcribbonbaseelement-class.md#closepopupmenu).)|
|[CMFCRibbonButton::DrawBottomText](#drawbottomtext)||
|[CMFCRibbonButton::DrawImage](#drawimage)|(Reemplaza [CMFCRibbonBaseElement::DrawImage](../../mfc/reference/cmfcribbonbaseelement-class.md#drawimage).)|
...
|[CMFCRibbonButton::GetCompactSize](#getcompactsize)|Devuelve el tamaño compacto del elemento de la cinta. (Reemplaza [CMFCRibbonBaseElement::GetCompactSize](../../mfc/reference/cmfcribbonbaseelement-class.md#getcompactsize).)|
...
|[CMFCRibbonButton::GetImageSize](#getimagesize)|Devuelve el tamaño de la imagen del elemento de la cinta. (Reemplaza [CMFCRibbonBaseElement::GetImageSize](../../mfc/reference/cmfcribbonbaseelement-class.md#getimagesize).)|
|[CMFCRibbonButton::GetIntermediateSize](#getintermediatesize)|Devuelve el tamaño del elemento de la cinta en su estado intermedio. (Reemplaza [CMFCRibbonBaseElement::GetIntermediateSize](../../mfc/reference/cmfcribbonbaseelement-class.md#getintermediatesize).)|
...
|[CMFCRibbonButton::GetRegularSize](#getregularsize)|Devuelve el tamaño normal del elemento de la cinta. (Reemplaza [CMFCRibbonBaseElement::GetRegularSize](../../mfc/reference/cmfcribbonbaseelement-class.md#getregularsize).)|
|[CMFCRibbonButton::GetSubItems](#getsubitems)||
|[CMFCRibbonButton::GetTextRowHeight](#gettextrowheight)||
|[CMFCRibbonButton::GetToolTipText](#gettooltiptext)|Devuelve el texto de información sobre herramientas del elemento de la cinta. (Reemplaza [CMFCRibbonBaseElement::GetToolTipText](../../mfc/reference/cmfcribbonbaseelement-class.md#gettooltiptext).)|
|[CMFCRibbonButton::HasCompactMode](#hascompactmode)|Especifica si el elemento de la cinta tiene un modo compacto. (Reemplaza [CMFCRibbonBaseElement::HasCompactMode](../../mfc/reference/cmfcribbonbaseelement-class.md#hascompactmode).)|
|[CMFCRibbonButton::HasIntermediateMode](#hasintermediatemode)|Especifica si el elemento de la cinta tiene un modo intermedio. (Reemplaza [CMFCRibbonBaseElement::HasIntermediateMode](../../mfc/reference/cmfcribbonbaseelement-class.md#hasintermediatemode).)|
|[CMFCRibbonButton::HasLargeMode](#haslargemode)|Determina si el elemento de la cinta tiene un modo grande. (Reemplaza [CMFCRibbonBaseElement::HasLargeMode](../../mfc/reference/cmfcribbonbaseelement-class.md#haslargemode).)|
|[CMFCRibbonButton::HasMenu](#hasmenu)|(Reemplaza [CMFCRibbonBaseElement::HasMenu](../../mfc/reference/cmfcribbonbaseelement-class.md#hasmenu).)|
|[CMFCRibbonButton::IsAlwaysDrawBorder](#isalwaysdrawborder)||
|[CMFCRibbonButton::IsAlwaysLargeImage](#isalwayslargeimage)|(Reemplaza [CMFCRibbonBaseElement::IsAlwaysLargeImage](../../mfc/reference/cmfcribbonbaseelement-class.md#isalwayslargeimage).)|
...
|[CMFCRibbonButton::OnCalcTextSize](#oncalctextsize)|(Reemplaza [CMFCRibbonBaseElement::OnCalcTextSize](../../mfc/reference/cmfcribbonbaseelement-class.md#oncalctextsize).)|
|[CMFCRibbonButton::OnDrawBorder](#ondrawborder)||
|[CMFCRibbonButton::OnDraw](#ondraw)|Llamado por el marco de trabajo para dibujar el elemento de la cinta. (Reemplaza [CMFCRibbonBaseElement::OnDraw](../../mfc/reference/cmfcribbonbaseelement-class.md#ondraw).)|
...
|[CMFCRibbonButton::SetACCData](#setaccdata)|(Reemplaza [CMFCRibbonBaseElement::SetACCData](../../mfc/reference/cmfcribbonbaseelement-class.md#setaccdata).)|
...
|[CMFCRibbonButton::SetDescription](#setdescription)|Establece la descripción del elemento de la cinta. (Reemplaza [CMFCRibbonBaseElement::SetDescription](../../mfc/reference/cmfcribbonbaseelement-class.md#setdescription).)|
...
|[CMFCRibbonButton::SetParentCategory](#setparentcategory)|(Reemplaza [CMFCRibbonBaseElement::SetParentCategory](../../mfc/reference/cmfcribbonbaseelement-class.md#setparentcategory).)|
|[CMFCRibbonButton::SetRightAlignMenu](#setrightalignmenu)|Alinea el menú emergente a la derecha del botón.|
|[CMFCRibbonButton::SetText](#settext)|Establece el texto para el elemento de la cinta. (Reemplaza [CMFCRibbonBaseElement::SetText](../../mfc/reference/cmfcribbonbaseelement-class.md#settext).)|
...
Para utilizar un botón de la cinta de opciones en una aplicación, construya el objeto button y agréguelo al [panel](../../mfc/reference/cmfcribbonpanel-class.md)de la cinta de opciones adecuado.
...
*pSubItem*<br/>
[en] Especifica un puntero al nuevo elemento que se va a agregar.

*nIndex*<br/>
[en] Especifica el índice en el que se va a agregar el elemento a la matriz de elementos de menú del botón; -1 para añadir el elemento al final de la matriz de elementos de menú.
...
*nSmallImageIndex*<br/>
[en] Especifica un índice de base cero de la imagen pequeña del botón en la lista de imágenes de la categoría primaria.

*nLargeImageIndex*<br/>
[en] Especifica un índice de base cero de la imagen grande del botón en la lista de imágenes de la categoría primaria.

*hIcon*<br/>
[en] Especifica un identificador para el icono que la aplicación utiliza como imagen del botón.

### <a name="example"></a>Ejemplo

En el ejemplo siguiente se `CMFCRibbonButton` muestra cómo construir un objeto.
...
*uiID*<br/>
[en] Especifica el identificador de comando del elemento de menú emergente.

### <a name="return-value"></a>Valor devuelto

El índice de base cero del subelemento asociado al *uiID*. -1 si no existe tal subelemento.
...
*bLargeImage*<br/>
[en] Si TRUE, devuelve el índice de imagen en la lista de imágenes que contiene las imágenes grandes; de lo contrario devuelve el índice de imagen en la lista de imágenes que contiene las imágenes pequeñas.
...
Especifica si el comando predeterminado para un botón de la cinta de opciones está habilitado.
...
TRUESi ha habilitado el comando predeterminado para un botón de la cinta de opciones; FALSE en caso contrario.
...
TRUESi el menú está alineado a la derecha; de lo contrario FALSO.
...
*Punto*<br/>
[en] Especifica la posición del clic del ratón.
...
*nIndex*<br/>
[en] Especifica el índice de base cero del elemento de menú que desea quitar.

### <a name="return-value"></a>Valor devuelto

TRUESi el elemento especificado se ha quitado correctamente; DE lo contrario FALSE si *nIndex* es negativo o supera el número de elementos de menú en el menú emergente.
...
Devuelve TRUE si se realiza correctamente; de lo contrario FALSO.
...
*Bset*<br/>
[en] Si es TRUE, el botón muestra una imagen grande. De lo contrario, el botón muestra una imagen pequeña.
...
*Bset*<br/>
[en] Si es TRUE, el botón puede ejecutar su comando predeterminado. Si FALSE, el botón no puede ejecutar su comando predeterminado.

### <a name="remarks"></a>Observaciones

*bSet* sólo es relevante cuando el botón tiene un menú. Si *bSet* es TRUE, el botón puede ejecutar su comando predeterminado y el menú emergente asignado solo aparece cuando un usuario hace clic en la flecha en el borde derecho del botón. De lo contrario, el botón no puede ejecutar su comando predeterminado y el menú emergente aparece independientemente del área del botón en la que haga clic el usuario.
...
*nIndex*<br/>
[en] Especifica el índice de imagen.

*bLargeImage*<br/>
[en] Si es TRUE, el índice especificado hace referencia a la lista de imágenes grandes. De lo contrario, el índice hace referencia a la lista de las imágenes pequeñas.
...
*bRightAlign*<br/>
Si es TRUE, el menú está alineado a la derecha. De lo contrario, el menú se alinea a la izquierda.
...
*Bset*<br/>
[en] Si es TRUE, el menú está alineado a la derecha. De lo contrario, el menú se alinea a la izquierda
