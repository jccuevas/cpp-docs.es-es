...
Para obtener más información sobre la estructura [PAGESETUPDLG](/windows/win32/api/commdlg/ns-commdlg-pagesetupdlgw) , vea el Windows SDK.
...
*pPSD*<br/>
Puntero a una estructura `PAGESETUPDLG`. Para obtener más información sobre [PAGESETUPDLG](/windows/win32/api/commdlg/ns-commdlg-pagesetupdlgw), vea el Windows SDK.
