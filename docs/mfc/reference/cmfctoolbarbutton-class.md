...
|[CMFCToolBarButton:: compareWith (](#comparewith)|Compara esta instancia con el objeto de `CMFCToolBarButton` proporcionado.|
|[CMFCToolBarButton:: CopyFrom](#copyfrom)|Copia las propiedades de otro botón de la barra de herramientas en el botón actual.|
|[CMFCToolBarButton:: CreateFromOleData](#createfromoledata)|Crea un objeto `CMFCToolBarButton` a partir del objeto `COleDataObject` proporcionado.|
...
|[CMFCToolBarButton:: OnContextHelp](#oncontexthelp)|Lo llama el marco de trabajo cuando la barra de herramientas primaria controla un mensaje de WM_HELPHITTEST.|
|[CMFCToolBarButton:: OnCtlColor](#onctlcolor)|Lo llama el marco de trabajo cuando la barra de herramientas primaria controla un mensaje de WM_CTLCOLOR.|
...
|[CMFCToolBarButton:: OnDblClk](#ondblclk)|Lo llama el marco de trabajo cuando la barra de herramientas primaria controla un mensaje de [WM_LBUTTONDBLCLK](/windows/win32/inputdev/wm-lbuttondblclk) .|
...
|[CMFCToolBarButton:: Move](#onmove)|Lo llama el marco de trabajo cuando se mueve la barra de herramientas primaria.|
|[CMFCToolBarButton:: show](#onshow)|Lo llama el marco de trabajo cuando el botón se vuelve visible o invisible.|
|[CMFCToolBarButton:: Datasize](#onsize)|Lo llama el marco de trabajo cuando cambia el tamaño o la posición de la barra de herramientas primaria y este cambio requiere que el botón cambie de tamaño.|
...
|[CMFCToolBarButton::P repareDrag](#preparedrag)|Lo llama el marco de trabajo cuando el botón está a punto de realizar una operación de arrastrar y colocar.|
...
|[CMFCToolBarButton:: SetACCData](#setaccdata)|Rellena el objeto de `CAccessibilityData` proporcionado con datos de accesibilidad del botón de la barra de herramientas.|
...
La implementación predeterminada devuelve TRUE. Invalide este método si el botón no se puede almacenar como parte de una operación de arrastrar y colocar. Para obtener más información sobre las operaciones de arrastrar y colocar, vea [arrastrar y colocar de OLE](../../mfc/drag-and-drop-ole.md).
...
Compara esta instancia con el objeto de `CMFCToolBarButton` proporcionado.
...
El marco de trabajo usa este método para realizar la transferencia de datos en varios formatos. Por ejemplo, el método `CMFCOutlookBarPane::OnDragOver` usa este método para realizar operaciones de arrastrar y colocar.
...
Este método llama a la función `EnableWindow` para habilitar o deshabilitar la entrada. Para obtener más información, vea [EnableWindow](/windows/win32/api/winuser/nf-winuser-enablewindow) en el Windows SDK.
...
Este método devuelve el miembro de datos `m_bHorz`. El valor predeterminado del miembro de datos `m_bHorz` es TRUE; se restablece en cada llamada al método [CMFCToolBarButton:: OnDraw](#ondraw) .
...
Si este miembro de datos se establece en TRUE, el marco de trabajo muestra la etiqueta de texto completo ampliando el botón. De lo contrario, el marco de trabajo trunca y anexa puntos suspensivos ( **...** ) a la etiqueta de texto.
...
Un identificador de comando-1 indica que el botón es un separador. Todos los separadores de botones tienen el estilo de TBBS_SEPARATOR. Vea [CMFCToolBarButton:: m_nStyle](#m_nstyle) para obtener más información sobre los estilos de botón.
...
De forma predeterminada, este método devuelve FALSE. Invalide este método para que devuelva TRUE si desea procesar el mensaje de WM_COMMAND o FALSE para indicar que la barra de herramientas primaria debe controlar el mensaje.
...
Lo llama el marco de trabajo cuando la barra de herramientas primaria controla un mensaje de WM_HELPHITTEST.
...
Para obtener más información sobre el mensaje de WM_HELPHITTEST, vea [TN028: ayuda contextual](../../mfc/tn028-context-sensitive-help-support.md).

##  <a name="onctlcolor"></a>CMFCToolBarButton:: OnCtlColor

Lo llama el marco de trabajo cuando la barra de herramientas primaria controla un mensaje de WM_CTLCOLOR.
...
El marco de trabajo llama a este método cuando la barra de herramientas primaria procesa el mensaje de WM_CTLCOLOR para un botón de la barra de herramientas que contiene un control de Windows. El marco de trabajo no llama a este método si el botón de la barra de herramientas no tiene ventanas.
...
Lo llama el marco de trabajo cuando la barra de herramientas primaria controla un mensaje de [WM_LBUTTONDBLCLK](/windows/win32/inputdev/wm-lbuttondblclk) .
...
El método `CMFCToolBar::OnLButtonDblClk` llama a este método cuando la barra de herramientas primaria controla un mensaje [WM_LBUTTONDBLCLK](/windows/win32/inputdev/wm-lbuttondblclk) .
...
*strToolTip*<br/>
enuncia Objeto `CString` que recibe el texto de información sobre herramientas personalizado.
...
##  <a name="onshow"></a>CMFCToolBarButton:: show
...
##  <a name="onsize"></a>CMFCToolBarButton:: Datasize
...
*pTI*<br/>
de `TOOLINFO` estructura que contiene información sobre una herramienta en un control ToolTip.
...
*str*<br/>
enuncia Objeto `CString` que recibe el texto de información sobre herramientas actualizado.
...
*srcItem*<br/>
de Objeto `COleDataSource` que almacena información de estado sobre la operación de arrastrar y colocar.
...
Para obtener más información sobre las operaciones OLE de arrastrar y colocar, vea [arrastrar y colocar de OLE](../../mfc/drag-and-drop-ole.md).
...
*analítico*<br/>
de Objeto `CArchive` del que se va a serializar.

### <a name="remarks"></a>Observaciones

Este método admite procesos de transferencia de datos, como el portapapeles o las operaciones de arrastrar y colocar. Lee o escribe propiedades del botón, como el identificador, la etiqueta de texto y el ID. de imagen de o en el objeto de `CArchive` proporcionado.
...
Rellena el objeto de `CAccessibilityData` proporcionado con datos de accesibilidad del botón de la barra de herramientas.
...
*lpszName*<br/>
de Nuevo nombre del formato del portapapeles global. No puede ser NULL.
