 ...
 *nUnits*, *nFractionalUnits*  
 Indicar las unidades y la parte fraccionaria (de 1/10, miles) del valor que se copiará en el nuevo `COleCurrency` objeto.  
...
- Construcciones de COleCurrency() un `COleCurrency` objeto se inicializa en 0 (cero).  
...
### <a name="remarks"></a>Comentarios  
 Si alguno de los operandos es null, el estado del resultante `COleCurrency` valor es null.  
