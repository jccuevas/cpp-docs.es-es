...
Para obtener más información sobre cómo usar `CSemaphore` objetos, consulte el artículo [Multithreading: Cómo usar las clases de sincronización](../../parallel/multithreading-how-to-use-the-synchronization-classes.md).
