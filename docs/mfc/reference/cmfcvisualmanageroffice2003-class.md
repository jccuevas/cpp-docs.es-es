...
|[CMFCVisualManagerOffice2003::OnDrawBarGripper](#ondrawbargripper)|Llamado por el marco de trabajo cuando dibuja el punto de sujeción de una barra de control. (Invalida `CMFCVisualManagerOfficeXP::OnDrawBarGripper`).|  
...
|[CMFCVisualManagerOffice2003::OnDrawRibbonCategoryTab](#ondrawribboncategorytab)|El marco de trabajo llama a este método cuando dibuja la pestaña de una categoría de cinta de opciones. (Invalida [CMFCVisualManager::OnDrawRibbonCategoryTab](../../mfc/reference/cmfcvisualmanager-class.md#ondrawribboncategorytab).)|  
...
|[CMFCVisualManagerOffice2003::OnEraseTabsArea](#onerasetabsarea)|El marco de trabajo llama a este método cuando borra el área de pestañas de una ventana de pestaña. (Invalida `CMFCVisualManagerOfficeXP::OnEraseTabsArea`).|  
...
### <a name="remarks"></a>Comentarios  
 El marco de trabajo llama a esta función cuando un [CMFCPopupMenu clase](../../mfc/reference/cmfcpopupmenu-class.md) objeto procesa un mensaje WM_PAINT y debe dibujar un título desplazable.  
...
##  <a name="onerasetabsframe"></a>  CMFCVisualManagerOffice2003::OnEraseTabsFrame  
 El marco de trabajo llama a este método cuando borra un fotograma en un [clase CMFCBaseTabCtrl](../../mfc/reference/cmfcbasetabctrl-class.md) objeto.  
...
### <a name="parameters"></a>Parámetros  
 ...
 [in] *pTabWnd*  
 Un puntero a una ventana de la ficha. El marco de trabajo borra un marco para este [clase CMFCBaseTabCtrl](../../mfc/reference/cmfcbasetabctrl-class.md).  
  
### <a name="return-value"></a>Valor devuelto  
 `TRUE` Si el método es correcto o `FALSE` si no es así.  
...
### <a name="parameters"></a>Parámetros  
 ...
 [in] *pButton*  
 Un puntero a un [clase CMFCAutoHideButton](../../mfc/reference/cmfcautohidebutton-class.md) objeto. El marco de trabajo rellena el fondo para que este botón de ocultación automática.  
...
##  <a name="onfillbarbackground"></a>  CMFCVisualManagerOffice2003::OnFillBarBackground  
 El marco de trabajo llama a este método cuando rellena el fondo de un [CBasePane clase](../../mfc/reference/cbasepane-class.md) objeto.  
...
##  <a name="onfillhighlightedarea"></a>  CMFCVisualManagerOffice2003::OnFillHighlightedArea  
 El marco de trabajo llama a este método cuando rellena el área resaltada de un botón de barra de herramientas.  
...
### <a name="parameters"></a>Parámetros  
 ...
 [in] *pBrush*  
 El pincel que se utiliza en rellena el área resaltado.  
...
### <a name="parameters"></a>Parámetros  
 ...
 [out] *clrText*  
 Una referencia a un `COLORREF` objeto donde este método almacena el color del texto del botón de página de outlook.  
...
### <a name="parameters"></a>Parámetros  
 ...
 [in] *pbrFill*  
 Un puntero al pincel el marco de trabajo se usa para rellenar la ventana de la ficha.  
...
##  <a name="onfilltasksgroupinterior"></a>  CMFCVisualManagerOffice2003::OnFillTasksGroupInterior  
 El marco de trabajo llama a este método cuando rellena el interior de un [clase CMFCTasksPaneTaskGroup](../../mfc/reference/cmfctaskspanetaskgroup-class.md) objeto.  
...
##  <a name="onfilltaskspanebackground"></a>  CMFCVisualManagerOffice2003::OnFillTasksPaneBackground  
 El marco de trabajo llama a este método cuando rellena el fondo de un [CMFCTasksPane clase](../../mfc/reference/cmfctaskspane-class.md) control.  
...
##  <a name="onhighlightquickcustomizemenubutton"></a>  CMFCVisualManagerOffice2003::OnHighlightQuickCustomizeMenuButton  
 Las llamadas de framework este método cuando se dibuja un resaltado personalizar rápida botón de menú.  
...
### <a name="remarks"></a>Comentarios  
 El marco de trabajo llama a este método como parte del procesamiento del mensaje WM_SYSCOLORCHANGE. Invalide este método en un administrador visual derivado si desea ejecutar código personalizado cuando se modifican los colores de la aplicación.  
  
##  <a name="setdefaultwinxpcolors"></a>  CMFCVisualManagerOffice2003::SetDefaultWinXPColors  
 Especifica si el administrador visual debe usar colores de tema de Windows XP nativo o colores que se obtienen del [GetSysColor](http://msdn.microsoft.com/library/windows/desktop/ms724371).  
...
### <a name="parameters"></a>Parámetros  
 ...
 Especifica si el administrador visual utilizará nativo colores de Windows XP.  
  
### <a name="remarks"></a>Comentarios  
 Si *bDefaultWinXPColors* es `TRUE`, el administrador visual utilizará los colores de Windows XP nativo como azul, oliva o plata. En caso contrario, el administrador visual utilizará los colores que se obtienen de `GetSysColor`. El administrador visual usa elementos visuales como `COLOR_3DFACE`, `COLOR_3DSHADOW`, `COLOR_3DHIGHLIGHT`, `COLOR_3DDKSHADOW`, y `COLOR_3DLIGHT`.  
  
 De forma predeterminada, un `CMFCVisualManagerOffice2003` objeto utiliza nativo colores de tema de Windows XP.  
...
### <a name="parameters"></a>Parámetros  
 ...
 `TRUE` Si el tema global de Windows XP se debe usar (valor predeterminado), o `FALSE` si no.  
...
### <a name="remarks"></a>Comentarios  
 ...
 Si un `CMFCVisualManagerOffice2003` objeto no usan un tema global, los elementos de interfaz gráfica de usuario dibujan utilizando el [CMFCVisualManagerOfficeXP clase](../../mfc/reference/cmfcvisualmanagerofficexp-class.md).  
