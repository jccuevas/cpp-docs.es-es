...
## <a name="remarks"></a>Comentarios  
 ...
 Índices de matriz siempre se inician en la posición 0. Puede decidir si desea corregir el límite superior o que la matriz se expanden cuando se agregan elementos más allá del límite actual. Memoria se asigna de forma contigua al límite superior, aunque algunos elementos son nulos.  
  
 En Win32, el tamaño de una `CObArray` objeto está limitado a la memoria disponible.  
  
 Al igual que con una matriz de C, el tiempo de acceso para un `CObArray` elemento indizado es constante y es independiente del tamaño de matriz.  
  
 `CObArray` incorpora la macro `IMPLEMENT_SERIAL` para admitir la serialización y el volcado de sus elementos. Si una matriz de `CObject` punteros se almacena en un archivo, con el operador de inserción sobrecargado o con el `Serialize` cada miembro de función `CObject` a su vez, se, serializa el elemento junto con su índice de matriz.  
  
 Si se necesita un volcado de individuales `CObject` elementos de una matriz, debe establecer la profundidad de la `CDumpContext` objeto en 1 o superior.  
...
>  Antes de usar una matriz, use `SetSize` para establecer su tamaño y asignarle memoria. Si no usa `SetSize`, al agregar elementos a la matriz, esta se reasigna y se copia con frecuencia. La reasignación y copia frecuentes son ineficaces y pueden fragmentar la memoria.  
 ...
 Derivación de la clase de matriz es similar a la derivación de la lista. Para obtener más información sobre la derivación de una clase de lista especial, consulte el artículo [colecciones](../../mfc/collections.md).  
...
### <a name="remarks"></a>Comentarios  
 ...
 La siguiente tabla muestra otro miembro de las funciones que son similares a `CObArray::Add`.  
...
##  <a name="append"></a>CObArray::Append  
 Llame a esta función miembro para agregar el contenido de otra matriz al final de la matriz.  
...
### <a name="remarks"></a>Comentarios  
 ...
 La siguiente tabla muestra otro miembro de las funciones que son similares a `CObArray::Append`.  
  
|Clase|Función miembro|  
|-----------|---------------------|  
|[CByteArray](../../mfc/reference/cbytearray-class.md)|**Anexar INT_PTR (const CByteArray aspecto** *src* **);**|  
|[CDWordArray](../../mfc/reference/cdwordarray-class.md)|**Anexar INT_PTR (const CDWordArray aspecto** *src* **);**|  
|[CPtrArray](../../mfc/reference/cptrarray-class.md)|**Anexar INT_PTR (const CPtrArray aspecto** *src* **);**|  
|[CStringArray](../../mfc/reference/cstringarray-class.md)|**Anexar INT_PTR (const CStringArray aspecto** *src* **);**|  
|[CUIntArray](../../mfc/reference/cuintarray-class.md)|**Anexar INT_PTR (const CUIntArray aspecto** *src* **);**|  
|[CWordArray](../../mfc/reference/cwordarray-class.md)|**Anexar INT_PTR (const CWordArray aspecto** *src* **);**|  
 ...
 **Copia** no libera memoria; sin embargo, si es necesario, **copia** puede asignar memoria adicional para acomodar los elementos que se copian en la matriz.  
 ...
 La siguiente tabla muestra otro miembro de las funciones que son similares a `CObArray::Copy`.  
  
|Clase|Función miembro|  
|-----------|---------------------|  
|[CByteArray](../../mfc/reference/cbytearray-class.md)|**anular copia (const CByteArray aspecto** *src* **);**|  
|[CDWordArray](../../mfc/reference/cdwordarray-class.md)|**anular copia (const CDWordArray aspecto** *src* **);**|  
|[CPtrArray](../../mfc/reference/cptrarray-class.md)|**anular copia (const CPtrArray aspecto** *src* **);**|  
|[CStringArray](../../mfc/reference/cstringarray-class.md)|**anular copia (const CStringArray aspecto** *src* **);**|  
|[CUIntArray](../../mfc/reference/cuintarray-class.md)|**anular copia (const CUIntArray aspecto** *src* **);**|  
|[CWordArray](../../mfc/reference/cwordarray-class.md)|**anular copia (const CWordArray aspecto** *src* **);**|  
...
##  <a name="cobarray"></a>CObArray::CObArray  
 Construye una cadena vacía `CObject` matriz de puntero.  
...
### <a name="remarks"></a>Comentarios  
 ...
 La siguiente tabla muestra otros constructores que son similares a `CObArray::CObArray`.  
...
### <a name="remarks"></a>Comentarios  
 Se utiliza para implementar el operador de asignación de la izquierda para las matrices. Tenga en cuenta que se trata de una función avanzada que debe usarse solo para implementar operadores de matriz especiales.  
  
 La siguiente tabla muestra otro miembro de las funciones que son similares a `CObArray::ElementAt`.  
  
|Clase|Función miembro|  
|-----------|---------------------|  
|[CByteArray](../../mfc/reference/cbytearray-class.md)|**BYTES aspecto ElementAt (INT_PTR** `nIndex` **);**|  
|[CDWordArray](../../mfc/reference/cdwordarray-class.md)|**DWORD aspecto ElementAt (INT_PTR** `nIndex` **);**|  
|[CPtrArray](../../mfc/reference/cptrarray-class.md)|**void\*aspecto ElementAt (INT_PTR** `nIndex` **);**|  
|[CStringArray](../../mfc/reference/cstringarray-class.md)|**CString aspecto ElementAt (INT_PTR** `nIndex` **);**|  
|[CUIntArray](../../mfc/reference/cuintarray-class.md)|**UINT aspecto ElementAt (INT_PTR** `nIndex` **);**|  
|[CWordArray](../../mfc/reference/cwordarray-class.md)|**WORD aspecto ElementAt (INT_PTR** `nIndex` **);**|  
...
### <a name="remarks"></a>Comentarios  
 ...
 La siguiente tabla muestra otro miembro de las funciones que son similares a `CObArray::FreeExtra`.  
...
>  Pasar un valor negativo o un valor mayor que el valor devuelto por `GetUpperBound` , provocará un error de aserción.  
 ...
 La siguiente tabla muestra otro miembro de las funciones que son similares a `CObArray::GetAt`.  
...
### <a name="remarks"></a>Comentarios  
 ...
 La siguiente tabla muestra otro miembro de las funciones que son similares a `CObArray::GetCount`.  
...
### <a name="remarks"></a>Comentarios  
 ...
 La siguiente tabla muestra otro miembro de las funciones que son similares a `CObArray::GetData`.  
...
|[CPtrArray](../../mfc/reference/cptrarray-class.md)|**void const\* \* () de GetData const; void\* \* (de GetData);**|  
|[CStringArray](../../mfc/reference/cstringarray-class.md)|**const CString\* GetData () const; CString\* (de GetData);**|  
...
### <a name="remarks"></a>Comentarios  
 Dado que los índices son de base cero, el tamaño es mayor que el índice más grande de 1.  
  
 La siguiente tabla muestra otro miembro de las funciones que son similares a `CObArray::GetSize`.  
...
### <a name="remarks"></a>Comentarios  
 ...
 La siguiente tabla muestra otro miembro de las funciones que son similares a `CObArray::GetUpperBound`.  
...
### <a name="parameters"></a>Parámetros  
 ...
 `newElement`  
 El `CObject` puntero que se colocarán en esta matriz. Un `newElement` del valor **NULL** está permitido.  
...
### <a name="remarks"></a>Comentarios  
 La primera versión de `InsertAt` inserta un elemento (o varias copias de un elemento) en el índice especificado en una matriz. En el proceso, pasa (incrementando el índice) al elemento existente en este índice y pasa todos los elementos por encima de él.  
  
 La segunda versión inserta todos los elementos de otro `CObArray` colección, empezando en la `nStartIndex` posición.  
  
 El `SetAt` función, en cambio, reemplaza un elemento de la matriz especificada y desplazar elementos.  
  
 La siguiente tabla muestra otro miembro de las funciones que son similares a `CObArray::InsertAt`.  
...
### <a name="return-value"></a>Valor devuelto  
 Distinto de cero si la matriz está vacía; en caso contrario, 0.  
...
### <a name="remarks"></a>Comentarios  
 ...
 La siguiente tabla muestra otros operadores que son similares a **[] CObArray::operator**.  
  
|Clase|Operador|  
|-----------|--------------|  
|[CByteArray](../../mfc/reference/cbytearray-class.md)|**Operador aspecto de BYTE [] (int_ptr** `nindex` ** \);**<br /><br /> **Operador BYTE [] (int_ptr** `nindex` ** \) const;**|  
|[CDWordArray](../../mfc/reference/cdwordarray-class.md)|**DWORD aspecto operator [] (int_ptr** `nindex` ** \);**<br /><br /> **DWORD operator [] (int_ptr** `nindex` ** \) const;**|  
|[CPtrArray](../../mfc/reference/cptrarray-class.md)|**void\*& operator [](int_ptr** `nindex` **\);**<br /><br /> **void\* operator [] (int_ptr** `nindex` ** \) const;**|  
|[CStringArray](../../mfc/reference/cstringarray-class.md)|**CString aspecto operator [] (int_ptr** `nindex` ** \);**<br /><br /> **CString operator [] (int_ptr** `nindex` ** \) const;**|  
|[CUIntArray](../../mfc/reference/cuintarray-class.md)|**UINT aspecto operator [] (int_ptr** `nindex` ** \);**<br /><br /> **UINT operator [] (int_ptr** `nindex` ** \) const;**|  
|[CWordArray](../../mfc/reference/cwordarray-class.md)|**WORD aspecto operator [] (int_ptr** `nindex` ** \);**<br /><br /> **WORD operator [] (int_ptr** `nindex` ** \) const;**|  
...
### <a name="remarks"></a>Comentarios  
 ...
 El `RemoveAll` función libera toda la memoria utilizada para el almacenamiento del puntero.  
  
 La siguiente tabla muestra otro miembro de las funciones que son similares a `CObArray::RemoveAll`.  
...
### <a name="remarks"></a>Comentarios  
 ...
 El `RemoveAt` función quita el `CObject` punteros a partir de la matriz, pero no elimina el propio objeto.  
  
 La siguiente tabla muestra otro miembro de las funciones que son similares a `CObArray::RemoveAt`.  
...
### <a name="parameters"></a>Parámetros  
 ...
 `newElement`  
 Puntero de objeto que se va a insertar en esta matriz. Un **NULL** se permite el valor.  
  
### <a name="remarks"></a>Comentarios  
 `SetAt`no se producirá la matriz crecer. Use `SetAtGrow` si desea que la matriz para crecer automáticamente.  
 ...
 La siguiente tabla muestra otro miembro de las funciones que son similares a `CObArray::SetAt`.  
...
### <a name="remarks"></a>Comentarios  
 ...
 La siguiente tabla muestra otro miembro de las funciones que son similares a `CObArray::SetAtGrow`.  
...
### <a name="remarks"></a>Comentarios  
 ...
 El `nGrowBy` parámetro afecta a la asignación de memoria interna mientras aumenta la matriz. Su uso nunca afecta al tamaño de la matriz devuelto por `GetSize` y `GetUpperBound`.  
  
 Si el tamaño de la matriz ha crecido, todos los recién asignado **CObject \* ** punteros se establecen en NULL.  
  
 La siguiente tabla muestra otro miembro de las funciones que son similares a `CObArray::SetSize`.  
