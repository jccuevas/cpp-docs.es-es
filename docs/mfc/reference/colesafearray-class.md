...
### <a name="parameters"></a>Parámetros  
 *varSrc*  
 Un objeto `VARIANT`. El *varSrc* parámetro debe tener el [VARTYPE](http://msdn.microsoft.com/317b911b-1805-402d-a9cb-159546bc88b4)VT_ARRAY.  
