...
> [!NOTE]
>  Las funciones DDX_Field son similares a las funciones DDX en que intercambian datos con controles en un formulario. Pero a diferencia de DDX, intercambian datos con los campos del objeto de conjunto de registros asociado de la vista, en lugar de con los campos de la propia vista de registros. Para obtener más información, vea `CRecordView` clases `CDaoRecordView`y.
...
|[DDX_FieldCBString](#ddx_fieldcbstring)|Transfiere `CString` datos entre un miembro de datos de un campo de conjunto de registros y el control de `CRecordView` edición `CDaoRecordView`de un cuadro combinado en un objeto o. Al mover los datos del conjunto de registros al control, esta función selecciona el elemento en el cuadro combinado que comienza con los caracteres de la cadena especificada.|
|[DDX_FieldCBStringExact](#ddx_fieldcbstringexact)|Transfiere `CString` datos entre un miembro de datos de un campo de conjunto de registros y el control de `CRecordView` edición `CDaoRecordView`de un cuadro combinado en un objeto o. Al mover los datos del conjunto de registros al control, esta función selecciona el elemento en el cuadro combinado que coincide exactamente con la cadena especificada.|
|[DDX_FieldCheck](#ddx_fieldcheck)|Transfiere datos booleanos entre un miembro de datos de un campo de conjunto de `CRecordView` registros `CDaoRecordView`y una casilla en o.|
|[DDX_FieldLBIndex](#ddx_fieldlbindex)|Transfiere datos enteros entre un miembro de datos de un campo de conjunto de registros y el índice de la selección actual en `CRecordView` un `CDaoRecordView`cuadro de lista de o.|
...
|[DDX_FieldLBStringExact](#ddx_fieldlbstringexact)|Administra la transferencia de `CString` datos entre un control de cuadro de lista y los miembros de datos de campo de un conjunto de registros. Cuando se mueven datos del conjunto de registros al control, esta función selecciona el primer elemento que coincide exactamente con la cadena especificada.|
|[DDX_FieldRadio](#ddx_fieldradio)|Transfiere datos enteros entre un miembro de datos de un campo de conjunto de registros y un grupo `CRecordView` de `CDaoRecordView`botones de radio de un objeto o.|
|[DDX_FieldScroll](#ddx_fieldscroll)|Establece u obtiene la posición de desplazamiento de un control de barra de `CRecordView` desplazamiento `CDaoRecordView`en o. Llame a desde la función [DoFieldExchange](../../mfc/reference/cdaorecordset-class.md#dofieldexchange) .|
|[DDX_FieldSlider](#ddx_fieldslider)|Sincroniza la posición Thumb de un control deslizante en una vista de registros y `int` un miembro de datos de campo de un conjunto de registros. |
|[DDX_FieldText](#ddx_fieldtext)|Hay disponibles versiones `int`sobrecargadas para transferir datos, **uint**, **Long**, `DWORD`, [CString](../../atl-mfc-shared/reference/cstringt-class.md), **float**, **Double**, **Short**, [COleDateTime](../../atl-mfc-shared/reference/coledatetime-class.md)y [COleCurrency](../../mfc/reference/colecurrency-class.md) entre un miembro de datos de un campo de conjunto de registros `CRecordView` y `CDaoRecordView`un cuadro de edición en un o.|

##  <a name="ddx_fieldcbindex"></a>  DDX_FieldCBIndex

La `DDX_FieldCBIndex` función sincroniza el índice del elemento seleccionado en el control de cuadro de lista de un control de cuadro combinado en una vista de registros `int` y un miembro de datos de campo de un conjunto de registros asociado a la vista de registros.
...
*index*<br/>
Referencia a un miembro de datos de campo en el `CRecordset` objeto `CDaoRecordset` o asociado.
...
La `DDX_FieldCBString` función administra la transferencia de datos [CString](../../atl-mfc-shared/reference/cstringt-class.md) entre el control de edición de un control de cuadro combinado en una vista de `CString` registros y un miembro de datos de campo de un conjunto de registros asociado a la vista de registros.
...
Consulte [DDX_FieldText](#ddx_fieldtext) para obtener un ejemplo de DDX_Field general. En el ejemplo se incluye una `DDX_FieldCBString`llamada a.
...
Consulte [DDX_FieldText](#ddx_fieldtext) para obtener un ejemplo de DDX_Field general. Las llamadas `DDX_FieldCBStringExact` a serían similares.
...
La `DDX_FieldCheck` función administra la transferencia de datos **int** entre un control de casilla en un objeto de cuadro de diálogo, vista de formulario o vista de control y un miembro de datos **int** del objeto de cuadro de diálogo, vista de formulario o vista de control.
...
Cuando `DDX_FieldCheck` se llama a, el *valor* se establece en el estado actual del control de casilla, o el estado del control se establece en *valor*, dependiendo de la dirección de la transferencia.
...
La `DDX_FieldLBIndex` función sincroniza el índice del elemento seleccionado en un control de cuadro de lista en una vista de registros y un miembro de datos de campo **int** de un conjunto de registros asociado a la vista de registros.
...
Consulte [DDX_FieldText](#ddx_fieldtext) para obtener un ejemplo de DDX_Field general. Las llamadas `DDX_FieldLBString` a serían similares.
...
La `DDX_FieldLBStringExact` función copia la selección actual de un control de cuadro de lista en una vista de registros en un miembro de datos de campo [CString](../../atl-mfc-shared/reference/cstringt-class.md) de un conjunto de registros asociado a la vista de registros.
...
Consulte [DDX_FieldText](#ddx_fieldtext) para obtener un ejemplo de DDX_Field general. Las llamadas `DDX_FieldLBStringExact` a serían similares.
...
La `DDX_FieldRadio` función asocia una variable miembro **int** de base cero del conjunto de registros de una vista de registros con el botón de radio seleccionado actualmente en un grupo de botones de radio de la vista de registros.
...
*nIDC*<br/>
IDENTIFICADOR del primer en un grupo (con el estilo WS_GROUP) de los controles de botón de radio adyacentes del objeto [CRecordView](../../mfc/reference/crecordview-class.md) o [CDaoRecordView](../../mfc/reference/cdaorecordview-class.md) .
...
Consulte [DDX_FieldText](#ddx_fieldtext) para obtener un ejemplo de DDX_Field general. Las llamadas `DDX_FieldRadio` a serían similares.
...
La `DDX_FieldScroll` función sincroniza la posición de desplazamiento de un control de barra de desplazamiento en una vista de registros y un miembro de datos de campo **int** de un conjunto de registros asociado a la vista de registros (o con cualquier variable de entero que elija para asignarlo).
...
Consulte [DDX_FieldText](#ddx_fieldtext) para obtener un ejemplo de DDX_Field general. Las llamadas `DDX_FieldScroll` a serían similares.
...
La `DDX_FieldSlider` función sincroniza la posición Thumb de un control deslizante en una vista de registros y un miembro de datos de campo **int** de un conjunto de registros asociado a la vista de registros (o con cualquier variable de entero que elija para asignarlo).
...
*pRecordset*<br/>
Puntero al objeto o `CRecordset` `CDaoRecordset` asociado con el que se intercambian los datos.
...
Para obtener más información sobre DDX, consulte [Intercambio y validación de datos de cuadro de diálogo](../dialog-data-exchange-and-validation.md). Para obtener ejemplos y más información sobre DDX `CRecordView` para `CDaoRecordView` los campos y, consulte [vistas de registros](../../data/record-views-mfc-data-access.md). Para obtener información acerca de los controles deslizantes, vea [usar CSliderCtrl](../using-csliderctrl.md).

### <a name="example"></a>Ejemplo

Consulte [DDX_FieldText](#ddx_fieldtext) para obtener un ejemplo de DDX_Field general. Las llamadas `DDX_FieldSlider` a serían similares.
...
La `DDX_FieldText` función administra la transferencia de **datos int**, **Short**, **Long**, DWORD, [CString](../../atl-mfc-shared/reference/cstringt-class.md), **float**, **Double**, **bool**o **byte** entre un control de cuadro de edición y los miembros de datos de campo de un DataRecordsets.
...
*value*<br/>
Referencia a un miembro de datos de campo en el `CRecordset` objeto `CDaoRecordset` o asociado. El tipo de datos del valor depende de las versiones sobrecargadas de `DDX_FieldText` que use.

*pRecordset*<br/>
Puntero al objeto [CRecordset](../../mfc/reference/crecordset-class.md) o [CDaoRecordset](../../mfc/reference/cdaorecordset-class.md) con el que se intercambian los datos. Este puntero permite `DDX_FieldText` detectar y establecer valores NULL.
...
La función `DoDataExchange` siguiente para un [CRecordView](../../mfc/reference/crecordview-class.md) contiene `DDX_FieldText` las llamadas de función para tres tipos `IDC_COURSELIST` de datos: es un cuadro combinado; los otros dos controles son cuadros de edición. Para la programación DAO, el parámetro *m_pSet* es un puntero a una [CRecordset](../../mfc/reference/crecordset-class.md) o [CDaoRecordset](../../mfc/reference/cdaorecordset-class.md).
