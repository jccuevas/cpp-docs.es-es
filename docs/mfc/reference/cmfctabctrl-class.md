---
title: Clase CMFCTabCtrl | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|[CMFCTabCtrl::AutoSizeWindow](#autosizewindow)|Especifica si el marco de trabajo es cambiar el tamaño de área de cliente de todas las ventanas de control de ficha cuando un elemento de interfaz de usuario de los cambios de control de ficha.|
...
|[CMFCTabCtrl::EnableTabDocumentsMenu](#enabletabdocumentsmenu)|Reemplaza los dos botones que se desplazan de las pestañas de ventana con un botón que abre un menú de ventanas con pestañas.|
|[CMFCTabCtrl::EnsureVisible](#ensurevisible)|Garantiza que una pestaña está visible.|
|[CMFCTabCtrl::GetDocumentIcon](#getdocumenticon)|Recupera el símbolo que está asociado a una pestaña en un menú emergente de ventanas con pestañas.|
|[CMFCTabCtrl::GetFirstVisibleTabNum](#getfirstvisibletabnum)|Recupera el índice de la primera pestaña está visible en el control de ficha actual.|
...
|`CMFCTabCtrl::GetThisClass`|Usa el marco de trabajo para obtener un puntero a la [CRuntimeClass](../../mfc/reference/cruntimeclass-structure.md) objeto que está asociado con este tipo de clase.|
...
|[CMFCTabCtrl::HideInactiveWindow](#hideinactivewindow)|Especifica si el marco de trabajo se va mostrar ventanas de control de ficha inactiva.|
|[CMFCTabCtrl::HideNoTabs](#hidenotabs)|Habilita o deshabilita el área de pestañas de dibujo si no hay ninguna pestaña visible.|
...
|[CMFCTabCtrl::IsActiveInMDITabGroup](#isactiveinmditabgroup)|Indica si la ficha actual de un control de ficha es la pestaña activa en un grupo de pestañas de interfaz de múltiples documentos.|
...
|[CMFCTabCtrl::IsDrawFrame](#isdrawframe)|Indica si la ventana con pestañas dibuja un rectángulo de marco en torno a los paneles de embedded.|
|[CMFCTabCtrl::IsFlatFrame](#isflatframe)|Indica si el marco que rodea el área de pestañas es plano o 3D.|
|[CMFCTabCtrl::IsFlatTab](#isflattab)|Indica si la apariencia de las fichas del control de ficha actual es fija o no.|
...
|[CMFCTabCtrl::IsMDITabGroup](#ismditabgroup)|Indica si el control de ficha actual se encuentra en el área cliente de una ventana de interfaz de múltiples documentos.|
...
|[CMFCTabCtrl::IsTabDocumentsMenu](#istabdocumentsmenu)|Indica si el control de pestaña muestra los botones de desplazamiento o un botón que muestra un menú de ventanas con pestañas.|
...
|[CMFCTabCtrl::SetFlatFrame](#setflatframe)|Especifica si se debe dibujar una plana o en un marco 3D alrededor del área de pestaña.|
...
|[CMFCTabCtrl::SetTabMaxWidth](#settabmaxwidth)|Especifica el ancho máximo de pestaña en una ventana con pestañas.|
...
|[CMFCTabCtrl::SynchronizeScrollBar](#synchronizescrollbar)|Dibuja una barra de desplazamiento horizontal en un control de ficha que muestra pestañas sin formato.|
...
- Pestaña estilos de control que incluyen 3D, plana y sin formato con una barra de desplazamiento horizontal compartida.

- Ubicado en la parte superior o inferior de la ventana de fichas.
...
1. Llame a [CBasePane::EnableDocking](../../mfc/reference/cbasepane-class.md#enabledocking) por lo que puede acoplar el control de ficha de acoplamiento actual en la ventana de marco principal.

1. Llame a [CFrameWndEx::DockPane](../../mfc/reference/cframewndex-class.md#dockpane) para acoplar la ventana con pestañas en el marco principal.

Para obtener un ejemplo de cómo crear una ventana con pestañas como una barra de control de acoplamiento, consulte [CTabbedPane (clase)](../../mfc/reference/ctabbedpane-class.md). Para usar `CMFCTabCtrl` como un control que no sean de acoplamiento, cree un `CMFCTabCtrl` objeto y, a continuación, llame a [CMFCTabCtrl::Create](#create).
...
Muestra la pestaña especificada del control de ficha actual y establece el foco en esa pestaña.
...
*nTab*<br/>
[in] Índice de base cero de una pestaña para mostrar, o -1 para especificar la pestaña activa.
...
Especifica si el marco de trabajo es cambiar el tamaño de área de cliente de todas las ventanas de control de ficha cuando un elemento de interfaz de usuario de los cambios de control de ficha.
...
*bAutoSize*<br/>
[in] TRUE para cambiar automáticamente el tamaño de las ventanas de control de ficha; en caso contrario, FALSE. El valor predeterminado es TRUE.
...
*Rect*<br/>
[in] Un rectángulo que delimita el control de ficha.
...
*bCloseBtn*<br/>
[in] TRUE para mostrar un botón Cerrar en la ficha; en caso contrario, FALSE. El valor predeterminado es FALSE.
...
|STYLE_FLAT_SHARED_HORZ_SCROLL|Crea un control de ficha con pestañas planas y una barra de desplazamiento que se puede desplazar las pestañas, si se recortan una ventana primaria.|
...
|STYLE_3D_ROUNDED_SCROLL|Crea un control de ficha con esquinas fichas y botones de desplazamiento en el estilo de Microsoft Visual Studio 2005.|
...
Este método se llama cuando se cambia la etiqueta de una pestaña. Este método desinfla los lados izquierdo y derecho del rectángulo especificado por la mitad del alto actual de pestaña y desinfla superior e inferior de una unidad.
...
Alterna entre una interfaz de usuario que utiliza dos botones para desplazarse por las fichas de la ventana y una interfaz que muestra un menú emergente de ventanas con pestañas.
...
TRUE si se realiza correctamente; FALSE si el *iTab* índice de parámetro no es válido.

### <a name="remarks"></a>Comentarios

Utilice este método para garantizar que la ficha especificada sea visible. El control de ficha se desplazará si es necesario.

##  <a name="getdocumenticon"></a>  CMFCTabCtrl::GetDocumentIcon

Recupera la imagen que está asociada a una pestaña en un menú emergente de ventanas con pestañas.
...
*nCmdID*<br/>
[in] El identificador de comando de una ficha en un menú emergente de ventanas con pestañas.
...
Recupera el índice de la primera pestaña está visible en el control de ficha actual.
...
Uno de los `CMFCTabCtrl::ResizeMode` valores de enumeración que especifica cómo se puede cambiar el tamaño del control de ficha. Para obtener una lista de valores posibles, vea la sección Comentarios de la [CMFCTabCtrl::SetResizeMode](#setresizemode) método.
...
Un puntero a un objeto de barra de desplazamiento o un valor NULL si no se creó con el estilo STYLE_FLAT_SHARED_HORZ_SCROLL el control de ficha.

### <a name="remarks"></a>Comentarios

Utilice este método para tener acceso a la barra de desplazamiento incrustado del control de ficha. Se crea un objeto de barra de desplazamiento solamente cuando el control de ficha no tiene el estilo STYLE_FLAT_SHARED_HORZ_SCROLL.
...
*rectTabAreaTop*<br/>
[out] Cuando este método vuelve, esta referencia contiene un rectángulo que delimita el área de etiqueta de la pestaña superior. Es el rectángulo en coordenadas de cliente. Esta referencia está vacía si no existe ningún área de la etiqueta de ficha en la parte superior del control de ficha.

*rectTabAreaBottom*<br/>
[out] Cuando este método vuelve, esta referencia contiene un rectángulo que delimita el área de etiqueta de ficha inferior. Es el rectángulo en coordenadas de cliente. Esta referencia está vacía si no existe ningún área de la etiqueta de ficha en la parte inferior del control de ficha.

### <a name="remarks"></a>Comentarios

Utilice este método para determinar el tamaño y posición del área de pestaña en la ventana con pestañas.
...
Use la [CMFCTabCtrl::SetTabMaxWidth](#settabmaxwidth) método para establecer el ancho máximo de ficha.
...
El alto del área de ficha si cualquier pestaña está visible, o cero si no hay pestaña está visible.
...
*Rect*<br/>
[out] Cuando este método finaliza, el *rect* parámetro contiene un rectángulo que delimita el área de pestañas.
...
*Rect*<br/>
[in, out] Cuando este método finaliza, este parámetro contiene un rectángulo que delimita el control de ficha actual.
...
Utilice este método para impedir que el control de ficha parpadea cuando el usuario cambia entre las páginas de control de ficha.
...
*bHide*<br/>
[in] Es TRUE, no se muestre una ventana inactiva; FALSE para mostrar una ventana inactiva. El valor predeterminado es TRUE.

### <a name="remarks"></a>Comentarios

##  <a name="hidenotabs"></a>  CMFCTabCtrl::HideNoTabs

Habilita o deshabilita el dibujo del área de pestaña si no hay ninguna pestaña visible.
...
*bHide*<br/>
[in] TRUE para habilitar el área de pestañas de dibujo FALSE para deshabilitar el dibujo. El valor predeterminado es TRUE.

### <a name="remarks"></a>Comentarios

##  <a name="hidesingletab"></a>  CMFCTabCtrl::HideSingleTab

Habilita o deshabilita el dibujo de la pestaña si no hay una sola ventana con pestañas.
...
*bHide*<br/>
[in] TRUE para no dibujar una pestaña de una sola ventana con pestañas; FALSE para dibujar una única pestaña. El valor predeterminado es TRUE.
...
Puede organizar varias ventanas de documento en ambos grupos de pestañas horizontales o verticales e intercambiar fácilmente los documentos de un grupo a otro.
...
TRUE si se muestra el botón Cerrar en la pestaña activa; FALSE si se muestra el botón Cerrar en la esquina superior derecha del área de ficha.

### <a name="remarks"></a>Comentarios

##  <a name="isdrawframe"></a>  CMFCTabCtrl::IsDrawFrame

Indica si la ventana con pestañas dibuja un rectángulo de marco en torno a los paneles de embedded.
...
Use la [CMFCTabCtrl::SetFlatFrame](#setflatframe) método para cambiar cómo el marco se dibuja.

##  <a name="isflattab"></a>  CMFCTabCtrl::IsFlatTab

Indica si la apariencia de las fichas del control de ficha actual es fija o no.
...
TRUE si la apariencia de las fichas del control de ficha actual es plana; en caso contrario, FALSE.
...
Indica si el control de ficha actual se encuentra en el área cliente de una ventana de interfaz de múltiples documentos.
...
TRUE si el control de ficha actual está en una ventana de área de cliente MDI; en caso contrario, FALSE.
...
TRUE si el control de pestaña tiene una barra de desplazamiento compartido; en caso contrario, FALSE.

### <a name="remarks"></a>Comentarios

Este método devuelve TRUE si el *estilo* parámetro de la [CMFCTabCtrl::Create](#create) método es STYLE_FLAT_SHARED_HORZ_SCROLL.

##  <a name="istabdocumentsmenu"></a>  CMFCTabCtrl::IsTabDocumentsMenu

Indica si el control de pestaña muestra los botones de desplazamiento o un botón que muestra un menú de ventanas con pestañas.
...
TRUE si se desplazan ventanas con pestañas con un menú emergente de etiquetas de la ventana con pestañas; FALSE si se desplazan ventanas con fichas con botones de desplazamiento hacia delante y hacia atrás.

### <a name="remarks"></a>Comentarios

Use la [CMFCTabCtrl::EnableTabDocumentsMenu](#enabletabdocumentsmenu) ventanas de fichas de método para especificar el método de desplazamiento.
...
El foco se realiza normalmente una nueva ventana con pestañas cuando se inserta y activa la pestaña. Establecer el `CMFCTabCtrl::m_bEnableActivate` variable miembro en FALSE para conservar el foco original. El valor predeterminado es TRUE.
...
|STYLE_3D_ROUNDED|Muestra las fichas tridimensionales que inclinado lados y esquinas redondeadas.|
|STYLE_3D_ROUNDED_SCROLL|Muestra las fichas tridimensionales que inclinado lados y esquinas redondeadas. Si hay varias pestañas que se pueden mostrar al mismo tiempo, el marco de trabajo muestra una flecha de lista desplegable y un menú de pestañas para que se active.|
|STYLE_3D_SCROLLED|Muestra las fichas tridimensionales, rectangulares. Si hay varias pestañas que se pueden mostrar al mismo tiempo, el marco de trabajo muestra una flecha de lista desplegable y un menú de pestañas para que se active.|
|STYLE_3D_VS2005|Muestra tridimensional, redondeado fichas que disponen de un lado inclinado y uno de los lados vertical.|
|STYLE_FLAT|Muestra las fichas bidimensionales que han inclinado lados izquierdo y derecho.|
|STYLE_FLAT_SHARED_HORZ_SCROLL|Muestra pestañas bidimensionales. Si hay varias pestañas que se pueden mostrar al mismo tiempo, el marco de trabajo muestra flechas de desplazamiento en los extremos del área de ficha.|
...
*pDataObject*<br/>
[in] Apunta a un objeto de datos que contiene los datos que el usuario arrastra.

*dwKeyState*<br/>
[in] Contiene el estado de las teclas modificadoras. Este parámetro es una combinación bit a bit (OR) de los siguientes valores: MK_CONTROL, MK_SHIFT, MK_ALT, MK_LBUTTON, MK_MBUTTON y MK_RBUTTON. Para obtener más información, consulte el **parámetros de mensaje** sección de [acerca de la entrada del Mouse](/windows/desktop/inputdev/about-mouse-input).
...
*pDataObject*<br/>
[in] Puntero a un [COleDataObject](../../mfc/reference/coledataobject-class.md) objeto que se está arrastrando sobre el destino de colocación.

*dwKeyState*<br/>
[in] El estado de las teclas modificadoras, que es una combinación bit a bit (OR) de MK_CONTROL, MK_SHIFT, MK_ALT, MK_LBUTTON, MK_MBUTTON y MK_RBUTTON. Para obtener más información, vea "Parámetros de mensaje" en [acerca de la entrada del Mouse](/windows/desktop/inputdev/about-mouse-input).

*punto*<br/>
[in] La posición del mouse actual.
...
Muestra un menú emergente de ventanas con pestañas, espera hasta que el usuario selecciona una ficha y hace que la pestaña seleccionada en la pestaña activa.
...
*punto*<br/>
[in] Las coordenadas de dónde desea mostrar el menú emergente.

### <a name="remarks"></a>Comentarios

##  <a name="setactiveinmditabgroup"></a>  CMFCTabCtrl::SetActiveInMDITabGroup

La pestaña actual de un control de ficha se establece como la pestaña activa en un grupo de pestañas de interfaz de múltiples documentos.
...
*iTab*<br/>
[in] Especifica el índice de base cero de la pestaña para activar.
...
*bIsBold*<br/>
[in] TRUE para utilizar una fuente en negrita para mostrar la etiqueta de la pestaña activa; FALSE para usar la fuente estándar para mostrar la etiqueta. El valor predeterminado es TRUE.

### <a name="remarks"></a>Comentarios

##  <a name="setdrawframe"></a>  CMFCTabCtrl::SetDrawFrame

Especifica si se dibuja un rectángulo de trama en torno a una barra incrustada.
...
*bDraw*<br/>
[in] TRUE para mostrar un rectángulo de marco alrededor de una barra incrustado; en caso contrario, FALSE. El valor predeterminado es TRUE.

### <a name="remarks"></a>Comentarios

##  <a name="setflatframe"></a>  CMFCTabCtrl::SetFlatFrame

Especifica si se debe dibujar una plana o en un marco 3D alrededor del área de pestaña.
...
*bFlat*<br/>
[in] TRUE para dibujar un marco plana (2D) alrededor del área de pestaña; FALSE para dibujar un marco tridimensional (3D). El valor predeterminado es TRUE.

*bRepaint*<br/>
[in] TRUE para volver a dibujar la ventana Inmediato; en caso contrario, FALSE. El valor predeterminado es TRUE.
...
*uiID*<br/>
[in] El identificador de un recurso de mapa de bits que contiene la lista de imágenes.
...
*resizeMode*<br/>
[in] Uno de los `CMFCTabCtrl::ResizeMode` valores de enumeración que especifica cómo se puede cambiar el tamaño del control de ficha. Para obtener una lista de valores posibles, vea la tabla en la sección Comentarios.
...
|RESIZE_HORIZ|El control de ficha se puede cambiar el tamaño horizontalmente pero no verticalmente.|

##  <a name="settabmaxwidth"></a>  CMFCTabCtrl::SetTabMaxWidth

Especifica el ancho máximo de pestaña en una ventana con pestañas.
...
Utilice este método para limitar el ancho de cada ficha en una ventana con pestañas. Este método es útil si las fichas tienen etiquetas muy largas. El [CMFCTabCtrl](../../mfc/reference/cmfctabctrl-class.md) constructor de clase inicializa el ancho máximo de ficha en 0, lo que realmente significa que el ancho no se limita.
...
Dibuja una barra de desplazamiento horizontal en un control de ficha que muestra pestañas sin formato.
...
*pScrollInfo*<br/>
[out] Puntero a un [SCROLLINFO](/windows/desktop/api/winuser/ns-winuser-tagscrollinfo) estructura o NULL. Cuando este método devuelve, y si este parámetro no es NULL, la estructura contiene todos los parámetros de la barra de desplazamiento. El valor predeterminado es NULL.
...
Este método afecta a solo un control de ficha que muestra pestañas sin formato. La barra de desplazamiento influye en todas las fichas al mismo tiempo.
