...
4.  Llame a [CBasePane::EnableDocking](../../mfc/reference/cbasepane-class.md#enabledocking) por lo que puede acoplar el control de ficha de acoplamiento actual en la ventana de marco principal.  
