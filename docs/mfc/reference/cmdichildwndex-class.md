...
|[CMDIChildWndEx::CanShowOnWindowsList](#canshowonwindowslist)|Devuelve `TRUE` si el nombre de ventana secundaria MDI se puede mostrar en el [CMFCWindowsManagerDialog clase](../../mfc/reference/cmfcwindowsmanagerdialog-class.md) cuadro de diálogo. De lo contrario, devuelve `FALSE`.|  
...
|[CMDIChildWndEx::EnableAutoHidePanes](#enableautohidepanes)|Habilita el modo de ocultación automática para los paneles al que se acoplan a los lados de la ventana especificados.|  
...
|[CMDIChildWndEx::GetPane](#getpane)|Busca un panel con el identificador del control especificado.|  
...
|[CMDIChildWndEx::GetTabProxyWnd](#gettabproxywnd)|Devuelve pestaña ventana proxy realmente registrado con pestañas de la barra de tareas de Windows 7.|  
|[CMDIChildWndEx::GetTaskbarPreviewWnd](#gettaskbarpreviewwnd)|Lo llama el marco cuando sea necesario obtener una ventana secundaria (normalmente una ventana de vista o divisor) que se mostrará en la miniatura de pestañas de barra de tareas de Windows 7.|  
|[CMDIChildWndEx::GetTaskbarThumbnailClipRect](#gettaskbarthumbnailcliprect)|Lo llama el marco cuando sea necesario seleccionar una parte del área de cliente de una ventana para mostrar como miniatura de la ventana en la barra de tareas.|  
|`CMDIChildWndEx::GetThisClass`|Lo llama el marco para obtener un puntero a la [CRuntimeClass](../../mfc/reference/cruntimeclass-structure.md) objeto que está asociado a este tipo de clase.|  
...
|[CMDIChildWndEx::InvalidateIconicBitmaps](#invalidateiconicbitmaps)|Invalida la representación en forma de mapa de bits de icono del elemento secundario MDI.|  
...
|[CMDIChildWndEx::IsRegisteredWithTaskbarTabs](#isregisteredwithtaskbartabs)|Devuelve TRUE si el elemento secundario MDI se registró correctamente con pestañas de la barra de tareas de Windows 7.|  
...
|[CMDIChildWndEx::IsTaskbarTabsSupportEnabled](#istaskbartabssupportenabled)|Indica si el formulario secundario MDI puede aparecer en las fichas de la barra de tareas de Windows 7.|  
...
|[CMDIChildWndEx::OnGetIconicLivePreviewBitmap](#ongeticoniclivepreviewbitmap)|Lo llama el marco cuando sea necesario obtener un mapa de bits para la previsualización del elemento secundario MDI.|  
|[CMDIChildWndEx::OnGetIconicThumbnail](#ongeticonicthumbnail)|Lo llama el marco cuando sea necesario obtener un mapa de bits de icono Vista en miniatura del elemento secundario MDI.|  
|[CMDIChildWndEx::OnMoveMiniFrame](#onmoveminiframe)|Lo llama el marco para mover una ventana de marco reducido.|  
|[CMDIChildWndEx::OnPressTaskbarThmbnailCloseButton](#onpresstaskbarthmbnailclosebutton)|Lo llama el marco cuando el usuario presiona el botón de cierre en miniatura de pestañas de la barra de tareas...|  
...
|[CMDIChildWndEx::OnTaskbarTabThumbnailActivate](#ontaskbartabthumbnailactivate)|Lo llama el marco cuando la miniatura de pestañas de la barra de tareas debe procesar el mensaje WM_ACTIVATE.|  
|[CMDIChildWndEx::OnTaskbarTabThumbnailMouseActivate](#ontaskbartabthumbnailmouseactivate)|Lo llama el marco cuando la miniatura de pestañas de la barra de tareas debe procesar el mensaje WM_MOUSEACTIVATE.|  
|[CMDIChildWndEx::OnTaskbarTabThumbnailStretch](#ontaskbartabthumbnailstretch)|Lo llama el marco cuando sea necesario ajustar un mapa de bits para Windows 7 barra de tareas ficha Vista previa en miniatura del elemento secundario MDI.|  
|[CMDIChildWndEx::OnUpdateFrameTitle](#onupdateframetitle)|Lo llama el marco de trabajo para actualizar el título de marco. (Invalida `CMDIChildWnd::OnUpdateFrameTitle`).|  
...
|[CMDIChildWndEx::UpdateTaskbarTabIcon](#updatetaskbartabicon)|Icono de pestaña de barra de tareas de Windows 7 de las actualizaciones.|  
  
## <a name="remarks"></a>Comentarios  
 Para aprovechar las ventajas de las características de acoplamiento extendidas en las aplicaciones MDI, derive la clase de ventana secundaria MDI de la aplicación `CMDIChildWndEx` en lugar de [CMDIChildWnd](../../mfc/reference/cmdichildwnd-class.md).  
...
### <a name="return-value"></a>Valor devuelto  
 `TRUE` Si se puede mostrar la ventana en la **Windows** cuadro de diálogo; en caso contrario, `FALSE`.  
...
### <a name="remarks"></a>Comentarios  
 El `lpRect` parámetro no se utiliza.  
...
### <a name="parameters"></a>Parámetros  
 `pBar`  
 Un puntero al panel que se acopla.  
...
### <a name="remarks"></a>Comentarios  
 ...
 Llamar a este método cuando desea acoplar varios paneles en orden predefinido.  
  
##  <a name="enableautohidepanes"></a>  CMDIChildWndEx::EnableAutoHidePanes  
 Habilita el modo de ocultación automática para los paneles al que se acoplan a los lados de la ventana especificados.  
...
### <a name="parameters"></a>Parámetros  
 [in] `dwDockStyle`  
 Especifica los lados de la ventana de marco principal que está habilitada. Utilice uno o varios de los siguientes indicadores.  
...
### <a name="remarks"></a>Comentarios  
 Llame a este método para activar la alineación de acoplamiento para el marco principal. Puede pasar una combinación de marcas CBRS_ALIGN_ (para obtener más información, consulte [CControlBar:: EnableDocking](../../mfc/reference/ccontrolbar-class.md#enabledocking)).  
...
### <a name="remarks"></a>Comentarios  
 Un documento es lo que muestra la ventana secundaria MDI. Por lo general, la ventana muestra los datos que se carga desde o se guardan en un archivo. Por lo tanto, el nombre del documento es el nombre del archivo. La implementación predeterminada de `GetDocumentName` devuelve una cadena que se obtienen de `CDocument::GetPathName`.  
  
 Si la ventana muestra un documento que no se carga desde un archivo, invalide este método en una clase derivada y devolver un identificador de documento único.  
 ...
 Cuando el marco de trabajo es restaurar el estado más adelante, el nombre del documento se lee desde el registro y pasa a [CMDIFrameWndEx::CreateDocumentWindow](../../mfc/reference/cmdiframewndex-class.md#createdocumentwindow). Invalide este método en un [CMDIFrameWndEx](../../mfc/reference/cmdiframewndex-class.md)-clase derivada y crear o abrir un documento que tiene este nombre y leer el archivo que tiene este nombre. Si el documento no se basa en un archivo, crear del documento basándose en el propio identificador de documento. Debe realizar las acciones anteriores sólo si desea guardar y restaurar los documentos.  
...
##  <a name="getframeicon"></a>  CMDIChildWndEx::GetFrameIcon  
 Lo llama el marco de trabajo para recuperar el icono de la ventana secundaria MDI.  
...
### <a name="remarks"></a>Comentarios  
 El marco de trabajo para determinar qué icono para mostrar en la ficha MDI que contiene la ventana de marco secundaria MDI se llama a este método.  
...
##  <a name="getframetext"></a>  CMDIChildWndEx::GetFrameText  
 Lo llama el marco de trabajo para recuperar el texto de la ventana secundaria MDI.  
...
### <a name="remarks"></a>Comentarios  
 Este método se llama el marco de trabajo para determinar qué texto que se muestra en la ficha MDI que contiene la ventana de marco secundaria MDI.  
...
### <a name="return-value"></a>Valor devuelto  
 Un puntero al panel si encuentra, de lo contrario `NULL`.  
...
##  <a name="gettabbedpane"></a>  CMDIChildWndEx::GetTabbedPane  
 Devuelve un puntero a un panel acoplable que forma parte de un grupo de MDI pestañas.  
...
### <a name="return-value"></a>Valor devuelto  
 Un puntero a un panel acoplable que forma parte de un grupo de MDI documentos con fichas.  
...
### <a name="parameters"></a>Parámetros  
 [in] `bPreview`  
 Si `TRUE`, entrar en el modo de vista previa de impresión. Si `FALSE`, salir del modo de vista previa de impresión.  
  
 [in] `pState`  
 Un puntero a la estructura de estado de vista previa de impresión.  
  
##  <a name="onupdateframetitle"></a>  CMDIChildWndEx::OnUpdateFrameTitle  
 Lo llama el marco de trabajo para actualizar el título de marco.  
...
### <a name="parameters"></a>Parámetros  
 [in] `bNotify`  
 Si `TRUE`, el elemento en el contexto activo de la ventana recibe la notificación del cambio de diseño.  
...
##  <a name="unregistertaskbartab"></a>  CMDIChildWndEx::UnregisterTaskbarTab  
 Quita al elemento secundario MDI de pestañas de la barra de tareas de Windows 7.  
...
### <a name="parameters"></a>Parámetros  
 ...
 Determina si esta función es necesario comprobar el número de elementos secundarios MDI registrado con pestañas MDI. Si este número es 0, esta función quita el rectángulo de recorte de la miniatura de la barra de tareas de la aplicación.  
  
### <a name="remarks"></a>Comentarios  
  
##  <a name="settaskbarthumbnailcliprect"></a>  CMDIChildWndEx::SetTaskbarThumbnailClipRect  
 Lo llama el marco para establecer el rectángulo de recorte para seleccionar una parte del área de cliente de una ventana para mostrar como miniatura de la ventana en la barra de tareas.  
...
### <a name="parameters"></a>Parámetros  
 `pWndBefore`  
 Un puntero a la ventana secundaria MDI cuya vista en miniatura se inserta a la izquierda. Esta ventana ya debe estar registrada a través de `RegisterTaskbarTab`. Si este valor es `NULL`, la miniatura de la nueva se agrega al final de la lista.  
...
##  <a name="ontaskbartabthumbnailstretch"></a>  CMDIChildWndEx::OnTaskbarTabThumbnailStretch  
 Lo llama el marco cuando sea necesario ajustar un mapa de bits para una Windows 7 barra de tareas ficha Vista previa en miniatura de la ventana secundaria MDI.  
...
### <a name="parameters"></a>Parámetros  
 `hBmpDst`  
 Un identificador a un mapa de bits de destino.  
  
 `rectDst`  
 Especifica el rectángulo de destino.  
  
 `hBmpSrc`  
 Un identificador a un mapa de bits de origen.  
  
 `rectSrc`  
 Especifica el rectángulo de origen.  
  
### <a name="remarks"></a>Comentarios  
 Requirementher o le sí sí sí le le le **:** afxmdichildwndex.h  
  
##  <a name="ontaskbartabthumbnailmouseactivate"></a>  CMDIChildWndEx::OnTaskbarTabThumbnailMouseActivate  
 Llamado por el marco de trabajo cuando la miniatura de pestañas de la barra de tareas debe procesar el mensaje WM_MOUSEACTIVATE.  
...
##  <a name="ontaskbartabthumbnailactivate"></a>  CMDIChildWndEx::OnTaskbarTabThumbnailActivate  
 Llamado por el marco de trabajo cuando la miniatura de pestañas de la barra de tareas debe procesar el mensaje WM_ACTIVATE.  
...
##  <a name="onpresstaskbarthmbnailclosebutton"></a>  CMDIChildWndEx::OnPressTaskbarThmbnailCloseButton  
 Lo llama el marco cuando el usuario presiona el botón de cierre en la miniatura de pestañas de la barra de tareas.  
...
##  <a name="ongeticonicthumbnail"></a>  CMDIChildWndEx::OnGetIconicThumbnail  
 Lo llama el marco cuando sea necesario obtener un mapa de bits para la miniatura del icono de la ventana secundaria MDI.  
...
### <a name="parameters"></a>Parámetros  
 `nWidth`  
 Especifica el ancho del mapa de bits necesarios.  
  
 `nHeight`  
 Especifica el alto del mapa de bits necesarios.  
  
### <a name="remarks"></a>Comentarios  
  
##  <a name="ongeticoniclivepreviewbitmap"></a>  CMDIChildWndEx::OnGetIconicLivePreviewBitmap  
 Lo llama el marco cuando sea necesario obtener un mapa de bits para la previsualización de la ventana secundaria MDI.  
...
### <a name="parameters"></a>Parámetros  
 `bIsMDIChildActive`  
 Este parámetro es `TRUE` si se solicita el mapa de bits para la ventana secundaria MDI, que está actualmente activa y la ventana principal no se minimiza. El procesamiento en este caso predeterminado toma una instantánea de la ventana principal.  
  
 `ptLocation`  
 Especifica la ubicación del mapa de bits en la ventana principal (nivel superior) coordenadas de cliente de la ventana. El destinatario debe proporcionar este punto.  
  
### <a name="return-value"></a>Valor devuelto  
 Si ha procesado, devuelve un identificador a un mapa de bits de 32 bpp válido, en caso contrario, `NULL`.  
  
### <a name="remarks"></a>Comentarios  
 Invalide este método en una clase derivada y devolver un mapa de bits de 32 bpp válido para la previsualización del elemento secundario MDI. Se llama a este método solo cuando se muestra el formulario secundario MDI en fichas de la barra de tareas de Windows 7. Si devuelve `NULL`, MFC llama a los controladores predeterminados y obtenga con mapas de bits `PrintClient` o `PrintWindow`.  
...
### <a name="return-value"></a>Valor devuelto  
 Devuelve `TRUE` si selección automática de una parte del área de cliente de una ventana para mostrar está habilitado; en caso contrario `FALSE`.  
  
### <a name="remarks"></a>Comentarios  
  
##  <a name="istaskbartabssupportenabled"></a>  CMDIChildWndEx::IsTaskbarTabsSupportEnabled  
 Indica si el formulario secundario MDI puede aparecer en las fichas de la barra de tareas de Windows 7.  
...
### <a name="return-value"></a>Valor devuelto  
 `TRUE` Si el formulario secundario MDI puede aparecer en las fichas de la barra de tareas de Windows 7; `FALSE` si la ventana secundaria MDI no puede aparecer en las pestañas de barra de tareas de Windows 7.  
...
### <a name="return-value"></a>Valor devuelto  
 `TRUE` Si la ventana secundaria MDI se registra con pestañas de la barra de tareas de Windows 7; en caso contrario, `FALSE`.  
  
### <a name="remarks"></a>Comentarios  
  
##  <a name="invalidateiconicbitmaps"></a>  CMDIChildWndEx::InvalidateIconicBitmaps  
 Invalida una representación de icono de mapa de bits de un elemento secundario MDI.  
...
### <a name="return-value"></a>Valor devuelto  
 Devuelve `FALSE` si se deshabilita la compatibilidad de la barra de tareas de Windows 7 o la ventana secundaria MDI no está registrada con pestañas de la barra de tareas de Windows 7; de lo contrario devuelve `TRUE`.  
...
##  <a name="gettaskbarthumbnailcliprect"></a>  CMDIChildWndEx::GetTaskbarThumbnailClipRect  
 Lo llama el marco cuando sea necesario seleccionar una parte del área de cliente de una ventana para mostrar como miniatura de la ventana en la barra de tareas.  
...
### <a name="return-value"></a>Valor devuelto  
 Un rectángulo en coordenadas de windows. Este rectángulo se asigna al área de cliente del marco de nivel superior. El rectángulo debe estar vacío para borrar el rectángulo de recorte.  
  
### <a name="remarks"></a>Comentarios  
  
##  <a name="gettaskbarpreviewwnd"></a>  CMDIChildWndEx::GetTaskbarPreviewWnd  
 Lo llama el marco cuando sea necesario obtener una ventana secundaria (normalmente una ventana de vista o divisor) que se muestre en una miniatura de pestañas de la barra de tareas de Windows 7.  
...
### <a name="return-value"></a>Valor devuelto  
 Debe devolver un puntero válido a una `CWnd` relacionados con este elemento secundario MDI objeto cuya vista previa debe mostrarse en una ficha de la barra de tareas de Windows 7. La implementación predeterminada devuelve una ventana secundaria de este elemento secundario MDI con el Id. de control AFX_IDW_PANE_FIRST (que suele ser un `CView`-clase derivada).  
  
### <a name="remarks"></a>Comentarios  
  
##  <a name="gettabproxywnd"></a>  CMDIChildWndEx::GetTabProxyWnd  
 Devuelve la ventana de proxy de la pestaña registrada con pestañas de la barra de tareas de Windows 7.  
...
### <a name="remarks"></a>Comentarios  
 Invalide este método en una clase derivada y devolver `FALSE` para deshabilitar la apariencia de este elemento secundario MDI en fichas de la barra de tareas de Windows 7.  
  
##  <a name="activatetoplevelframe"></a>  CMDIChildWndEx::ActivateTopLevelFrame  
 Lo llama el marco de trabajo para activar el marco de nivel superior cuando se activa la aplicación de una pestaña de la barra de tareas.  
