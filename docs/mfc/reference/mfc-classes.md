...
[CAnimationManagerEventHandler (clase)](../../mfc/reference/canimationmanagereventhandler-class.md)<br/>
...
[CAnimationPoint (clase)](../../mfc/reference/canimationpoint-class.md)<br/>
Implementa la funcionalidad de un punto cuyas coordenadas se pueden animar.

[CAnimationRect (clase)](../../mfc/reference/canimationrect-class.md)<br/>
Implementa la funcionalidad de un rectángulo cuyos lados se pueden animar.

[CAnimationSize (clase)](../../mfc/reference/canimationsize-class.md)<br/>
...
[CAnimationVariable (clase)](../../mfc/reference/canimationvariable-class.md)<br/>
...
[CArchiveException (clase)](../../mfc/reference/carchiveexception-class.md)<br/>
...
[CBaseKeyFrame (clase)](../../mfc/reference/cbasekeyframe-class.md)<br/>
Implementa la funcionalidad básica de un fotograma clave.

[CBasePane (clase)](../../mfc/reference/cbasepane-class.md)<br/>
...
[CBaseTransition (clase)](../../mfc/reference/cbasetransition-class.md)<br/>
...
[CCachedDataPathProperty (clase)](../../mfc/reference/ccacheddatapathproperty-class.md)<br/>
...
[CCheckListBox (clase)](../../mfc/reference/cchecklistbox-class.md)<br/>
...
Administra la llamada de funciones de Windows [GetDC](/windows/desktop/api/winuser/nf-winuser-getdc) en tiempo de construcción y [ReleaseDC](/windows/desktop/api/winuser/nf-winuser-releasedc) en tiempo de destrucción.
...
[CComboBoxEx (clase)](../../mfc/reference/ccomboboxex-class.md)<br/>
...
[CConstantTransition (clase)](../../mfc/reference/cconstanttransition-class.md)<br/>
...
[CCustomInterpolator (clase)](../../mfc/reference/ccustominterpolator-class.md)<br/>
Implementa un interpolador básico.

[CCustomTransition (clase)](../../mfc/reference/ccustomtransition-class.md)<br/>
Implementa una transición personalizada.

[CD2DBitmap (clase)](../../mfc/reference/cd2dbitmap-class.md)<br/>
Contenedor para `ID2D1Bitmap`.

[CD2DBitmapBrush (clase)](../../mfc/reference/cd2dbitmapbrush-class.md)<br/>
...
[CD2DLayer (clase)](../../mfc/reference/cd2dlayer-class.md)<br/>
Contenedor para `ID2D1Layer`.

[CD2DLinearGradientBrush (clase)](../../mfc/reference/cd2dlineargradientbrush-class.md)<br/>
Contenedor para `ID2D1LinearGradientBrush`.

[CD2DMesh (clase)](../../mfc/reference/cd2dmesh-class.md)<br/>
Contenedor para `ID2D1Mesh`.

[CD2DPathGeometry (clase)](../../mfc/reference/cd2dpathgeometry-class.md)<br/>
Contenedor para `ID2D1PathGeometry`.

[CD2DPointF (clase)](../../mfc/reference/cd2dpointf-class.md)<br/>
Contenedor para `D2D1_POINT_2F`.

[CD2DPointU (clase)](../../mfc/reference/cd2dpointu-class.md)<br/>
Contenedor para `D2D1_POINT_2U`.

[CD2DRadialGradientBrush (clase)](../../mfc/reference/cd2dradialgradientbrush-class.md)<br/>
Contenedor para `ID2D1RadialGradientBrush`.

[CD2DRectF (clase)](../../mfc/reference/cd2drectf-class.md)<br/>
Contenedor para `D2D1_RECT_F`.

[CD2DRectU (clase)](../../mfc/reference/cd2drectu-class.md)<br/>
...
[CD2DRoundedRect (clase)](../../mfc/reference/cd2droundedrect-class.md)<br/>
Contenedor para `D2D1_ROUNDED_RECT`.

[CD2DSizeF (clase)](../../mfc/reference/cd2dsizef-class.md)<br/>
Contenedor para `D2D1_SIZE_F`.

[CD2DSizeU (clase)](../../mfc/reference/cd2dsizeu-class.md)<br/>
...
[CD2DTextLayout (clase)](../../mfc/reference/cd2dtextlayout-class.md)<br/>
...
[CDaoException (clase)](../../mfc/reference/cdaoexception-class.md)<br/>
...
[CDaoFieldExchange (clase)](../../mfc/reference/cdaofieldexchange-class.md)<br/>
...
[CDataExchange (clase)](../../mfc/reference/cdataexchange-class.md)<br/>
...
[CDBVariant (clase)](../../mfc/reference/cdbvariant-class.md)<br/>
...
[CDiscreteTransition (clase)](../../mfc/reference/cdiscretetransition-class.md)<br/>
...
[CDockingPanesRow (clase)](../../mfc/reference/cdockingpanesrow-class.md)<br/>
...
[CDrawingManager (clase)](../../mfc/reference/cdrawingmanager-class.md)<br/>
Implementa algoritmos de dibujo complejos.

[CDumpContext (clase)](../../mfc/reference/cdumpcontext-class.md)<br/>
...
[CEvent (clase)](../../mfc/reference/cevent-class.md)<br/>
...
[CFolderPickerDialog (clase)](../../mfc/reference/cfolderpickerdialog-class.md)<br/>
...
[CHttpFile (clase)](../../mfc/reference/chttpfile-class.md)<br/>
Proporciona la funcionalidad para solicitar y leer archivos en un servidor HTTP.

[CHwndRenderTarget (clase)](../../mfc/reference/chwndrendertarget-class.md)<br/>
...
[CInstantaneousTransition (clase)](../../mfc/reference/cinstantaneoustransition-class.md)<br/>
...
[CInterpolatorBase (clase)](../../mfc/reference/cinterpolatorbase-class.md)<br/>
...
[CInvalidArgException (clase)](../../mfc/reference/cinvalidargexception-class.md)<br/>
...
[CJumpList (clase)](../../mfc/reference/cjumplist-class.md)<br/>
...
[CLinearTransition (clase)](../../mfc/reference/clineartransition-class.md)<br/>
...
[CMenu (clase)](../../mfc/reference/cmenu-class.md)<br/>
Una encapsulación de `HMENU`de Windows.

[CMenuTearOffManager (clase)](../../mfc/reference/cmenutearoffmanager-class.md)<br/>
...
[CMetaFileDC (clase)](../../mfc/reference/cmetafiledc-class.md)<br/>
...
[CMFCReBar (clase)](../../mfc/reference/cmfcrebar-class.md)<br/>
...
[CMFCRibbonGalleryMenuButton (clase)](../../mfc/reference/cmfcribbongallerymenubutton-class.md)<br/>
Implementa un botón de menú de la cinta que contiene galerías de la cinta.

[CMFCRibbonLabel (clase)](../../mfc/reference/cmfcribbonlabel-class.md)<br/>
...
[CMFCVisualManagerOffice2003 (clase)](../../mfc/reference/cmfcvisualmanageroffice2003-class.md)<br/>
...
[CMiniFrameWnd (clase)](../../mfc/reference/cminiframewnd-class.md)<br/>
...
Representa una secuencia de datos ([IStream](/windows/desktop/api/objidl/nn-objidl-istream)) nombrada por un [IMoniker](/windows/desktop/api/objidl/nn-objidl-imoniker).
...
[CMutex (clase)](../../mfc/reference/cmutex-class.md)<br/>
...
[CNotSupportedException (clase)](../../mfc/reference/cnotsupportedexception-class.md)<br/>
...
[COleCmdUI (clase)](../../mfc/reference/colecmdui-class.md)<br/>
...
[COleDocObjectItem (clase)](../../mfc/reference/coledocobjectitem-class.md)<br/>
...
[COleDropTarget (clase)](../../mfc/reference/coledroptarget-class.md)<br/>
Proporciona el mecanismo de comunicación entre una ventana y las bibliotecas OLE.

[COleException (clase)](../../mfc/reference/coleexception-class.md)<br/>
...
[COleMessageFilter (clase)](../../mfc/reference/colemessagefilter-class.md)<br/>
...
[COlePasteSpecialDialog (clase)](../../mfc/reference/colepastespecialdialog-class.md)<br/>
...
[COleSafeArray (clase)](../../mfc/reference/colesafearray-class.md)<br/>
...
Encapsula el tipo de datos [VARIANT](/previous-versions/windows/desktop/api/oaidl/ns-oaidl-tagvariant) .
...
[CPaneDialog (clase)](../../mfc/reference/cpanedialog-class.md)<br/>
Admite un cuadro de diálogo no modal, acoplable.

[CPaneDivider (clase)](../../mfc/reference/cpanedivider-class.md)<br/>
...
[CPoint (clase)](../../atl-mfc-shared/reference/cpoint-class.md)<br/>
...
[CPrintDialogEx (clase)](../../mfc/reference/cprintdialogex-class.md)<br/>
...
[CPropExchange (clase)](../../mfc/reference/cpropexchange-class.md)<br/>
...
[CReBar (clase)](../../mfc/reference/crebar-class.md)<br/>
Barra de control que proporciona información de diseño, persistencia y estado para controles rebar.
...
[CRecentFileList (clase)](../../mfc/reference/crecentfilelist-class.md)<br/>
...
[CResourceException (clase)](../../mfc/reference/cresourceexception-class.md)<br/>
Se genera cuando Windows no puede encontrar o asignar un recurso solicitado.

[CReversalTransition (clase)](../../mfc/reference/creversaltransition-class.md)<br/>
Encapsula una transición de inversión.

[CRgn (clase)](../../mfc/reference/crgn-class.md)<br/>
...
[CRichEditCtrl (clase)](../../mfc/reference/cricheditctrl-class.md)<br/>
...
[CSettingsStoreSP (clase)](../../mfc/reference/csettingsstoresp-class.md)<br/>
...
[CSimpleException (clase)](../../mfc/reference/csimpleexception-class.md)<br/>
...
[CTypedPtrList (clase)](../../mfc/reference/ctypedptrlist-class.md)<br/>
Proporciona un "contenedor" de tipo seguro para objetos de clase `CPtrList`.

[CTypedPtrMap (clase)](../../mfc/reference/ctypedptrmap-class.md)<br/>
...
[CUIntArray (clase)](../../mfc/reference/cuintarray-class.md)<br/>
...
[CWaitCursor (clase)](../../mfc/reference/cwaitcursor-class.md)<br/>
