---
title: Clases MFC | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
> [!IMPORTANT]
>  Las clases MFC y sus miembros no se puede usar en aplicaciones que se ejecutan en el tiempo de ejecución de Windows.  
...
## <a name="in-this-section"></a>En esta sección  
 ...
 [CAnimationBaseObject (clase)](../../mfc/reference/canimationbaseobject-class.md)  
 La clase base para todos los objetos de animación.  
  
 [CAnimationColor (clase)](../../mfc/reference/canimationcolor-class.md)  
 Implementa la funcionalidad de un color cuyos componentes rojo, verde y azul se pueden animar.  
  
 [CAnimationController (clase)](../../mfc/reference/canimationcontroller-class.md)  
 Implementa el controlador de animación, que proporciona una interfaz central para crear y administrar las animaciones.  
  
 [CAnimationGroup (clase)](../../mfc/reference/canimationgroup-class.md)  
 Implementa el controlador de animación, que proporciona una interfaz central para crear y administrar las animaciones.  
  
 [CAnimationManagerEventHandler (clase)](../../mfc/reference/canimationmanagereventhandler-class.md)  
 ...
 [CAnimationPoint (clase)](../../mfc/reference/canimationpoint-class.md)  
 Implementa la funcionalidad de un punto cuyas coordenadas se pueden animar.  
  
 [CAnimationRect (clase)](../../mfc/reference/canimationrect-class.md)  
 Implementa la funcionalidad de un rectángulo cuyos lados se pueden animar.  
  
 [CAnimationSize (clase)](../../mfc/reference/canimationsize-class.md)  
 Implementa la funcionalidad de un objeto cuyas dimensiones se pueden animar.  
  
 [CAnimationStoryboardEventHandler (clase)](../../mfc/reference/canimationstoryboardeventhandler-class.md)  
 ...
 [CAnimationTimerEventHandler (clase)](../../mfc/reference/canimationtimereventhandler-class.md)  
 Implementa una devolución de llamada, a la que llama la API de animación cuando se producen eventos de control de tiempo.  
  
 [CAnimationValue (clase)](../../mfc/reference/canimationvalue-class.md)  
 Implementa la funcionalidad del objeto de animación que tiene un valor.  
  
 [CAnimationVariable (clase)](../../mfc/reference/canimationvariable-class.md)  
 Representa una variable de animación.  
  
 [CAnimationVariableChangeHandler (clase)](../../mfc/reference/canimationvariablechangehandler-class.md)  
 Implementa una devolución de llamada, a la que llama la API de animación cuando cambia el valor de una animación.  
  
 [CAnimationVariableIntegerChangeHandler (clase)](../../mfc/reference/canimationvariableintegerchangehandler-class.md)  
 Implementa una devolución de llamada, a la que llama la API de animación cuando cambia el valor de una animación.  
 ...
 [CArchiveException (clase)](../../mfc/reference/carchiveexception-class.md)  
 ...
 [CBaseKeyFrame (clase)](../../mfc/reference/cbasekeyframe-class.md)  
 ...
 [CBaseTransition (clase)](../../mfc/reference/cbasetransition-class.md)  
 ...
 [CBitmapButton (clase)](../../mfc/reference/cbitmapbutton-class.md)  
 Crea controles de botón de comando etiquetados con imágenes de mapa de bits en lugar de texto.  
  
 [CBitmapRenderTarget (clase)](../../mfc/reference/cbitmaprendertarget-class.md)  
 ...
 [CCachedDataPathProperty (clase)](../../mfc/reference/ccacheddatapathproperty-class.md)  
 ...
 [CCheckListBox (clase)](../../mfc/reference/cchecklistbox-class.md)  
 ...
 Administra la llamada de funciones de Windows [GetDC](http://msdn.microsoft.com/library/windows/desktop/dd144871) en tiempo de construcción y [ReleaseDC](http://msdn.microsoft.com/library/windows/desktop/dd162920) en tiempo de destrucción.  
 ...
 [CColorDialog (clase)](../../mfc/reference/ccolordialog-class.md)  
 ...
 [CCommandLineInfo (clase)](../../mfc/reference/ccommandlineinfo-class.md)  
 ...
 [CConnectionPoint (clase)](../../mfc/reference/cconnectionpoint-class.md)  
 Define un tipo especial de interfaz que se utiliza para comunicarse con otros objetos OLE, denominado "punto de conexión".  
  
 [CConstantTransition (clase)](../../mfc/reference/cconstanttransition-class.md)  
 ...
 [CCubicTransition (clase)](../../mfc/reference/ccubictransition-class.md)  
 Encapsula una transición cúbica.  
  
 [CCustomInterpolator (clase)](../../mfc/reference/ccustominterpolator-class.md)  
 Implementa un interpolador básico.  
  
 [CCustomTransition (clase)](../../mfc/reference/ccustomtransition-class.md)  
 Implementa una transición personalizada.  
  
 [CD2DBitmap (clase)](../../mfc/reference/cd2dbitmap-class.md)  
 Contenedor para `ID2D1Bitmap`.  
  
 [CD2DBitmapBrush (clase)](../../mfc/reference/cd2dbitmapbrush-class.md)  
 Contenedor para `ID2D1BitmapBrush`.  
  
 [CD2DBrush (clase)](../../mfc/reference/cd2dbrush-class.md)  
 Contenedor para `ID2D1Brush`.  
  
 [CD2DBrushProperties (clase)](../../mfc/reference/cd2dbrushproperties-class.md)  
 Contenedor para `D2D1_BRUSH_PROPERTIES`.  
  
 [CD2DEllipse (clase)](../../mfc/reference/cd2dellipse-class.md)  
 Contenedor para `D2D1_BRUSH_PROPERTIES`.  
  
 [CD2DGeometry (clase)](../../mfc/reference/cd2dgeometry-class.md)  
 Contenedor para `ID2D1Geometry`.  
  
 [CD2DGeometrySink (clase)](../../mfc/reference/cd2dgeometrysink-class.md)  
 Contenedor para `ID2D1GeometrySink`.  
  
 [CD2DGradientBrush (clase)](../../mfc/reference/cd2dgradientbrush-class.md)  
 La clase base de las clases `CD2DLinearGradientBrush` y `CD2DRadialGradientBrush` .  
  
 [CD2DLayer (clase)](../../mfc/reference/cd2dlayer-class.md)  
 Contenedor para `ID2D1Layer`.  
  
 [CD2DLinearGradientBrush (clase)](../../mfc/reference/cd2dlineargradientbrush-class.md)  
 Contenedor para `ID2D1LinearGradientBrush`.  
  
 [CD2DMesh (clase)](../../mfc/reference/cd2dmesh-class.md)  
 Contenedor para `ID2D1Mesh`.  
  
 [CD2DPathGeometry (clase)](../../mfc/reference/cd2dpathgeometry-class.md)  
 Contenedor para `ID2D1PathGeometry`.  
  
 [CD2DPointF (clase)](../../mfc/reference/cd2dpointf-class.md)  
 Contenedor para `D2D1_POINT_2F`.  
  
 [CD2DPointU (clase)](../../mfc/reference/cd2dpointu-class.md)  
 Contenedor para `D2D1_POINT_2U`.  
  
 [CD2DRadialGradientBrush (clase)](../../mfc/reference/cd2dradialgradientbrush-class.md)  
 Contenedor para `ID2D1RadialGradientBrush`.  
  
 [CD2DRectF (clase)](../../mfc/reference/cd2drectf-class.md)  
 Contenedor para `D2D1_RECT_F`.  
  
 [CD2DRectU (clase)](../../mfc/reference/cd2drectu-class.md)  
 Contenedor para `D2D1_RECT_U`.  
  
 [CD2DResource (clase)](../../mfc/reference/cd2dresource-class.md)  
 Una clase abstracta que proporciona una interfaz para crear y administrar recursos de `D2D` como pinceles, capas y textos.  
  
 [CD2DRoundedRect (clase)](../../mfc/reference/cd2droundedrect-class.md)  
 Contenedor para `D2D1_ROUNDED_RECT`.  
  
 [CD2DSizeF (clase)](../../mfc/reference/cd2dsizef-class.md)  
 Contenedor para `D2D1_SIZE_F`.  
  
 [CD2DSizeU (clase)](../../mfc/reference/cd2dsizeu-class.md)  
 Contenedor para `D2D1_SIZE_U`.  
  
 [CD2DSolidColorBrush (clase)](../../mfc/reference/cd2dsolidcolorbrush-class.md)  
 Contenedor para `ID2D1SolidColorBrush`.  
  
 [CD2DTextFormat (clase)](../../mfc/reference/cd2dtextformat-class.md)  
 Contenedor para `IDWriteTextFormat`.  
  
 [CD2DTextLayout (clase)](../../mfc/reference/cd2dtextlayout-class.md)  
 ...
 [CDaoFieldExchange (clase)](../../mfc/reference/cdaofieldexchange-class.md)  
 ...
 [CDBException (clase)](../../mfc/reference/cdbexception-class.md)  
 ...
 [CDCRenderTarget (clase)](../../mfc/reference/cdcrendertarget-class.md)  
 ...
 [CDiscreteTransition (clase)](../../mfc/reference/cdiscretetransition-class.md)  
 ...
 [CDockablePaneAdapter (clase)](../../mfc/reference/cdockablepaneadapter-class.md)  
 ...
 [CDockingPanesRow (clase)](../../mfc/reference/cdockingpanesrow-class.md)  
 ...
 [CDockState (clase)](../../mfc/reference/cdockstate-class.md)  
 ...
 [CDragListBox (clase)](../../mfc/reference/cdraglistbox-class.md)  
 ...
 [CDrawingManager (clase)](../../mfc/reference/cdrawingmanager-class.md)  
 Implementa algoritmos de dibujo complejos.  
  
 [CDumpContext (clase)](../../mfc/reference/cdumpcontext-class.md)  
 ...
 [CFileException (clase)](../../mfc/reference/cfileexception-class.md)  
 Representa una condición de excepción relacionada con archivo.  
  
 [CFileFind (clase)](../../mfc/reference/cfilefind-class.md)  
 Realiza búsquedas de archivos locales y es la clase base para [CGopherFileFind (clase)](../../mfc/reference/cgopherfilefind-class.md) y [CFtpFileFind (clase)](../../mfc/reference/cftpfilefind-class.md), lo que realizar búsquedas de archivos de Internet.  
  
 [CFindReplaceDialog (clase)](../../mfc/reference/cfindreplacedialog-class.md)  
 Permite implementar los cuadros de diálogo Buscar/Reemplazar de cadena estándar en la aplicación.  
  
 [CFolderPickerDialog (clase)](../../mfc/reference/cfolderpickerdialog-class.md)  
 ...
 [CFontDialog (clase)](../../mfc/reference/cfontdialog-class.md)  
 ...
 Implementa la funcionalidad de una interfaz de un único documento (SDI) de Windows superpuesta o una ventana de marco emergente y proporciona miembros para administrar la ventana. Extiende la [CFrameWnd (clase)](../../mfc/reference/cframewnd-class.md) clase.  
  
 [CFtpConnection (clase)](../../mfc/reference/cftpconnection-class.md)  
 ...
 [CHtmlEditCtrl (clase)](../../mfc/reference/chtmleditctrl-class.md)  
 Proporciona la funcionalidad del control ActiveX de WebBrowser en una ventana de MFC.  
  
 [CHtmlEditCtrlBase (clase)](../../mfc/reference/chtmleditctrlbase-class.md)  
 Representa un componente de edición HTML.  
  
 [CHtmlEditDoc (clase)](../../mfc/reference/chtmleditdoc-class.md)  
 Con [CHtmlEditView (clase)](../../mfc/reference/chtmleditview-class.md), proporciona la funcionalidad de la plataforma de edición WebBrowser en el contexto de la arquitectura de vista-documento MFC.  
  
 [CHtmlEditView (clase)](../../mfc/reference/chtmleditview-class.md)  
 ...
 [CHtmlView (clase)](../../mfc/reference/chtmlview-class.md)  
 ...
 [CHwndRenderTarget (clase)](../../mfc/reference/chwndrendertarget-class.md)  
 ...
 [CInstantaneousTransition (clase)](../../mfc/reference/cinstantaneoustransition-class.md)  
 ...
 [CInternetException (clase)](../../mfc/reference/cinternetexception-class.md)  
 ...
 [CInterpolatorBase (clase)](../../mfc/reference/cinterpolatorbase-class.md)  
 ...
 [CInvalidArgException (clase)](../../mfc/reference/cinvalidargexception-class.md)  
 Esta clase representa una condición de excepción de argumento no válido.  
  
 [CIPAddressCtrl (clase)](../../mfc/reference/cipaddressctrl-class.md)  
 Proporciona la funcionalidad del control de dirección IP común de Windows.  
  
 [CJumpList (clase)](../../mfc/reference/cjumplist-class.md)  
 ...
 [CKeyFrame (clase)](../../mfc/reference/ckeyframe-class.md)  
 Representa un fotograma clave de la animación.  
  
 [CLinearTransition (clase)](../../mfc/reference/clineartransition-class.md)  
 Encapsula una transición lineal.  
  
 [CLinearTransitionFromSpeed (clase)](../../mfc/reference/clineartransitionfromspeed-class.md)  
 Encapsula una transición de velocidad lineal.  
  
 [CLinkCtrl (clase)](../../mfc/reference/clinkctrl-class.md)  
 ...
 [CMap (clase)](../../mfc/reference/cmap-class.md)  
 Una clase de colección de diccionarios que asigna claves únicas a valores.  
  
 [CMapPtrToPtr (clase)](../../mfc/reference/cmapptrtoptr-class.md)  
 Admite mapas de punteros void con clave de punteros void.  
  
 [CMapPtrToWord (clase)](../../mfc/reference/cmapptrtoword-class.md)  
 Admite mapas de palabras de 16 bits con clave de punteros void.  
  
 [CMapStringToOb (clase)](../../mfc/reference/cmapstringtoob-class.md)  
 ...
 [CMapStringToString (clase)](../../mfc/reference/cmapstringtostring-class.md)  
 Admite mapas de objetos `CString` con clave de objetos `CString` .  
  
 [CMapWordToOb (clase)](../../mfc/reference/cmapwordtoob-class.md)  
 ...
 [CMemoryException (clase)](../../mfc/reference/cmemoryexception-class.md)  
 ...
 [CMenuTearOffManager (clase)](../../mfc/reference/cmenutearoffmanager-class.md)  
 ...
 [CMFCAcceleratorKeyAssignCtrl (clase)](../../mfc/reference/cmfcacceleratorkeyassignctrl-class.md)  
 ...
 [CMFCCaptionButton (clase)](../../mfc/reference/cmfccaptionbutton-class.md)  
 ...
 [CMFCColorBar (clase)](../../mfc/reference/cmfccolorbar-class.md)  
 ...
 [CMFCColorMenuButton (clase)](../../mfc/reference/cmfccolormenubutton-class.md)  
 ...
 [CMFCDragFrameImpl (clase)](../../mfc/reference/cmfcdragframeimpl-class.md)  
 ...
 [CMFCEditBrowseCtrl (clase)](../../mfc/reference/cmfceditbrowsectrl-class.md)  
 ...
 [CMFCFilterChunkValueImpl (clase)](../../mfc/reference/cmfcfilterchunkvalueimpl-class.md)  
 Simplifica el fragmento y la lógica de los pares de valores de propiedad.  
  
 [CMFCFontComboBox (clase)](../../mfc/reference/cmfcfontcombobox-class.md)  
 ...
 [CMFCKeyMapDialog (clase)](../../mfc/reference/cmfckeymapdialog-class.md)  
 Admite un control que asigna comandos a teclas del teclado.  
  
 [CMFCLinkCtrl (clase)](../../mfc/reference/cmfclinkctrl-class.md)  
 ...
 Extiende la funcionalidad de [CListCtrl (clase)](../../mfc/reference/clistctrl-class.md) clase proporcionando la funcionalidad de control avanzado de encabezado de la [clase CMFCHeaderCtrl](../../mfc/reference/cmfcheaderctrl-class.md).  
  
 [CMFCMaskedEdit (clase)](../../mfc/reference/cmfcmaskededit-class.md)  
 ...
 [CMFCPreviewCtrlImpl (clase)](../../mfc/reference/cmfcpreviewctrlimpl-class.md)  
 ...
 [CMFCPropertyGridFileProperty (clase)](../../mfc/reference/cmfcpropertygridfileproperty-class.md)  
 Admite un elemento de control de la lista de propiedades que abre un cuadro de diálogo de selección de archivos.  
  
 [CMFCPropertyGridFontProperty (clase)](../../mfc/reference/cmfcpropertygridfontproperty-class.md)  
 ...
 [CMFCReBar (clase)](../../mfc/reference/cmfcrebar-class.md)  
 Barra de control que proporciona información de diseño, persistencia y estado para controles rebar.  
  
 [CMFCRibbonApplicationButton (clase)](../../mfc/reference/cmfcribbonapplicationbutton-class.md)  
 ...
 [CMFCRibbonCheckBox (clase)](../../mfc/reference/cmfcribboncheckbox-class.md)  
 ...
 [CMFCRibbonContextCaption (clase)](../../mfc/reference/cmfcribboncontextcaption-class.md)  
 ...
 [CMFCRibbonFontComboBox (clase)](../../mfc/reference/cmfcribbonfontcombobox-class.md)  
 ...
 [CMFCRibbonLabel (clase)](../../mfc/reference/cmfcribbonlabel-class.md)  
 Implementa una etiqueta de texto no seleccionable en una cinta.  
  
 [CMFCRibbonLinkCtrl (clase)](../../mfc/reference/cmfcribbonlinkctrl-class.md)  
 Implementa un hipervínculo que se coloca en una cinta. El hipervínculo abre una página web cuando se hace clic en él.  
  
 [CMFCRibbonMainPanel (clase)](../../mfc/reference/cmfcribbonmainpanel-class.md)  
 ...
 [CMFCRibbonMiniToolBar (clase)](../../mfc/reference/cmfcribbonminitoolbar-class.md)  
 ...
 [CMFCRibbonProgressBar (clase)](../../mfc/reference/cmfcribbonprogressbar-class.md)  
 Implementa un control que indica visualmente el progreso de una operación larga.  
  
 [CMFCRibbonSlider (clase)](../../mfc/reference/cmfcribbonslider-class.md)  
 ...
 [CMFCRibbonStatusBarPane (clase)](../../mfc/reference/cmfcribbonstatusbarpane-class.md)  
 Implementa un elemento de cinta que puede agregar a una barra de estado de la cinta.  
  
 [CMFCRibbonUndoButton (clase)](../../mfc/reference/cmfcribbonundobutton-class.md)  
 ...
 [CMFCSpinButtonCtrl (clase)](../../mfc/reference/cmfcspinbuttonctrl-class.md)  
 Admite un administrador visual que dibuja un control de botón de número.  
  
 [CMFCStatusBar (clase)](../../mfc/reference/cmfcstatusbar-class.md)  
 ...
 [CMFCTabCtrl (clase)](../../mfc/reference/cmfctabctrl-class.md)  
 ...
 [CMFCTabToolTipInfo (estructura)](../../mfc/reference/cmfctabtooltipinfo-structure.md)  
 ...
 [CMFCToolBarInfo (clase)](../../mfc/reference/cmfctoolbarinfo-class.md)  
 ...
 [CMFCVisualManagerOffice2007 (clase)](../../mfc/reference/cmfcvisualmanageroffice2007-class.md)  
 Proporciona a una aplicación un aspecto de Microsoft Office 2007.  
  
 [CMFCVisualManagerVS2005 (clase)](../../mfc/reference/cmfcvisualmanagervs2005-class.md)  
 ...
 [CMiniFrameWnd (clase)](../../mfc/reference/cminiframewnd-class.md)  
 ...
 [CMonikerFile (clase)](../../mfc/reference/cmonikerfile-class.md)  
 Representa una secuencia de datos ([IStream](http://msdn.microsoft.com/library/windows/desktop/aa380034)) nombrada por un [IMoniker](http://msdn.microsoft.com/library/windows/desktop/ms679705).  
 ...
 Permite a un usuario asociar diferentes comandos a un determinado [clase CView](../../mfc/reference/cview-class.md) objeto cuando el usuario hace doble clic dentro de esa vista.  
 ...
 [CMultiPageDHtmlDialog (clase)](../../mfc/reference/cmultipagedhtmldialog-class.md)  
 ...
 [CMultiPaneFrameWnd (clase)](../../mfc/reference/cmultipaneframewnd-class.md)  
 Extiende [CPaneFrameWnd (clase)](../../mfc/reference/cpaneframewnd-class.md). Puede admitir varios paneles. En lugar de un único identificador incrustado para una barra de control, `CMultiPaneFrameWnd` contiene un [CPaneContainerManager (clase)](../../mfc/reference/cpanecontainermanager-class.md) objeto que permite al usuario acoplar un `CMultiPaneFrameWnd` a otro y dinámicamente crear varios flotante, con pestañas en Windows.  
 ...
 [CNetAddressCtrl (clase)](../../mfc/reference/cnetaddressctrl-class.md)  
 ...
 [COleBusyDialog (clase)](../../mfc/reference/colebusydialog-class.md)  
 Se utiliza en los cuadros de diálogo que indican que el servidor OLE no responde o el servidor está ocupado.  
  
 [COleChangeIconDialog (clase)](../../mfc/reference/colechangeicondialog-class.md)  
 Se utiliza en el cuadro de diálogo Cambiar icono de OLE.  
  
 [COleChangeSourceDialog (clase)](../../mfc/reference/colechangesourcedialog-class.md)  
 ...
 [COleCmdUI (clase)](../../mfc/reference/colecmdui-class.md)  
 ...
 [COleControlModule (clase)](../../mfc/reference/colecontrolmodule-class.md)  
 ...
 [COleConvertDialog (clase)](../../mfc/reference/coleconvertdialog-class.md)  
 ...
 [COleDispatchException (clase)](../../mfc/reference/coledispatchexception-class.md)  
 ...
 [COleInsertDialog (clase)](../../mfc/reference/coleinsertdialog-class.md)  
 Se utiliza para el cuadro de diálogo Insertar objeto OLE.  
  
 [COleIPFrameWnd (clase)](../../mfc/reference/coleipframewnd-class.md)  
 Base para la ventana de la edición en contexto de la aplicación.  
  
 [COleIPFrameWndEx (clase)](../../mfc/reference/coleipframewndex-class.md)  
 ...
 [COleLinkingDoc (clase)](../../mfc/reference/colelinkingdoc-class.md)  
 ...
 [COleMessageFilter (clase)](../../mfc/reference/colemessagefilter-class.md)  
 ...
 [COlePasteSpecialDialog (clase)](../../mfc/reference/colepastespecialdialog-class.md)  
 Se utiliza en el cuadro de diálogo Pegado especial de OLE.  
  
 [COlePropertiesDialog (clase)](../../mfc/reference/colepropertiesdialog-class.md)  
 ...
 [COleResizeBar (clase)](../../mfc/reference/coleresizebar-class.md)  
 Un tipo de barra de control que admite el cambio de tamaño de elementos de OLE en contexto.  
  
 [COleSafeArray (clase)](../../mfc/reference/colesafearray-class.md)  
 ...
 [COleUpdateDialog (clase)](../../mfc/reference/coleupdatedialog-class.md)  
 ...
 [CPageSetupDialog (clase)](../../mfc/reference/cpagesetupdialog-class.md)  
 ...
 [CPaneDialog (clase)](../../mfc/reference/cpanedialog-class.md)  
 ...
 [CParabolicTransitionFromAcceleration (clase)](../../mfc/reference/cparabolictransitionfromacceleration-class.md)  
 ...
 [CPrintDialog (clase)](../../mfc/reference/cprintdialog-class.md)  
 Encapsula los servicios proporcionados por el cuadro de diálogo común de Windows para imprimir.  
  
 [CPrintDialogEx (clase)](../../mfc/reference/cprintdialogex-class.md)  
 ...
 [CPtrArray (clase)](../../mfc/reference/cptrarray-class.md)  
 ...
 [CRecentDockSiteInfo (clase)](../../mfc/reference/crecentdocksiteinfo-class.md)  
 Clase auxiliar que almacena la información de estado reciente para [CPane Class](../../mfc/reference/cpane-class.md).  
  
 [CRecentFileList (clase)](../../mfc/reference/crecentfilelist-class.md)  
 ...
 [CRenderTarget (clase)](../../mfc/reference/crendertarget-class.md)  
 Contenedor para `ID2D1RenderTarget`.  
  
 [CResourceException (clase)](../../mfc/reference/cresourceexception-class.md)  
 Se genera cuando Windows no puede encontrar o asignar un recurso solicitado.  
  
 [CReversalTransition (clase)](../../mfc/reference/creversaltransition-class.md)  
 ...
 Con [CRichEditView (clase)](../../mfc/reference/cricheditview-class.md) y [CRichEditCntrItem (clase)](../../mfc/reference/cricheditcntritem-class.md), proporciona la funcionalidad del control rich edit en el contexto de la arquitectura de vista de documento de MFC.  
  
 [CRichEditView (clase)](../../mfc/reference/cricheditview-class.md)  
 Con [CRichEditDoc (clase)](../../mfc/reference/cricheditdoc-class.md) y [CRichEditCntrItem (clase)](../../mfc/reference/cricheditcntritem-class.md), proporciona la funcionalidad del control rich edit en el contexto de la arquitectura de vista de documento de MFC.  
 ...
 Un [clase CView](../../mfc/reference/cview-class.md) con capacidades de desplazamiento.  
 ...
 [CSettingsStoreSP (clase)](../../mfc/reference/csettingsstoresp-class.md)  
 Clase auxiliar que se puede usar para crear instancias de [CSettingsStore Class](../../mfc/reference/csettingsstore-class.md).  
  
 [CSharedFile (clase)](../../mfc/reference/csharedfile-class.md)  
 El [CMemFile (clase)](../../mfc/reference/cmemfile-class.md)-clase derivada que es compatible con archivos de memoria compartida.  
  
 [CShellManager (clase)](../../mfc/reference/cshellmanager-class.md)  
 ...
 [CSinusoidalTransitionFromRange (clase)](../../mfc/reference/csinusoidaltransitionfromrange-class.md)  
 Encapsula una transición de intervalo sinusoidal que tiene un intervalo determinado de oscilación.  
  
 [CSinusoidalTransitionFromVelocity (clase)](../../mfc/reference/csinusoidaltransitionfromvelocity-class.md)  
 ...
 [CSmartDockingInfo (clase)](../../mfc/reference/csmartdockinginfo-class.md)  
 Define el aspecto de los marcadores de acoplamiento inteligente.  
  
 [CSmoothStopTransition (clase)](../../mfc/reference/csmoothstoptransition-class.md)  
 ...
 Representa un archivo de secuencia de tiempo de ejecución de C tal como lo abre la función de tiempo de ejecución [fopen, _wfopen](../../c-runtime-library/reference/fopen-wfopen.md).  
  
 [CStringArray (clase)](../../mfc/reference/cstringarray-class.md)  
 ...
 [CTabView (clase)](../../mfc/reference/ctabview-class.md)  
 ...
 [CTooltipManager (clase)](../../mfc/reference/ctooltipmanager-class.md)  
 ...
 [CTreeView (clase)](../../mfc/reference/ctreeview-class.md)  
 ...
 [CUIntArray (clase)](../../mfc/reference/cuintarray-class.md)  
 Admite matrices de enteros sin signo.  
  
 [CUserException (clase)](../../mfc/reference/cuserexception-class.md)  
 ...
 [CVSListBox (clase)](../../mfc/reference/cvslistbox-class.md)  
 Admite un control de lista modificable.  
  
 [CWaitCursor (clase)](../../mfc/reference/cwaitcursor-class.md)  
 ...
 [CWordArray (clase)](../../mfc/reference/cwordarray-class.md)  
