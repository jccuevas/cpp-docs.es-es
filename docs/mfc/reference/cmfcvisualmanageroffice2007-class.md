---
title: CMFCVisualManagerOffice2007 (clase)
ms.date: 11/04/2016
f1_keywords:
...
ms.locfileid: "81319923"
---
# <a name="cmfcvisualmanageroffice2007-class"></a>CMFCVisualManagerOffice2007 (clase)

`CMFCVisualManagerOffice2007`da a una aplicación una apariencia de Microsoft Office 2007.
...
|`CMFCVisualManagerOffice2007::GetStyle`|Devuelve el esquema de `CMFCVisualManagerOffice2007` color actual de la GUI que, a su vez, imita la GUI de Microsoft Office 2007.|
...
|`CMFCVisualManagerOffice2007::SetStyle`|Establece el esquema `CMFCVisualManagerOffice2007` de color de la GUI.|

## <a name="remarks"></a>Observaciones

Se `CMFCVisualManagerOffice2007` usa para cambiar el aspecto visual de la aplicación para que se asemeje a la de Microsoft Office 2007. Este administrador visual requiere que establezca el estilo antes de usarlo. Antes de pasar este `CMFCVisualManager::SetDefaultManager`administrador visual a `CMFCVisualManagerOffice2007::SetStyle`, debe llamar a la función estática .

## <a name="example"></a>Ejemplo

En el ejemplo siguiente se muestra cómo usar el administrador visual de Office 2007. Este fragmento de código forma parte del [ejemplo Demostración de alertas](../../overview/visual-cpp-samples.md)de escritorio.
...
[en] *rect*<br/>
[en] *bIsHighlighted*<br/>
[en] *bIsPaneHighlighted*<br/>
[en] *bIsDisabled*<br/>
[en] *clrText*<br/>
[en] *clrSelBackground*<br/>
[en] *clrSelText*<br/>
