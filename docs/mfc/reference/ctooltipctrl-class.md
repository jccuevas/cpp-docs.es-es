---
title: CToolTipCtrl (clase) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|---------------|-----------------|  
|[out] *lpToolInfo*|Puntero a un [TOOLINFO](/windows/desktop/api/commctrl/ns-commctrl-tagtoolinfoa) estructura que recibe información acerca de la ventana de información sobre herramientas actual.|  
...
|Parámetro|Descripción|  
|---------------|-----------------|  
|[out] *pttgt*|Puntero a un [TTGETTITLE](/windows/desktop/api/commctrl/ns-commctrl-_ttgettitle) estructura que contiene información sobre el control ToolTip. Cuando este método finaliza, el *pszTitle* miembro de la [TTGETTITLE](/windows/desktop/api/commctrl/ns-commctrl-_ttgettitle) estructura señala el texto del título.|  
