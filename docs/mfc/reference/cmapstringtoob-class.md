---
title: CMapStringToOb (clase) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|[CMapPtrToWord](../../mfc/reference/cmapptrtoword-class.md)|**Búsqueda de BOOL (void\***  `key` **, palabra &** `rValue` **) const;**|  
...
|[CMapPtrToWord](../../mfc/reference/cmapptrtoword-class.md)|**PALABRA & (operador) [] (void\***  `key`  **\);**|  
