---
title: CMFCDropDownToolbarButton (clase) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|`CMFCDropDownToolbarButton::OnCancelMode`|Lo llama el marco de trabajo para controlar la [WM_CANCELMODE](http://msdn.microsoft.com/library/windows/desktop/ms632615) mensaje. (Invalida `CMCToolBarButton::OnCancelMode`).|  
...
### <a name="parameters"></a>Parámetros  
 [in] *conquistado*  
 La ventana primaria del marco de la lista desplegable, o NULL para usar la ventana primaria del botón de barra de herramientas desplegable.  
...
### <a name="parameters"></a>Parámetros  
 ...
 [in] *bSelected*  
 Si se selecciona el botón. Si este parámetro es TRUE, se selecciona el botón. Si este parámetro es FALSE, no se selecciona el botón.  
