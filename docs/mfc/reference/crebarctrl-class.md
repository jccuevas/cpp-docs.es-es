...
Implementa el comportamiento del mensaje de Win32 [RB_IDTOINDEX](/windows/desktop/controls/rb-idtoindex), tal y como se describe en el SDK de Windows.
