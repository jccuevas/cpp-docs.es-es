---
title: CRichEditCtrl (clase) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
- Artículo de Knowledge Base Q259949: INFO: SetCaretPos() es no es adecuado con CEdit o controles de CRichEditCtrl
