...
`CPaneContainer` los objetos se crean automáticamente el marco de trabajo.

## <a name="example"></a>Ejemplo

En el ejemplo siguiente se muestra cómo construir una instancia de la `CPaneContainer` clase. Este fragmento de código forma parte de la [ejemplo establece el tamaño del panel](../../overview/visual-cpp-samples.md).
