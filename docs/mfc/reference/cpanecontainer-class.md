...
### <a name="remarks"></a>Comentarios  
 `CPaneContainer`el marco de trabajo crea automáticamente los objetos.  
...
[!code-cpp[1 NVC_MFC_SetPaneSize](../../mfc/reference/codesnippet/cpp/cpanecontainer-class_2.cpp)]  
