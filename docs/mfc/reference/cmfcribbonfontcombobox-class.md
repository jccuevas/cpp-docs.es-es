...
Para obtener más información sobre las posibles *nFontType* valores de parámetros, vea [EnumFontFamProc](/previous-versions/dd162621\(v=vs.85\)) en la documentación del SDK de Windows.
