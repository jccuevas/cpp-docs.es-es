...
[in] [out] *pBarToDock* un puntero al panel para acoplar a la izquierda del *pTargetBar*.

[in] [out] *pTargetBar* un puntero en el panel de destino.
...
[in] [out] *pBar* un puntero al panel para mostrar u ocultar.
