...
```  
 ...
 De nuevo, hay macros similar para hacer TEXTMETRIC, DEVMODE, BSTR y asignada cadenas OLE. Consulte AFXPRIV. H para obtener más información.  
