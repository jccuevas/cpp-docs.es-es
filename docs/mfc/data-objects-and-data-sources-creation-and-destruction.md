...
1. Si se trata de una operación de **cortar** o `DoDragDrop` devuelve **DROPEFFECT_MOVE**, los datos seleccionados en el paso 1 se eliminan del documento.
