---
title: 'Controles ActiveX MFC: Creación de un servidor de automatización | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
1. Invalidar [IsInvokeAllowed](../mfc/reference/colecontrol-class.md#isinvokeallowed). Para obtener más información, consulte el artículo de Knowledge Base Q146120.
