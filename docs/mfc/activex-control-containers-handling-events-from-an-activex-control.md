...
3.  En la ventana Propiedades, seleccione el identificador de control del control ActiveX incrustado. En este ejemplo, utilice `IDC_CIRCCTRL1`.  
...
4.  Seleccione el evento que desee de la clase de cuadro de diálogo para administrar. En este ejemplo, seleccione **haga clic en**.  
