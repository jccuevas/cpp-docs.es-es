...
Al crear sus propios menús en el objeto Visual C++ editor de menús, es una buena idea a la biblioteca de clases de seguir la convención de nomenclatura como se muestra en **ID_FILE_OPEN**. [Comandos estándar](../mfc/standard-commands.md) explica los comandos estándares definidos por la biblioteca de clases.
