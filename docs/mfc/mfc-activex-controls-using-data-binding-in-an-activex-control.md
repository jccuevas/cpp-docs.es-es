---
title: 'Controles ActiveX MFC: Utilizar enlace de datos en un Control ActiveX | Microsoft Docs'
ms.custom: ''
ms.date: 12/09/2018
ms.technology:
- cpp-mfc
...
5.  Active las casillas siguientes desde el **atributos IDL** ficha: **displaybind** y **defaultbind** para agregar los atributos a la definición de propiedad del proyecto. Archivo IDL. Estos atributos que el control sea visible para el usuario y que la propiedad enlazable predeterminada de la propiedad estándar.  
...
2.  En el **configuración del Control** , seleccione una clase de ventana para el control para crear una subclase. Por ejemplo, es posible que desee para crear una subclase un control de edición.  
