---
title: Crear y utilizar controles | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Realizar la mayoría de los controles de cuadros de diálogo en Visual C++ [editor de cuadro de diálogo](../windows/dialog-editor.md). Pero también puede crear controles en cualquier cuadro de diálogo o ventana.  
...
-   [Recibir notificaciones de controles comunes](../mfc/receiving-notification-from-common-controls.md)  
...
-   Controles individuales: vea [controles](../mfc/controls-mfc.md) para obtener vínculos a todos los controles comunes  
