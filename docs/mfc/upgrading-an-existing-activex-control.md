...
1. En el **License Package Authoring Tool** cuadro de diálogo el **controles disponibles** cuadro de lista, seleccione cada control ActiveX que se usará en la página HTML y haga clic en la licencia **agregar**.

1. Haga clic en **guardar y salir** y escriba un nombre para el archivo LPK. Esto creará el archivo LPK y cierre la aplicación.
...
Para obtener más información acerca de las licencias de control, vea [controles ActiveX: Licencias de un Control ActiveX](../mfc/mfc-activex-controls-licensing-an-activex-control.md).
