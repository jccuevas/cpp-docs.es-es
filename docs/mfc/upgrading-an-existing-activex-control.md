...
### <a name="creating-cab-files"></a>Creación de archivos CAB  
 ...
 Para obtener más información sobre cómo crear un archivo .cab, consulte [crear un archivo CAB](http://msdn.microsoft.com/cc52fd09-bdf6-4410-a693-149a308f36a3).  
...
##  <a name="_core_signing_code"></a> Firma de código  
 ...
 Asegúrese de que se firma el código final para que el control puede descargarse automáticamente sin mostrar mensajes de advertencia de confianza. Para obtener más información sobre cómo firmar el código, consulte la documentación de Authenticode en ActiveX SDK y consulte [firmar un archivo CAB](http://msdn.microsoft.com/04d8b47a-8f1c-4b54-ab90-730fcdc03747).  
