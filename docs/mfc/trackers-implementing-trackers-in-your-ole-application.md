...
-   [Efecto de banda elástica y seguimiento](../mfc/rubber-banding-and-trackers.md).  
 ...
 El artículo también explica el uso de estilos con los objetos de seguimiento. Además, se incluyen varias referencias en el ejemplo de MFC OLE [OCLIENT](../visual-cpp-samples.md).  
