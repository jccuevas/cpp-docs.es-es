...
7.  En el **tipo de propiedad** cuadro, seleccione **IDispatch** <strong>\*</strong> para el tipo de propiedad.  
...
###  <a name="_core_processing_font_notifications"></a> Procesar notificaciones de fuente  
 ...
 ![Implementar varias interfaces de objeto de fuente](../mfc/media/vc373q1.gif "vc373q1")  
