...
2.  Agregue una variable miembro (de tipo `CCirc`) a la sección protegida de la `CMyView` ubicado en CMYVIEW de definición de clase. H:  
...
4.  En la función de controlador, `CMyView::OnCreate`, realizar una llamada para el control `Create` funcionan según el **esto** puntero como la ventana primaria:  
  
     [!code-cpp[NVC_MFC_AxCont#15](../mfc/codesnippet/cpp/activex-control-containers-using-controls-in-a-non-dialog-container_4.cpp)]  
  
5.  Recompile el proyecto. Un control Circ creará dinámicamente cada vez que se crea la vista de la aplicación.  
