...
1. En la primera página de la **MFC Application Wizard**, haga clic en **siguiente**.

1. En el **tipo de aplicación** página, en **estilo Visual y colores**, seleccione **Office 2007 (tema azul)**. Deje los otros valores tal como están. Haga clic en **Siguiente**.

1. En el **compatibilidad con documentos compuestos** página, asegúrese de que **ninguno** está seleccionada y, a continuación, haga clic en **siguiente**.

1. En el **propiedades de la plantilla de documento** página, en el **la extensión de archivo** , escriba una extensión de nombre de archivo para los documentos que crea esta aplicación, por ejemplo, *mfcrbnapp*. Haga clic en **Siguiente**.

1. En el **soporte técnico de la base de datos** página, asegúrese de que **ninguno** está seleccionada y, a continuación, haga clic en **siguiente**.

1. En el **características de la interfaz de usuario** página, asegúrese de que **usar una cinta de opciones** está seleccionada. Haga clic en **Siguiente**.
