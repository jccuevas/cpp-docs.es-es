---
title: Clases MFC relacionadas con Internet | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Para obtener información acerca de las clases relacionadas con Internet y funciones, vea:  
...
## <a name="asynchronous-moniker-classes"></a>Clases de moniker asincrónico  
