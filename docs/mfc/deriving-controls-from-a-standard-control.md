...
1.  Derive la clase de una clase de control existente y, opcionalmente, invalide el **crear** función miembro para que proporcione los argumentos necesarios para la clase base **crear** función.  
