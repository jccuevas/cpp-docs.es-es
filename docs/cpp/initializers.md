...
![Gráfico de decisión de inicialización de tipos de referencia](../cpp/media/vc38s71.gif "gráfico de decisión de inicialización de tipos de referencia") <br/>
