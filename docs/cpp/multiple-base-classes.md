...
1. Si el acceso al nombre infringe el permiso de acceso a miembros, se genera un mensaje de error. (Para obtener más información, consulte [Control de acceso a miembros](../cpp/member-access-control-cpp.md).)
