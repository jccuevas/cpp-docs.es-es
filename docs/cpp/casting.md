...
![Jerarquía de clases](../cpp/media/vc38zz1.gif "vc38ZZ1") jerarquía de clases

Un objeto de tipo `C` se podría visualizar tal y como se muestra en la ilustración siguiente.

![Clase C con sub&#45;objetos B y A](../cpp/media/vc38zz2.gif "vc38ZZ2") clase C con subobjeto B y subobjeto A
