...
The exception is thrown because the object being cast (a Shape) isn't derived from the specified cast type (Circle). Para evitar la excepción, agregue estas declaraciones a `main`:
