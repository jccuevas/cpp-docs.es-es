...
|**UINT_MAX**|Valor máximo de una variable de tipo **int sin signo**.|4294967295 (0xffffffff)|
...
|**ULONG_MAX**|Valor máximo de una variable de tipo **largo sin signo**.|4294967295 (0xffffffff)|
