...
-   Un **comenzar** método que devuelve un iterador al principio de la estructura y un **final** método que devuelve un iterador al final de la estructura.  
