...
## [Control de excepciones en C++](exception-handling-in-visual-cpp.md)
...
#### [Ejemplo de llamada: llamada y prototipo de función](calling-example-function-prototype-and-call.md)
