...
## Comentarios  
 ...
 Vea [static\_cast](../cpp/static-cast-operator.md) para obtener una explicación de la diferencia existente entre las conversiones estáticas y dinámicas, y cuándo es adecuado utilizar cada una de ellas.  
...
```  
 ...
 ![Jerarquía de clases que muestra herencia múltiple](../cpp/media/vc39011.png "vc39011")  
...
```  
 ...
 El valor de una conversión con errores al tipo de puntero es el puntero NULL.  Una conversión con errores al tipo de referencia produce una [excepción bad\_cast](../cpp/bad-cast-exception.md). Si `expression` no apunta ni hace referencia a un objeto válido, se produce una excepción `__non_rtti_object`.  
