...
El **typeid** operador no funciona con tipos administrados (instancias o declaradores abstractos), consulte [typeid](../extensions/typeid-cpp-component-extensions.md) para obtener información sobre cómo obtener el <xref:System.Type> de un tipo especificado.
