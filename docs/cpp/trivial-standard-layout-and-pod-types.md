---
title: "Trivial, diseño estándar y los tipos POD | Documentos de Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="trivial-standard-layout-and-pod-types"></a>Trivial, diseño estándar y los tipos POD
