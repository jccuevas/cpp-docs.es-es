---
title: 'Operador lógico OR: || | Microsoft Docs'
ms.custom: ''
ms.date: 06/14/2018
ms.technology:
- cpp-language
...
## <a name="see-also"></a>Vea también
 [Operadores integrados de C++ prioridad y asociatividad](cpp-built-in-operators-precedence-and-associativity.md)  
