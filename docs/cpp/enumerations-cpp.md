...
> [!NOTE]
>  Este artículo trata el tipo `enum` del lenguaje C\+\+ estándar de ISO y el tipo de ámbito \(o fuertemente tipado\) `enum class`, que se introdujo en C\+\+11.  Para obtener información acerca de los tipos `public enum class` o `private enum class` en C\+\+\/CLI y C\+\+\/CX, vea [enum class](../windows/enum-class-cpp-component-extensions.md).  
