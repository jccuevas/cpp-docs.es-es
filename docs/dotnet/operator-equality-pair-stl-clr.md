---
title: "operator== (par) (STL/CLR) | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
manager: "ghogen"
---
# operator== (par) (STL/CLR)
[!INCLUDE[vs2017banner](../assembler/inline/includes/vs2017banner.md)]

Comparación igual de pares.  
...
## Comentarios  
 La función de operador devuelve `left``.first ==` `right``.first &&` `left``.second ==` `right``.second`.  Se utiliza para probar si `left` se le igual que `right` cuando los dos pares son elemento comparado al lado de elemento.  
