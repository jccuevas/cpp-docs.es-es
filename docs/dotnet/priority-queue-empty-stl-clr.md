...
## Comentarios  
 La función miembro devuelve true para una secuencia controlada vacía.  Es equivalente a [priority\_queue::size](../dotnet/priority-queue-size-stl-clr.md)`() == 0`.  Se utiliza para probar si el priority\_queue está vacío.  
