...
ms.locfileid: "50659828"
---
# <a name="autohandle-members"></a>auto_handle (Miembros)

Los miembros de `auto_handle`.
...
[auto_handle (Clase)](../dotnet/auto-handle-class.md)<br/>
