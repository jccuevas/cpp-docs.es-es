...
## Comentarios  
 La función miembro devuelve true para una secuencia controlada vacía.  Es equivalente a [list::size](../dotnet/list-size-stl-clr.md)`() == 0`.  Se utiliza para probar si la lista está vacía.  
