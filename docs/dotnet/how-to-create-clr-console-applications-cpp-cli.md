---
title: Filtrar Crear aplicaciones de consola CLR (C++ / c++ / CLI)
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "57426345"
---
# <a name="how-to-create-clr-console-applications-ccli"></a>Procedimiento Crear aplicaciones de consola CLR (C++ / c++ / CLI)
