---
title: Declaración de una matriz CLR | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
En Visual C++, la declaración es mucho más sencilla. Por ejemplo,
...
se ha simplificado considerablemente en la nueva sintaxis (tenga en cuenta que dado que la conversión boxing es implícita en la nueva sintaxis, la `__box` se ha eliminado el operador, consulte [tipos de valor y sus comportamientos (C++ / c++ / CLI)](../dotnet/value-types-and-their-behaviors-cpp-cli.md) para obtener una explicación):
