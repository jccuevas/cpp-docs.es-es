...
## Comentarios  
 La función miembro devuelve `(float)`[hash\_set::size](../dotnet/hash-set-size-stl-clr.md)`() /` [hash\_set::bucket\_count](../dotnet/hash-set-bucket-count-stl-clr.md)`()`.  Se utiliza para determinar el tamaño medio de depósito.  
