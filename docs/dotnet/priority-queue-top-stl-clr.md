...
## Comentarios  
 La función miembro devuelve una referencia al elemento \(prioridad\) superior de la secuencia controlada, que no puede estar vacía.  Se utiliza para tener acceso al elemento prioridad, cuando lo conoce existe.  
