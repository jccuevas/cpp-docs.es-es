...
|[priority_queue::value_compare (STL/CLR)](#value_compare)|El delegado de ordenación para dos elementos.|  
...
|[priority_queue::get_container (STL/CLR)](#get_container)|Se tiene acceso del contenedor subyacente.|  
|[priority_queue::pop (STL/CLR)](#pop)|Quita el elemento de prioridad de hghest.|  
...
|[priority_queue::top (STL/CLR)](#top)|Accede al elemento de prioridad más alta.|  
...
|--------------|-----------------|  
|[priority_queue::top_item (STL/CLR)](#top_item)|Accede al elemento de prioridad más alta.|  
...
### <a name="remarks"></a>Comentarios  
 La función miembro inserta un elemento con el valor `val` en la la secuencia controlada y vuelve a ordenar la secuencia controlada para mantener la disciplina de montón. Utiliza para agregar otro elemento a la cola.  
