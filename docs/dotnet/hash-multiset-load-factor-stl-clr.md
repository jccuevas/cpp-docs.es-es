...
## Comentarios  
 La función miembro devuelve `(float)`[hash\_multiset::size](../dotnet/hash-multiset-size-stl-clr.md)`() /` [hash\_multiset::bucket\_count](../dotnet/hash-multiset-bucket-count-stl-clr.md)`()`.  Se utiliza para determinar el tamaño medio de depósito.  
