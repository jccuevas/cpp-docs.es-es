...
## [Tutorial: Compilación de un programa de C++/CLI que tiene como destino CLR](walkthrough-compiling-a-cpp-program-that-targets-the-clr-in-visual-studio.md)
## [Tareas de C++/CLI](cpp-cli-tasks.md)
### [Cómo: Crear proyectos vacíos de CLR](how-to-create-clr-empty-projects.md)
### [Cómo: Creación de aplicaciones de consola CLR](how-to-create-clr-console-applications-cpp-cli.md)
...
### [Cómo: Definición y consumo de clases y structs](how-to-define-and-consume-classes-and-structs-cpp-cli.md)
### [Semántica de pila de C++ para los tipos de referencia](cpp-stack-semantics-for-reference-types.md)
### [Operadores definidos por el usuario](user-defined-operators-cpp-cli.md)
### [Conversiones definidas por el usuario](user-defined-conversions-cpp-cli.md)
### [initonly](initonly-cpp-cli.md)
### [Cómo: Definición y uso de delegados](how-to-define-and-use-delegates-cpp-cli.md)
...
### [Cómo: Definición de un constructor estático de interfaz](how-to-define-an-interface-static-constructor-cpp-cli.md)
### [Cómo: Declaración de especificadores de invalidación en compilaciones nativas](how-to-declare-override-specifiers-in-native-compilations-cpp-cli.md)
...
### [Expresiones regulares](regular-expressions-cpp-cli.md)
### [Control y E/S de archivos](file-handling-and-i-o-cpp-cli.md)
### [Operaciones de gráficos](graphics-operations-cpp-cli.md)
### [Operaciones de Windows](windows-operations-cpp-cli.md)
### [Acceso a datos mediante ADO.NET](data-access-using-adonet-cpp-cli.md)
## [Interoperabilidad nativa y de .NET](native-and-dotnet-interoperability.md)
### [Interoperabilidad con otros lenguajes de .NET](interoperability-with-other-dotnet-languages-cpp-cli.md)
...
## [Código puro y comprobable](pure-and-verifiable-code-cpp-cli.md)
### [Cómo: Creación de proyectos de C++ comprobables](how-to-create-verifiable-cpp-projects-cpp-cli.md)
### [Uso de ensamblados comprobables con SQL Server](using-verifiable-assemblies-with-sql-server-cpp-cli.md)
...
## [Serialización](serialization-cpp-cli.md)
## [Ensamblados de confianza (C++)](friend-assemblies-cpp.md)
## [Tipos administrados](managed-types-cpp-cli.md)
## [Reflexión](reflection-cpp-cli.md)
## [Ensamblados de nombre seguro (Firma de ensamblados)](strong-name-assemblies-assembly-signing-cpp-cli.md)
## [Clase Debug](debug-class-cpp-cli.md)
...
## [Conversión boxing](boxing-cpp-cli.md)
