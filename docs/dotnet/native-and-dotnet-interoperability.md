---
title: Nativo y la interoperabilidad de .NET | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
## <a name="in-this-section"></a>En esta sección  
 ...
 Describe los ensamblados generados con el [/clr (compilación de Common Language Runtime)](../build/reference/clr-common-language-runtime-compilation.md) opción del compilador que contienen tanto administrados y funcionalidad.  
