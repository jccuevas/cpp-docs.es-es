...
## Comentarios  
 La función miembro quita un elemento de la secuencia controlada que `((System::Object^)``val``)->Equals((System::Object^)x)` es true \(si existe\).  Se utiliza para borrar un elemento arbitrario con el valor especificado.  
