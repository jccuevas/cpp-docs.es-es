...
## Comentarios  
 Esta función se comporta igual que la función `swap_ranges`STL.  Para obtener más información, vea [swap\_ranges](../Topic/swap_ranges.md).  
