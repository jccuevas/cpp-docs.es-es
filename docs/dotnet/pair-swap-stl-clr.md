...
Cambia el contenido de dos pares.  
...
#### Parámetros  
 right  
 Pares para intercambiar contenido con.  
  
## Comentarios  
 La función miembro intercambia los pares almacenados de valores entre `*this` y `right`.  
