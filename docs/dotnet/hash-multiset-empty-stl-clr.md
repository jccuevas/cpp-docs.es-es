...
## Comentarios  
 La función miembro devuelve true para una secuencia controlada vacía.  Es equivalente a [hash\_multiset::size](../dotnet/hash-multiset-size-stl-clr.md)`() == 0`.  Se utiliza para probar si el hash\_multiset está vacío.  
