...
## Comentarios  
 La función miembro devuelve `(float)`[hash\_map::size](../dotnet/hash-map-size-stl-clr.md)`() /` [hash\_map::bucket\_count](../dotnet/hash-map-bucket-count-stl-clr.md)`()`.  Se utiliza para determinar el tamaño medio de depósito.  
