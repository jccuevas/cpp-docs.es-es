---
title: 'Cómo: iterar por una colección definida por el usuario con for each | Documentos de Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
## <a name="example"></a>Ejemplo  
 Colección de tipos de referencia definido por el usuario simple.  
