---
title: C++ / c++ / CLI tareas | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
ms.locfileid: "46414750"
---
# <a name="ccli-tasks"></a>Tareas de C++/CLI

Los artículos de esta sección de la documentación muestran cómo usar diversas características de C / c++ / CLI.
