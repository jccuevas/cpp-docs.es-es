...
|[hash_multimap::difference_type (STL/CLR)](#difference_type)|El tipo de una distancia (posiblemente con signo) entre dos elementos.|  
|[hash_multimap::generic_container (STL/CLR)](#generic_container)|El tipo de la interfaz genérica para el contenedor.|  
|[hash_multimap::generic_iterator (STL/CLR)](#generic_iterator)|El tipo de un iterador para la interfaz genérica para el contenedor.|  
|[hash_multimap::generic_reverse_iterator (STL/CLR)](#generic_reverse_iterator)|El tipo de un iterador inverso para la interfaz genérica para el contenedor.|  
...
|[hash_multimap::key_compare (STL/CLR)](#key_compare)|El delegado para dos claves de ordenación.|  
...
|[hash_multimap::size_type (STL/CLR)](#size_type)|El tipo de una distancia (positivo) entre dos elementos.|  
|[hash_multimap::value_compare (STL/CLR)](#value_compare)|El delegado de ordenación para los dos valores de elemento.|  
...
|[hash_multimap::key_comp (STL/CLR)](#key_comp)|Copia al delegado para dos claves de ordenación.|  
|[hash_multimap::load_factor (STL/CLR)](#load_factor)|Cuenta los elementos promedio por depósito.|  
|[hash_multimap::lower_bound (STL/CLR)](#lower_bound)|Busca el comienzo del intervalo que coincide con una clave especificada.|  
...
|[hash_multimap::to_array (STL/CLR)](#to_array)|Copia la secuencia controlada en una nueva matriz.|  
|[hash_multimap::upper_bound (STL/CLR)](#upper_bound)|Busca el final del intervalo que coincide con una clave especificada.|  
|[hash_multimap::value_comp (STL/CLR)](#value_comp)|Copia al delegado de ordenación para los dos valores de elemento.|  
...
### <a name="remarks"></a>Comentarios  
 La función miembro devuelve un par de iteradores `cliext::pair<iterator, iterator>(` [hash_multimap:: lower_bound (STL/CLR)](../dotnet/hash-multimap-lower-bound-stl-clr.md) `(key),` [hash_multimap:: upper_bound (STL/CLR)](../dotnet/hash-multimap-upper-bound-stl-clr.md)`(key))`. Usa para determinar el intervalo de elementos actualmente en la secuencia controlada que coinciden con una clave especificada.  
...
### <a name="remarks"></a>Comentarios  
 Si al menos un elemento de la secuencia controlada tiene una ordenación equivalente con `key`, la función miembro devuelve un iterador que designa uno de esos elementos; de lo contrario, devuelve [hash_multimap:: end (STL/CLR)](../dotnet/hash-multimap-end-stl-clr.md) `()`. Usa para buscar un elemento actualmente en la secuencia controlada que coincida con una clave especificada.  
...
### <a name="remarks"></a>Comentarios  
 La función miembro devuelve `(float)` [hash_multimap:: Size (STL/CLR)](../dotnet/hash-multimap-size-stl-clr.md) `() /` [hash_multimap::bucket_count (STL/CLR)](../dotnet/hash-multimap-bucket-count-stl-clr.md)`()`. Usa para determinar el tamaño de depósito promedio.  
...
### <a name="remarks"></a>Comentarios  
 La función miembro se vuelve a generar la tabla hash, lo que asegura que [hash_multimap::load_factor (STL/CLR)](../dotnet/hash-multimap-load-factor-stl-clr.md) `() <=` [hash_multimap::max_load_factor (STL/CLR)](../dotnet/hash-multimap-max-load-factor-stl-clr.md). En caso contrario, la tabla hash aumenta de tamaño solo si es necesario después de una inserción. (Automáticamente nunca disminuye de tamaño). Usa para ajustar el tamaño de la tabla hash.  
