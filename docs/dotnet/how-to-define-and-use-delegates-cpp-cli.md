---
title: Filtrar Definir y utilizar delegados (C++ / c++ / CLI)
ms.date: 11/04/2016
helpviewer_keywords:
- delegates
...
ms.locfileid: "57748715"
---
# <a name="how-to-define-and-use-delegates-ccli"></a>Filtrar Definir y utilizar delegados (C++ / c++ / CLI)
