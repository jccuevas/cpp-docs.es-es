...
## Comentarios  
 Esta función se comporta igual que la función `equal_range`STL.  Para obtener más información, vea [equal\_range](../Topic/equal_range.md).  
