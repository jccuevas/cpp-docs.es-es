...
## Comentarios  
 La función miembro devuelve true para una secuencia controlada vacía.  Es equivalente a [queue::size](../dotnet/queue-size-stl-clr.md)`() == 0`.  Se utiliza para probar si la cola está vacía.  
