...
La clase de plantilla describe un functor que, cuando se invoca, devuelve true solo si el primer argumento no es igual que el segundo.  Se utiliza especifica un objeto de función en términos del tipo de argumento.  
...
|Miembro|Descripción|  
|-------------|-----------------|  
|not\_equal\_to|Construye el functor.|  
...
## Comentarios  
 La clase de plantilla describe un functor de dos\- argumento.  Define el operador `operator()` de miembro para que, cuando el objeto se denomina como función, devuelve true solo si el primer argumento no es igual que el segundo.  
