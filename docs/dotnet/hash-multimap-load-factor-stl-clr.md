...
## Comentarios  
 La función miembro devuelve `(float)`[hash\_multimap::size](../dotnet/hash-multimap-size-stl-clr.md)`() /` [hash\_multimap::bucket\_count](../dotnet/hash-multimap-bucket-count-stl-clr.md)`()`.  Se utiliza para determinar el tamaño medio de depósito.  
