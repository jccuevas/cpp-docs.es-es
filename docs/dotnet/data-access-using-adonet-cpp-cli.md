---
title: Acceso a datos mediante ADO.NET (C++ / c++ / CLI) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
### <a name="example"></a>Ejemplo  
 ...
 Tenga en cuenta el miembro privado de la clase DatabaseClass: `gcroot<DataTable ^> table`. Puesto que los tipos nativos no pueden contener tipos administrados, el `gcroot` palabra clave es necesario. Para obtener más información sobre `gcroot`, consulte [Cómo: declarar controla en tipos nativos](../dotnet/how-to-declare-handles-in-native-types.md).  
...
## <a name="see-also"></a>Vea también  
 ...
 [Interoperabilidad](https://msdn.microsoft.com/afcc2e7d-3f32-48d2-8141-1c42acf29084)   
