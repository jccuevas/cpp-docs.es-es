...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "double (tipo de datos), tipo float"
  - "longitud de exponente"
  - "float (palabra clave) [C]"
  - "números de punto flotante, float (tipo)"
  - "números de punto flotante, variables"
  - "representación de punto flotante IEEE"
  - "longitudes, exponente"
  - "longitudes, mantisa"
  - "mantisas, longitud"
  - "intervalos, tipos de punto flotante"
  - "tipo float"
...
### Longitud de exponentes y mantisas  
...
### Intervalo de tipos de punto flotante  
