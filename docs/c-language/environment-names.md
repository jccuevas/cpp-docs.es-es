---
title: "Nombre del entorno | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
**ANSI 4.10.4.4** El conjunto de nombres de entorno y el método para modificar la lista de entorno utilizada por la función [getenv](../c-runtime-library/reference/getenv-wgetenv.md)  
 ...
 Para cambiar las variables de entorno desde un programa de C, se ha de llamar a la función [\_putenv](../c-runtime-library/reference/putenv-wputenv.md).  Para cambiar variables de entorno desde la línea de comandos de Windows, utilice el comando SET \(por ejemplo, SET LIB \= D: LIBS\).  
