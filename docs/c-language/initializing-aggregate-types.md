...
helpviewer_keywords: 
  - "tipos agregados [C++]"
  - "agregados [C++], inicializar"
  - "tipos [C], inicializar"
  - "union (palabra clave) [C]"
  - "union (palabra clave) [C], declaraciones"
 ...
 **Específicos de Microsoft**  
 ...
 El tamaño máximo para una matriz se define mediante **size\_t**.  Definido en el archivo de encabezado STDDEF.H, **size\_t** es un `unsigned int` con el intervalo de 0x00000000 a 0x7CFFFFFF.  
