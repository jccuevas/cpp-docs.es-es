...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "archivos [C++], de origen"
  - "programas [C++], de origen"
  - "archivos de código fuente, especificar en el compilador"
  - "programas de origen"
 ...
 *declaration*  
 ...
 [Información general de declaraciones](../c-language/overview-of-declarations.md) proporciona la sintaxis para `declaration` no terminal, y la *Referencia del preprocesador* explica cómo se procesa la [unidad de traducción](../preprocessor/phases-of-translation.md).  
