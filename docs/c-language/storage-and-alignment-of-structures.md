...
**Específicos de Microsoft**  
 ...
 Cada objeto de datos tiene un elemento *alignment\-requirement*.  Para las estructuras, el requisito es el mayor de sus miembros.  A cada objeto se le asigna un *offset* de forma que  
...
```  
 ...
 Los campos de bits tienen como valor predeterminado el tamaño **long** en el compilador C de Microsoft.  Los miembros de la estructura se alinean de acuerdo con el tamaño del tipo o el tamaño de \/Zp \[*n*\], lo que sea menor.  El tamaño predeterminado es 4.  
