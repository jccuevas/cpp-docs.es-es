...
|**do**|**if**|**static**|`while`|  
 ...
 No puede volver a definir las palabras clave.  Sin embargo, puede especificar el texto que se sustituirá para las palabras clave antes de la compilación mediante [directivas de preprocesador](../preprocessor/preprocessor-directives.md) de C.  
...
|`dllexport`2|`__inline`|`__leave`||  
 ...
 2.  Estos son identificadores especiales cuando se utilizan con `__declspec`; su uso en otros contextos no está restringido.  
