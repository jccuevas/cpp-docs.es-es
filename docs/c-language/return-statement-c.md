...
dev_langs: 
  ...
  - "C"
helpviewer_keywords: 
  - "( ) (paréntesis) en instrucciones return"
 ...
 **return**  *expression*  opt **;**  
 ...
 Muchos programadores utilizan paréntesis para incluir el argumento *expression* de la instrucción `return`.  Sin embargo, C no necesita los paréntesis.  
