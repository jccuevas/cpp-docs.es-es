...
# [Configuración de programas para procesadores ARM (Visual C++)](configuring-programs-for-arm-processors-visual-cpp.md)
...
## [Ventajas de usar archivos DLL](advantages-of-using-dlls.md)
...
## [Vinculación de un ejecutable a un archivo DLL](linking-an-executable-to-a-dll.md)
### [Determinación del método de vinculación que se va a usar](determining-which-linking-method-to-use.md)
### [Vinculación implícita](linking-implicitly.md)
### [Vinculación explícita](linking-explicitly.md)
## [Inicialización de un archivo DLL](initializing-a-dll.md)
### [Inicialización de archivos DLL estándar](initializing-regular-dlls.md)
### [Inicialización de archivos DLL de extensión](initializing-extension-dlls.md)
### [Inicialización de archivos DLL no basados en MFC](initializing-non-mfc-dlls.md)
...
### [Uso de archivos DLL de extensión de base de datos, OLE y Sockets en archivos DLL estándar](using-database-ole-and-sockets-extension-dlls-in-regular-dlls.md)
...
# [Compilación en la línea de comandos](building-on-the-command-line.md)
...
## [Establecimiento de la ruta de acceso y las variables de entorno para compilar desde la línea de comandos](setting-the-path-and-environment-variables-for-command-line-builds.md)
