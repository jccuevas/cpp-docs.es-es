...
|double-precision|Inicie sesión bit, exponentes de 11 bits, mantisa de 52 bits|
|double-extended-precision|Inicie sesión bit, exponente de 15 bits y exponentes de 64 bits|
