---
title: "Convenciones de software x64 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "Visual C++, convenciones de llamada x64"
  - "convenciones de codificación x64"
...
En esta sección se describe la metodología de la convención de llamada de Visual C\+\+ para [!INCLUDE[vcprx64](../assembler/inline/includes/vcprx64_md.md)], extensión de 64 bits en la arquitectura de x86.  
