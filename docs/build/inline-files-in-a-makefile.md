---
title: Archivos en línea en un archivo MAKE | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
## <a name="what-do-you-want-to-know-more-about"></a>¿Qué más desea saber?  
 [Especificar un archivo insertado](../build/specifying-an-inline-file.md)  
  
 [Crear texto del archivo en línea](../build/creating-inline-file-text.md)  
