---
title: -SUMMARY | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="remarks"></a>Comentarios  
 Esta opción muestra información básica acerca de las secciones, incluido el tamaño total. Esta opción es el valor predeterminado si no se especifica ninguna otra opción.  
