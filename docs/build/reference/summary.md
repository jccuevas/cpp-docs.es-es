...
Esta opción muestra información mínima sobre las secciones, incluido el tamaño total. Esta opción es el valor predeterminado si no se especifica ninguna otra opción.
