---
title: "Directivas pragma de optimización y las palabras clave | Documentos de Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="optimization-pragmas-and-keywords"></a>Directivas pragma y palabras clave de optimización
Varias palabras clave y directivas pragma que usar en el código de C o C++ afectan a la optimización:  
  
-   [__asm](../../assembler/inline/asm.md)  
  
-   [__assume](../../intrinsics/assume.md)  
  
-   [en línea, inline, o \__forceinline](../../cpp/inline-functions-cpp.md)  
  
-   [#pragma auto_inline](../../preprocessor/auto-inline.md)  
  
-   [#pragma check_stack](../../preprocessor/check-stack.md)  
  
-   [#pragma (función)](../../preprocessor/function-c-cpp.md)  
...
-   [registrar (palabra clave)](../../cpp/storage-classes-cpp.md#register)  
