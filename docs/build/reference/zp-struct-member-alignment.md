...
Cuando se especifica la **/Zp**_n_ opción, cada miembro de estructura después de que el primero se almacena en el tamaño del tipo de miembro o *n*-límites de bytes (donde *n* es 1, 2, 4, 8 o 16), lo que sea menor.

En la tabla siguiente se describen los valores de empaquetado disponibles:
...
> [!WARNING]  
> Encabezados de C++ en el SDK de Windows supone **/zp8** de empaquetado. Memoria pueden dañarse si la **/Zp** configuración se cambia al utilizar encabezados de SDK de Windows.
...
1. Seleccione el **C/C++** > **generación de código** página de propiedades.
