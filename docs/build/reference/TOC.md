...
### [Reglas de coherencia del encabezado precompilado](precompiled-header-consistency-rules.md)
...
### [Usar encabezados precompilados en un proyecto](using-precompiled-headers-in-a-project.md)
...
#### [NOMBRE (C-C++)](name-c-cpp.md)
#### [SECCIONES (C-C++)](sections-c-cpp.md)
#### [STACKSIZE](stacksize.md)
#### [STUB](stub.md)
#### [VERSIÓN (C-C++)](version-c-cpp.md)
...
# [Errores del compilador C2001 a C2499](../../error-messages/compiler-errors-1/TOC.md)
