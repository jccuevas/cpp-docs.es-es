...
# [Referencia de MSBuild para proyectos de C++](msbuild-reference-cpp.md)
## [Parámetros internos de MSBuild para proyectos de C++](msbuild-visual-cpp-overview.md)
## [Macros comunes para propiedades y comandos de compilación](common-macros-for-build-commands-and-properties.md)
## [Tipos de archivo utilizados en los proyectos de C++](file-types-created-for-visual-cpp-projects.md)
### [Archivos de proyecto y solución](project-and-solution-files.md)
### [Plantillas de proyectos de C++](visual-cpp-project-types.md)
### [Nuevas plantillas de elemento C++](using-visual-cpp-add-new-item-templates.md)
...
### [Archivos de ayuda HTML](help-files-html-help.md)
### [Archivos de ayuda de WinHelp](help-files-winhelp.md)
### [Archivos de indicaciones para Intellisense](hint-files.md)
...
## [Referencia de propiedades de proyectos de C++](property-pages-visual-cpp.md)
### [Página de propiedades General](general-property-page-project.md)
### [Página de propiedades General](general-property-page-file.md)
...
# [Referencia del compilador MSVC](compiling-a-c-cpp-program.md)
...
##### [Optimización de punto flotante de MSVC](floating-point-optimization.md)
...
### [/CETCOMPAT (compatible con la tecnología de aplicación de flujos de control)](cetcompat.md)
...
### [/DEPENDENTLOADFLAG (Establecer marcas de carga dependientes predeterminadas)](dependentloadflag.md)
...
### [Proyectos de NMAKE en Visual Studio](creating-a-makefile-project.md)
...
# [Errores de las herramientas de compilación y del compilador](../../error-messages/)
# [Documentación XML para C++](xml-documentation-visual-cpp.md)
## [Etiquetas recomendadas para los comentarios de documentación en C++](recommended-tags-for-documentation-comments-visual-cpp.md)
### [<c>](c-visual-cpp.md)
...
## [Delimitadores de etiquetas de documentación en C++](delimiters-for-visual-cpp-documentation-tags.md)
