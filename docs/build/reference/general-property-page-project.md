...
- **Archivo de registro de compilación**
   ...
   Puede utilizar macros de proyecto para cambiar la ubicación del directorio. Consulte [macros comunes para propiedades y comandos de compilación](common-macros-for-build-commands-and-properties.md).
