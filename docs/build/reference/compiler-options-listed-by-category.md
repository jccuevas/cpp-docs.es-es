---
title: Opciones del compilador ordenadas por categoría | Microsoft Docs
ms.custom: ''
ms.date: 08/20/2018
ms.technology:
- cpp-tools
...
ms.locfileid: "42571913"
---
# <a name="compiler-options-listed-by-category"></a>Opciones del compilador por categoría

Este artículo contiene una lista por categorías de las opciones del compilador. Para obtener una lista alfabética, vea [Compiler Options Listed Alphabetically](compiler-options-listed-alphabetically.md).
...
|Opción|Propósito|
|------------|-------------|
|[/ CLR: noAssembly](clr-common-language-runtime-compilation.md)|Desusado. Use [/LN (Create MSIL Module)](ln-create-msil-module.md) en su lugar.|
...
|[/Yd](yd-place-debug-information-in-object-file.md)|Desusado. Coloca información completa de depuración en todos los archivos de objeto. Use [/Zi](z7-zi-zi-debug-information-format.md) en su lugar.|
|[ForScope](zc-forscope-force-conformance-in-for-loop-scope.md)|Desusado. Deshabilita la conformidad en el ámbito del bucle.|
|[/ Ze](za-ze-disable-language-extensions.md)|Desusado. Habilita las extensiones de lenguaje.|
