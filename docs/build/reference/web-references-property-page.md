...
Para obtener información sobre cómo obtener acceso a la **referencia Web** página de propiedades, vea [propiedades de compilación y el compilador de C++ establece en Visual Studio](../working-with-project-properties.md).
