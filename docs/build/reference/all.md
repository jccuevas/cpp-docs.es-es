...
Esta opción muestra toda la información disponible excepto el código desensamblado. Use [/DISASM](disasm.md) para mostrar el desensamblado. Puede usar [/RAWDATA](rawdata.md): NONE con todo para omitir los detalles binarios sin formato del archivo.
