...
2. Seleccione el **propiedades de configuración** > **C o C++** > **línea de comandos** página de propiedades.

3. Especifique la opción del compilador en el **opciones adicionales** cuadro.
