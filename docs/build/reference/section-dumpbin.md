---
title: -SECTION (DUMPBIN) | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="remarks"></a>Comentarios  
 Esta opción restringe el resultado a la información en las clases *sección*. Use la [/HEADERS](../../build/reference/headers.md) opción para obtener una lista de las secciones en el archivo.  
