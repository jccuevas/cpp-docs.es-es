...
|[/favor](favor-optimize-for-architecture-specifics.md)|Produce código optimizado para una arquitectura [!INCLUDE[vcprx64](../../assembler/inline/includes/vcprx64_md.md)] específica o para las características de microarquitecturas en arquitecturas AMD64 y EM64T.|
...
|[/permissive-](permissive-standards-conformance.md)|Establezca el modo de cumplimiento del estándar.|
