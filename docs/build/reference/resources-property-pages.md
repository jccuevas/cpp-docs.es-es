---
title: páginas de propiedades Recursos
ms.date: 11/04/2016
f1_keywords:
...
Para obtener información sobre cómo obtener acceso a la **recursos** páginas de propiedades, vea [propiedades de compilación y el compilador de C++ establece en Visual Studio](../working-with-project-properties.md).
