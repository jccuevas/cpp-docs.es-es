---
title: Importar a una aplicación | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
-   Utilizar un archivo de definición (.def) módulo junto con **__declspec (dllimport)**  
