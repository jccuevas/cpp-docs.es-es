---
title: C2821 de Error del compilador | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
El primer parámetro formal de la [operador new](../../standard-library/new-operators.md#operator_new) deben tener un signo `int`.  
