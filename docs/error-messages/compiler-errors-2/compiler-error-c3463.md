...
'type': tipo no permitido en el atributo 'implements'  
 ...
 Un tipo no válido se pasó a la [implementa](../../windows/implements-cpp.md) atributo. Por ejemplo, puede pasar una interfaz a `implements`, pero no se puede pasar un puntero a una interfaz.  
