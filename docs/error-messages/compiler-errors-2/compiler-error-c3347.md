...
---
# Error del compilador C3347
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

'arg': el argumento requerido no está especificado en el atributo idl\_module.  
  
 No se pasó un argumento necesario al atributo [idl\_module](../../windows/idl-module.md).  
