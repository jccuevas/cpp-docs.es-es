---
title: Error del compilador C3277 | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33250021"
---
# <a name="compiler-error-c3277"></a>Error del compilador C3277
no se puede definir una enumeración no administrada 'enum' dentro de 'tipo' administrado  
