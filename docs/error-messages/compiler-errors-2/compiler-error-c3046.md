---
title: Error del compilador C3046 | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Falta el bloque estructurado en la región '#pragma omp sections' de OpenMP  
 ...
 A [secciones](../../parallel/openmp/reference/sections-openmp.md) directiva tiene un bloque de código vacío.  
