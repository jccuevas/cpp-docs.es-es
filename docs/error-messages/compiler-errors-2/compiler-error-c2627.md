---
title: C2627 de Error del compilador | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="compiler-error-c2627"></a>C2627 de Error del compilador
'función': función miembro no permitida en unión anónima  
