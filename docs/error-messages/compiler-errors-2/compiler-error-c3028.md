---
title: C3028 de Error del compilador | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
'miembro': solo los miembros de datos estáticos o variable se pueden utilizar en una cláusula de uso compartido de datos  
 ...
 Se pasó un símbolo que no sea un miembro de datos estáticos o variable a la cláusula de reducción.  
