---
title: Error del compilador C3408 | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33257720"
---
# <a name="compiler-error-c3408"></a>Error del compilador C3408
'attribute': no se permite el atributo en las definiciones de plantilla  
  
 Los atributos no se pueden aplicar a las definiciones de plantilla.  
