---
title: Error del compilador C3754 | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33268609"
---
# <a name="compiler-error-c3754"></a>Error del compilador C3754
constructor delegado: función de miembro 'function' no se puede llamar en una instancia de tipo 'type'  
