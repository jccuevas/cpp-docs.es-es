---
title: Error del compilador C3070 | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
'property': la propiedad no tiene un método 'set'  
 ...
 No se definió el método de descriptor de acceso set de una propiedad. Para obtener más información, consulte [propiedad](../../windows/property-cpp-component-extensions.md).  
