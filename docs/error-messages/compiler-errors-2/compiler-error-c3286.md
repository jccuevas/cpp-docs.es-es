...
'especificador': una variable de iteración no puede tener especificadores de clase de almacenamiento.  
 ...
 Vea [(NOTINBUILD) especificadores de clase de almacenamiento](http://msdn.microsoft.com/en-us/10b3d22d-cb40-450b-994b-08cf9a211b6c) para obtener más información.  
