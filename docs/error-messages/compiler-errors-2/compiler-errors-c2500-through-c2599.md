---
title: Errores del compilador C2500 a C2599 | Microsoft Docs
ms.custom: ''
ms.date: 11/17/2017
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "46017783"
---
# <a name="compiler-errors-c2500-through-c2599"></a>Errores del compilador C2500 a C2599
...
|C2501 de Error del compilador|'*identificador*': ' __declspec (*especificador*)' solo se puede aplicar a structs, uniones, clases o miembros de campo de bits sin signo|
...
|C2508 de Error del compilador|'*identificador*': ' __declspec (*specifier1*)' no se puede combinar con ' __declspec (*specifier2*)'|
...
|C2515 de Error del compilador|'*identificador*': 'vtguard' solamente se puede aplicar a definiciones o declaraciones de clase|
...
|C2519 de Error del compilador|'*identificador*': atributos de WinRT solo pueden contener campos públicos|
|C2520 de Error del compilador|'*clase*': no hay constructor no explícita disponible para la conversión implícita|
|[Error del compilador C2521](compiler-error-C2521.md)|un destructor/finalizador no toma ningún argumento|
|C2522 de Error del compilador|'*identificador*': no se puede utilizar el identificador de sobrecarga en '*identificador1*'como ya se especifica en'*identificador2*'|
...
|C2525 de Error del compilador|'*identificador*': el parámetro '*identificador1*'denominado'*identificador2*' en la base de función y debe coincidir en una implementación publicada|
...
|C2527 de Error del compilador|'*identificador*': no se puede especificar DefaultOverload en ambos '*función1*'y'*función2*'. Quite una especificación o cambie el nombre de la función durante la implementación|
...
|C2546 de Error del compilador|'*identificador*': cuando se define un tipo en un PIA y no primario, debe hacer referencia a los PIA en primer lugar|
|C2547 de Error del compilador|'*identificador*': todos los parámetros de un método publicado se deben designar explícitamente en la declaración|
...
|C2565 de Error del compilador|'*identificador*': calificador de referencia no es válido para constructores/destructores|
...
|C2576 de Error del compilador|'*identificador*': no se puede introducir un nuevo método virtual como 'public'. Considere la posibilidad de hacer que el método no virtual o cambiar la accesibilidad a 'internal' o 'protected private'|
...
|C2590 de Error del compilador|'*identificador*': solo un constructor puede tener una lista de inicializadores de base o miembro|
|C2591 de Error del compilador|ExclusiveTo no puede usar '*tipo*' como argumento. Solo 'ref class' es un argumento válido|
