...
ms.locfileid: "74760717"
---
# <a name="compiler-error-c3133"></a>Error del compilador C3133

Los atributos no se pueden C++ aplicar a varargs

Se aplicó incorrectamente un atributo. Los atributos no se pueden aplicar a los puntos suspensivos que representan argumentos variables.
...
En el ejemplo siguiente se genera C3133.
