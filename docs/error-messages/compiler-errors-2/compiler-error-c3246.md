---
title: C3246 de Error del compilador | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Una clase marcada como [sellado](../../windows/sealed-cpp-component-extensions.md) no puede ser la clase base para otras clases.  
