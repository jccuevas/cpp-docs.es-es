...
|C3108 de Error del compilador|no se puede deducir un tipo, ya que una lista de inicializadores no es una expresión|  
...
|C3111 de Error del compilador|No se puede usar una lista de inicializadores como argumento predeterminado para un parámetro de plantilla|  
...
|C3123 de Error del compilador|una interfaz genérica de WinRT no puede tener restricciones|  
...
|[Error del compilador C3130](compiler-error-c3130.md)|Error interno del compilador: error al escribir bloque de código insertado en PDB|  
|[Error del compilador C3131](compiler-error-c3131.md)|el proyecto debe tener un atributo 'module' con una propiedad 'name'|  
...
|[Error del compilador C3140](compiler-error-c3140.md)|no se pueden tener varios atributos 'module' en la misma unidad de compilación|  
...
|[Error del compilador C3157](compiler-error-c3157.md)|el atributo ParamArray solamente se puede aplicar al último parámetro|  
...
|[Error del compilador C3170](compiler-error-c3170.md)|no se pueden tener identificadores de módulo distintos en un proyecto|  
...
|[Error del compilador C3173](compiler-error-c3173.md)|la versión no coincide en la combinación de IDL|  
|[Error del compilador C3174](compiler-error-c3174.md)|no se especificó un atributo de módulo|  
