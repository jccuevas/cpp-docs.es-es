...
|[Error del compilador C3415](compiler-error-c3415.md)|varios '*sección*' se encontraron secciones con atributos diferentes ('0 x*valor*')|
...
|C3422 de Error del compilador|'*declaración*': error de coincidencia de tipos*tipo*'y'*tipo*'|
...
|C3425 de Error del compilador|no se puede producir un puntero al objeto de un tipo incompleto '*tipo*'|
|C3426 de Error del compilador|no se puede producir el objeto de un tipo incompleto '*tipo*'|
