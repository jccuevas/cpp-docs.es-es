...
|C3512 de Error del compilador|la secuencia de caracteres delimitadora de un literal de cadena sin formato no debe tener más de 16 caracteres|  
...
|C3515 de Error del compilador|si un argumento de una especialización parcial de una plantilla de clase es una expansión del paquete, este debe ser el último argumento|  
...
|C3517 de Error del compilador|'*identificador*' la declaración de un alias no puede tener un tipo que contiene 'auto'|  
...
|C3546 de Error del compilador|'...': no hay paquetes de parámetros disponibles para expandir|  
...
|C3570 de Error del compilador|uso no válido del ámbito con restricción de AMP al compilar con /clr|  
|C3571 de Error del compilador|'*tipo*': argumento de dominio de cálculo no válido; no es un tipo de clase|  
|C3572 de Error del compilador|'*tipo*': argumento de dominio de cálculo no válido; el miembro público que falta: 'static const int rango' o el valor de rango no es positivo|  
...
|C3574 de Error del compilador|'*tipo*': extensiones de icono no válido: debe ser positivo y (1) Z < = *número*; (2) Z*Y*X <= *number*|  
...
|C3587 de Error del compilador|dynamic_cast no se admite en código con restricción de AMP|  
...
|C3591 de Error del compilador|el operador typeid no se admite en código con restricción de AMP|  
|C3592 de Error del compilador|El ensamblado nativo alineado ('__asm') no se admite en código con restricción de AMP|  
|C3593 de Error del compilador|'goto' no se admite en código con restricción de AMP|  
|C3594 de Error del compilador|el control de excepciones (try, catch, throw etc.) no se admite en código con restricción de AMP|  
|C3595 de Error del compilador|el valor constante está fuera del intervalo admitido en código con restricción de AMP|  
...
|C3598 de Error del compilador|no se admite una instrucción de etiqueta en código con restricción de AMP|  
...
|C3605 de Error del compilador|El número total de muestras (*número* captura y *número* predefinidas) superar *número* al compilar el gráfico de llamadas para Concurrency:: parallel_for_each en: '*función*'|  
...
|C3613 de Error del compilador|falta el tipo de devolución después de '->' (se presupone 'int')|  
...
|C3615 de Error del compilador|función constexpr '*función*' no se puede dar lugar a una expresión constante|  
...
|[Error del compilador C3622] (error de compilador de c3622.md*tipo*': una clase declarada como '*palabra clave*' no se pueden crear instancias|  
...
|[Error del compilador C3648](compiler-error-c3648.md)|no se admite esta sintaxis de invalidación explícita para tipos administrados|  
...
|[Error del compilador C3665](compiler-error-c3665.md)|'*miembro*': especificador de reemplazo '*palabra clave*' no se permite en un destructor/finalizador|  
...
|[Error del compilador C3672](compiler-error-c3672.md)|la expresión de pseudodestructor solamente se puede utilizar como parte de una llamada a función|  
...
|C3677 de Error del compilador|el literal de cadena después de 'operator' no puede tener un prefijo de codificación|  
...
|C3680 de Error del compilador|no se pueden concatenar literales de cadena definidos por el usuario con identificadores de sufijo literales que no coinciden|  
...
|C3683 de Error del compilador|no se puede definir un operador literal sin formato y una plantilla de operador literal con el mismo identificador de sufijo|  
...
|C3690 de Error del compilador|se esperaba un literal de cadena pero se encontró un literal de cadena definido por el usuario|  
...
|[Error del compilador C3724](compiler-error-c3724.md)|debe utilizar #include <windows.h> para usar el subprocesamiento múltiple con eventos|  
...
|[Error del compilador C3739](compiler-error-c3739.md)|'*clase*': sintaxis sólo es compatible cuando el ' diseño\_dependientes ' del parámetro de event_receiver es true|  
...
|[Error del compilador C3743](compiler-error-c3743.md)|solo se puede enlazar/desenlazar una interfaz completa cuando el parámetro 'layout_dependent' de event_receiver se establece en true|  
...
|[Error del compilador C3768](compiler-error-c3768.md)|no se puede tomar la dirección de una función vararg virtual en código administrado puro|  
...
|C3776 de Error del compilador|no puede devolver una expresión de tipo void en un corrutina de tipo de valor devuelto final distinto de void|  
...
|{1&gt;Error del compilador C3811&lt;1}|Obsoleto.|  
...
|[Error del compilador C3836](compiler-error-c3836.md)|no se permite que un constructor estático tenga una lista de inicializadores de miembro|  
...
|[Error del compilador C3853](compiler-error-c3853.md)|'=': no se puede reinicializar una referencia o trabajo mediante una referencia a función|  
...
|C3875 de Error del compilador|falta lista de argumentos en llamada a función miembro no estática|  
...
|[Error del compilador C3920](compiler-error-c3920.md)|'*operador*': no se puede definir un incremento y decremento postfijo de llamada de operador CLR o WinRT operador CLR o WinRT llamará a WinRT o CLR de prefijo correspondiente (op_Increment/op_Decrement), pero con semántica de postfijo de operador|  
|{1&gt;Error del compilador C3921&lt;1}|Obsoleto.|  
...
|C3924 de Error del compilador|Error en el argumento #*número* de llamada al constructor de delegado '*constructor*':|  
...
|C3927 de Error del compilador|->: no se admite el tipo de valor devuelto final después de un declarador que no es de función|  
|C3928 de Error del compilador|->: no se admite el tipo de valor devuelto final después de un declarador entre paréntesis|  
...
|C3934 de Error del compilador|una función de un tipo 'main' cualquiera no puede tener especificadores de restricción distintos de restrict(cpu)|  
...
|C3937 de Error del compilador|no se permite un especificador de restricción vacío|  
...
|C3949 de Error del compilador|una expansión de paquete, '...', no puede aparecer en un declarador abstracto entre paréntesis.|  
...
|C3959 de Error del compilador|'ref new' solamente se puede usar para crear un objeto con tipo WinRT|  
|C3960 de Error del compilador|Obsoleto.|  
|C3961 de Error del compilador|no se admite un constructor estático|  
|C3962 de Error del compilador|no se admite una clase genérica|  
...
|C3965 de Error del compilador|no se admite una matriz de parámetros|  
|C3966 de Error del compilador|'*función*': no se admite la función genérica|  
|C3967 de Error del compilador|Error al importar '*identificador de*'del módulo'*módulo*'|  
|C3968 de Error del compilador|el símbolo (token) '*token*' no es válido como separador de nombres de módulo; punto ('. ') en su lugar|  
|C3969 de Error del compilador|los nombres de módulo incoherente: '*module1*'y'*module1*'|  
|C3970 de Error del compilador|'*identificador de*': '*palabra clave*' sólo se puede aplicar a 'clase ref' o 'ref struct' en el ámbito global o de espacio de nombres|  
|C3971 de Error del compilador|'*tipo de*': definición parcial no puede aparecer después de la definición completa|  
|C3972 de Error del compilador|'*tipo de*': 'partial' sólo se puede aplicar a definiciones o declaraciones de clase|  
|C3973 de Error del compilador|Obsoleto.|  
|C3974 de Error del compilador|Obsoleto.|  
|C3975 de Error del compilador|' clase/estructura *identificador*' previamente se ha declarado o definido con un modificador diferente|  
|C3976 de Error del compilador|'*identifier1*'se debe declarar como 'public' para poder usar'*identificador2*'|  
|C3977 de Error del compilador|El uso requiere una referencia a un ensamblado que define '*identificador*'|  
|C3978 de Error del compilador|'*identificador de*': una propiedad estática no está permitida como miembro de un tipo de valor o de la interfaz de WinRT|  
|C3979 de Error del compilador|'*tipo*': utilizar el atributo '*atributo*'en lugar de'*valor*'|  
|C3980 de Error del compilador|'*tipo*' no se emite en metadatos|  
|C3981 de Error del compilador|'*tipo*': un tipo de valor no puede tener los miembros de datos estáticos*identificador*'|  
|C3982 de Error del compilador|'*tipo*': un tipo de valor no puede tener los miembros de los datos no públicos*identificador*'|  
|C3983 de Error del compilador|'*tipo*': un tipo de valor no puede tener los miembros sin datos públicos*identificador*'|  
|C3984 de Error del compilador|'*tipo*': un tipo de valor no no puede tener los miembros de datos públicos*identificador*'|  
|C3985 de Error del compilador|'*identificador de*': firma de miembro público contiene un tipo privado '*miembro*'|  
|C3986 de Error del compilador|'*identificador de*': firma de miembro público contiene un tipo nativo '*miembro*'|  
|C3987 de Error del compilador|'*identificador de*': firma de miembro público contiene un tipo nativo '*tipo*'|  
|C3988 de Error del compilador|'*tipo de*': un tipo nativo no puede ser público|  
|C3989 de Error del compilador|'*tipo de*': un tipo anidado no puede ser público|  
|C3990 de Error del compilador|'*tipo*': atributo '*atributo*' no puede ser privada o anidado|  
|C3991 de Error del compilador|'*tipo*': no se puede implementar una interfaz no público o anidada '*interfaz*'|  
|C3992 de Error del compilador|'*identificador de*': firma de miembro público contiene un tipo no válido '*tipo*'|  
|C3993 de Error del compilador|'*tipo de*': un tipo de valor debe contener al menos un campo público|  
|C3994 de Error del compilador|'*tipo de*': un tipo de valor no puede implementar interfaces o tiene funciones virtuales|  
...
|C3998 de Error del compilador|' c ++*versión*': versión de C++ no admitido; el valor predeterminado ' c ++*versión*'|  
|Compiler Error C3999|ERROR DESCONOCIDO Elija el comando soporte técnico en el menú Ayuda de Visual C++, o abra el archivo de Ayuda de soporte técnico para obtener más información|  
