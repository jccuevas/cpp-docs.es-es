...
Para obtener más información, vea [genéricos](../../extensions/generics-cpp-component-extensions.md) y [OpenMP](../../parallel/openmp/openmp-in-visual-cpp.md).
