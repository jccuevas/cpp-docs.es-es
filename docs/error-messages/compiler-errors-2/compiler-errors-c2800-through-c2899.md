...
|[Error del compilador C2812](compiler-error-c2812.md)|#no se admite la importación con/CLR: pure y/CLR: safe|  
|[Error del compilador C2813](compiler-error-c2813.md)|#no se admite la importación con /MP|  
...
|[Error del compilador C2817](compiler-error-c2817.md)|el tipo de valor devuelto para 'operator delete' debe ser 'void'|  
...
|[Error del compilador C2821](compiler-error-c2821.md)|el primer parámetro formal para 'operator new' debe ser 'size_t'|  
...
|[Error del compilador C2824](compiler-error-c2824.md)|el tipo de valor devuelto para 'operator new' debe ser 'void *'|  
|[Error del compilador C2825](compiler-error-c2825.md)|'*identificador*': debe ser una clase o cuando va seguido del espacio de nombres '::'|  
...
|[Error del compilador C2830](compiler-error-c2830.md)|solo pueden tener valores predeterminados los parámetros de ubicación para 'operator new'|  
...
|C2841 de Error del compilador|argumento de registro no constante|  
...
|[Error del compilador C2860](compiler-error-c2860.md)|'void' no puede ser un tipo de argumento, con la excepción de '(void)'|  
...
|[Error del compilador C2892](compiler-error-c2892.md)|la clase local no debe tener plantillas de miembros|  
|[Error del compilador C2893](compiler-error-c2893.md)|No se pudo especializar la plantilla de función '*plantilla*'|  
|[Error del compilador C2894](compiler-error-c2894.md)|no se puede declarar una vinculación C para las plantillas|  
