---
title: Compilador advertencia (nivel 1) C4603 | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
'\<identificador >': no se definió la macro o la definición es diferente después del uso del encabezado precompilado  
