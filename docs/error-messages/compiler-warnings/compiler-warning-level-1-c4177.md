...
\#pragma pragma debe estar en el ámbito global  
 ...
 El [pragma](../../preprocessor/pragma-directives-and-the-pragma-keyword.md) pragma no debe usarse dentro de un ámbito local. El **pragma** no será válido hasta que se encuentre el ámbito global después del ámbito actual.  
