---
title: C4950 de advertencia del compilador | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Un miembro o tipo se ha marcado como obsoleto con la <xref:System.ObsoleteAttribute>atributo.</xref:System.ObsoleteAttribute>  
