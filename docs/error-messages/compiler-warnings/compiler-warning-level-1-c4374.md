---
title: Compilador advertencia (nivel 1) C4374 | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
'función1': el método no virtual 'function2' no implementará el método de interfaz  
 ...
 El compilador esperaba encontrar el [virtuales](../../cpp/virtual-specifier.md) palabra clave en una definición de método.  
