---
title: "Advertencia del compilador (nivel 4) C4681 | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
manager: "ghogen"
---
# Advertencia del compilador (nivel 4) C4681
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

'class': la coclase no especifica una interfaz predeterminada que sea un origen de eventos  
  
 Una interfaz [source](../Topic/source%20\(C++\).md) no se especificó para una clase.  
