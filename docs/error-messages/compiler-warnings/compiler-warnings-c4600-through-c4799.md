...
|Advertencia del compilador (nivel 3) C4609|'%$S' se deriva de la interfaz predeterminada '%$S' en el tipo '%$S'. Usar una interfaz predeterminada distinta de '%$S' o se ha interrumpido la relación de base/derivada.|  
...
|Advertencia del compilador (nivel 1) C4613|'%$S': no se puede cambiar la clase de segmento|  
...
|[Advertencia del compilador (nivel 1) C4616](../../error-messages/compiler-warnings/compiler-warning-level-1-c4616.md)|#Advertencia de pragma: número de advertencia 'número' no es una advertencia válida del compilador|  
|[Advertencia del compilador (nivel 1) C4618](../../error-messages/compiler-warnings/compiler-warning-level-1-c4618.md)|los parámetros de tipo pragma incluían una cadena vacía; se ha omitido pragma|  
|[Advertencia del compilador (nivel 3) C4619](../../error-messages/compiler-warnings/compiler-warning-level-3-c4619.md)|#Advertencia de pragma: no hay ningún número de advertencia 'número'|  
...
|[Advertencia del compilador (nivel 1) C4650](../../error-messages/compiler-warnings/compiler-warning-level-1-c4650.md)|la información de depuración no está en el encabezado precompilado; solo estarán disponibles símbolos globales del encabezado|  
...
|Advertencia del compilador (nivel 1) C4657|la expresión requiere un tipo de datos que sea nuevo desde la última compilación|  
...
|[Advertencia del compilador C4687](../../error-messages/compiler-warnings/compiler-warning-c4687.md)|'clase': una clase abstracta sealed no puede implementar una interfaz 'interfaz'|  
...
|Advertencia del compilador (nivel 1) C4689|'%c': carácter no admitido en #pragma detect_mismatch; se ha omitido #pragma|  
...
|Advertencia del compilador (nivel 1) Advertencia C4693|'clase': una clase abstracta sealed no puede tener cualquier instancia de 'miembro de instancia' miembros|  
|Advertencia del compilador (nivel 1) Advertencia C4694|'clase': una clase abstracta sealed no puede tener una clase base 'clase_base'|  
...
|[Advertencia del compilador (nivel 4) C4702](../../error-messages/compiler-warnings/compiler-warning-level-4-c4702.md)|no se puede tener acceso al código|  
|[Advertencia del compilador (nivel 4) C4703](../../error-messages/compiler-warnings/compiler-warning-level-4-c4703.md)|posiblemente se utilizó la variable de puntero local '%s' sin inicializar|  
...
|[Advertencia del compilador (nivel 4) C4709](../../error-messages/compiler-warnings/compiler-warning-level-4-c4709.md)|operador de comas en la expresión de índice de matriz|  
...
|[Advertencia del compilador (nivel 1) C4716](../../error-messages/compiler-warnings/compiler-warning-level-1-c4716.md)|'función': debe devolver un valor|  
...
|Advertencia del compilador (nivel 1) C4728|Se omitió la opción /Yl- porque se requiere una referencia a PCH|  
...
|[Advertencia del compilador (nivel 1) C4733](../../error-messages/compiler-warnings/compiler-warning-level-1-c4733.md)|Inline asm que asigna a 'FS:0': el controlador no está registrado como controlador seguro|  
...
|[Advertencia del compilador (nivel 4) C4740](../../error-messages/compiler-warnings/compiler-warning-level-4-c4740.md)|flow in o flow out del código inline asm suprime la optimización global|  
...
|[Advertencia del compilador C4746](../../error-messages/compiler-warnings/compiler-warning-c4746.md)|acceso volátil de '%s' está sujeto a /volatile:\<iso &#124; ms > establecer; considere el uso de funciones intrínsecas de __iso_volatile_load/almacén|  
...
|Advertencia del compilador (nivel 4) C4751|/arch:AVX no se aplica a las extensiones SIMD de streaming de Intel(R) incluidas en ASM inline|  
|Advertencia del compilador (nivel 4) C4752|se encontraron extensiones vectoriales avanzadas (AVX, Advanced Vector Extensions) de Intel(R); considere el uso de /arch:AVX|  
...
|C4770 de advertencia del compilador|enumeración '%s' validada parcialmente usada como índice|  
|[Advertencia del compilador (nivel 1) C4772](../../error-messages/compiler-warnings/compiler-warning-level-1-c4772.md)|#importación hace referencia a un tipo de una biblioteca de tipos que falta; 'falta_tipo' como marcador de posición|  
...
|Advertencia del compilador (nivel 1) C4794|el segmento de la variable '%s' de almacenamiento local de subprocesos se ha cambiado de '%s' a '%s'|  
