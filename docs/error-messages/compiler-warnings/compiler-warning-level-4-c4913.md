---
title: Advertencia de compilador advertencia (nivel 4) C4913 | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
**usuario definido por el operador binario ',' existe pero ninguna sobrecarga puede convertir todos los operandos, operador binario ',' incorporado**  
