...
|[Advertencia del compilador (nivel 4) C4001](../../error-messages/compiler-warnings/compiler-warning-level-4-c4001.md)|se usó una extensión no estándar 'comentario de una única línea'|
...
|[Advertencia del compilador (nivel 1) C4029](../../error-messages/compiler-warnings/compiler-warning-level-1-c4029.md)|lista de parámetros formales declarados distinta de la definición|
...
|[Advertencia del compilador (nivel 1) C4142](../../error-messages/compiler-warnings/compiler-warning-level-1-c4142.md)|benigno nueva definición de tipo|
