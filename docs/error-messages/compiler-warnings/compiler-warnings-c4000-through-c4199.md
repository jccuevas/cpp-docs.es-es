...
|Advertencia|Mensaje|  
|-------------|-------------|  
|C4000 de advertencia del compilador|ADVERTENCIA DESCONOCIDA<br /><br /> Elija el comando soporte técnico en Visual C++<br /><br /> Menú Ayuda o abra el archivo de Ayuda de soporte técnico para obtener más información|  
|[Advertencia del compilador (nivel 4) C4001](../../error-messages/compiler-warnings/compiler-warning-level-4-c4001.md)|se ha utilizado la extensión de tipo no estándar 'comentario de una sola línea'|  
...
|[Advertencia del compilador (nivel 1) C4005](../../error-messages/compiler-warnings/compiler-warning-level-1-c4005.md)|'identificador': nueva definición de macro|  
...
|Advertencia del compilador (nivel 3) C4008|'función': atributo 'atributo' omitido|  
...
|[Advertencia del compilador (nivel 3) C4013](../../error-messages/compiler-warnings/compiler-warning-level-3-c4013.md)|'función' sin definir; Suponiendo que int devuelto es extern|  
...
|[Advertencia del compilador (nivel 1) C4020](../../error-messages/compiler-warnings/compiler-warning-level-1-c4020.md)|'función': hay demasiados parámetros reales|  
|[Advertencia del compilador (nivel 1) C4022](../../error-messages/compiler-warnings/compiler-warning-level-1-c4022.md)|'función': puntero no coincide con el parámetro real 'número de parámetro'|  
|Advertencia del compilador (nivel 1) C4023|'función': puntero de tipo basado se pasa a la función sin prototipo: parámetro 'número_parámetro'|  
|[Advertencia del compilador (nivel 1) C4024](../../error-messages/compiler-warnings/compiler-warning-level-1-c4024.md)|'función': tipos diferentes de parámetros formales y reales 'número_parámetro'|  
|Advertencia del compilador (nivel 1) C4025|'función': puntero de tipo basado se pasó a la función con argumentos de variable: parámetro 'número_parámetro'|  
...
|[Compilador (nivel 1) de la advertencia C4028](../../error-messages/compiler-warnings/compiler-warning-level-1-c4028.md)8|'número_parámetro' distinto de la declaración de parámetros formales|  
|[Advertencia del compilador (nivel 1) C4029](../../error-messages/compiler-warnings/compiler-warning-level-1-c4029.md)|la lista de parámetros formales declarada es distinta de la definición|  
...
|[Advertencia del compilador (nivel 1) C4049](../../error-messages/compiler-warnings/compiler-warning-level-1-c4049.md)|límite del compilador: se va a finalizar la emisión de números de línea|  
...
|[Advertencia del compilador (nivel 1) C4067](../../error-messages/compiler-warnings/compiler-warning-level-1-c4067.md)|símbolos (token) inesperados después de la directiva del preprocesador; se esperaba una nueva línea|  
|Advertencia del compilador (nivel 1) C4068|pragma desconocida|  
|C4069 de advertencia del compilador|long double tiene la misma precisión que double|  
|[Advertencia del compilador (nivel 3) C4073](../../error-messages/compiler-warnings/compiler-warning-level-3-c4073.md)|inicializadores situados en el área de inicialización de bibliotecas|  
...
|[Advertencia del compilador (nivel 1) C4088](../../error-messages/compiler-warnings/compiler-warning-level-1-c4088.md)|'función': no coincide el puntero en el parámetro real 'número_parámetro', parámetro formal 'número_parámetro'|  
...
|Advertencia del compilador (nivel 1) C4112|#línea requiere un entero entre 1 y 'line_count'|  
...
|[Advertencia del compilador (nivel 1) C4142](../../error-messages/compiler-warnings/compiler-warning-level-1-c4142.md)|nueva definición de tipo sin efecto|  
...
|[Advertencia del compilador (nivel 2) C4146](../../error-messages/compiler-warnings/compiler-warning-level-2-c4146.md)|operador unario menos aplicado a un tipo unsigned; el resultado aún no tiene signo|  
...
|[Advertencia del compilador (nivel 1) C4154](../../error-messages/compiler-warnings/compiler-warning-level-1-c4154.md)|eliminación de una expresión de matriz; suministrada una conversión a puntero|  
|Advertencia del compilador (nivel 1) C4155|eliminación de expresión de matriz sin utilizar el formato de matriz de 'delete'|  
|[Advertencia del compilador (nivel 2) C4156](../../error-messages/compiler-warnings/compiler-warning-level-2-c4156.md)|eliminación de expresión de matriz sin utilizar el formato de matriz de 'delete'; formato de matriz sustituido|  
|[Advertencia del compilador (nivel 1) C4157](../../error-messages/compiler-warnings/compiler-warning-level-1-c4157.md)|el compilador C ha omitido pragma|  
...
|Advertencia del compilador (nivel 1) C4165|'HRESULT' se está convirtiendo en 'bool'; ¿seguro que desea realizar esta operación?|  
...
|[Advertencia del compilador (nivel 1) C4172](../../error-messages/compiler-warnings/compiler-warning-level-1-c4172.md)|devolución de dirección de la variable local o temporal|  
...
|C4181 de advertencia del compilador|se ha omitido el calificador aplicado al tipo de referencia|  
|Advertencia del compilador (nivel 1) C4182|#incluir el nivel de anidamiento es 'nest_count' profundo; posible recursividad infinita|  
...
|Advertencia del compilador (nivel 1) C4186|#importación de atributo 'attribute' requiere argumentos de 'argument_count'; pasa por alto|  
|Advertencia del compilador (nivel 1) C4187|#atributos de importación 'atributo1' y 'atributo2' son incompatibles; se omiten ambos|  
