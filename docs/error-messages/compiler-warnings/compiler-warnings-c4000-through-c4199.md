...
|Advertencia del compilador (nivel 1) C4002|hay demasiados parámetros reales para la macro 'identifier'|
...
|Advertencia del compilador (nivel 3) C4008|'function': atributo 'atributo' omitido|
...
|Advertencia del compilador (nivel 1) C4025|'function': puntero pasado a la función con argumentos de variable: parámetro 'número_parámetro'|
...
|Advertencia del compilador (nivel 1) C4033|'function': la función debe devolver un valor|
...
|Advertencia del compilador (nivel 1) C4041|límite del compilador: finalizar el resultado del explorador|
...
|Advertencia del compilador (nivel 4) C4057|'operador': 'identificador1' difiere de direccionamiento indirecto en tipos base ligeramente diferentes de 'identificador2'|
...
|Advertencia del compilador (nivel 1) C4076|'type_modifier': no se puede usar con el tipo 'nombredetipo'|
...
|Advertencia del compilador (nivel 1) C4087|'function': declarada con lista de parámetros 'void'|
...
|Advertencia del compilador (niveles 1 y 4) C4115|'type': definición de tipo entre paréntesis con nombre|
...
|Advertencia del compilador (nivel 1) C4117|nombre de macro 'name' está reservado, se omite 'command'|
...
|Advertencia del compilador (nivel 1) C4122|'function': alloc_text aplicable solo a funciones con vinculación C|
...
|Advertencia del compilador (nivel 4) C4131|'function': utiliza el declarador de estilo antiguo|
|Advertencia del compilador (nivel 4) C4132|'object': debe inicializarse un objeto const|
...
|Advertencia del compilador (nivel 1) C4141|'modifier': puede usar más de una vez|
...
|Advertencia del compilador (nivel 4) C4152|extensión no estándar; conversión de puntero a función/datos en expresión|
...
|Advertencia del compilador (nivel 1) C4158|utiliza #pragma pointers_to_members (full_generality, 'inheritance_type')|
...
|Advertencia del compilador (nivel 1) C4164|'function': función intrínseca no declarada|
...
|Advertencia del compilador (nivel 1) C4176|'subcomponent': subcomponente desconocido para el explorador del componente de #pragma|
|Advertencia del compilador (nivel 1) C4177|#pragma 'pragma' solo debe usarse en el ámbito global o de espacio de nombres|
|Advertencia del compilador (nivel 1) C4178|constante case 'constante' demasiado grande para el tipo de expresión switch|
|Advertencia del compilador (nivel 4) C4179|' / / *': analizado como '/' y ' /\*': confusión con standard ' / /' comentarios|
...
|Advertencia del compilador (nivel 1) C4182|#include nesting level is 'nest_count' deep; possible infinite recursion|
...
|Advertencia del compilador (nivel 1) C4186|atributo de #import 'attribute' requiere argumentos 'argument_count'; pasa por alto|
...
|Advertencia del compilador (nivel 4) C4189|'identifier': se ha inicializado pero no hace referencia a una variable local|
