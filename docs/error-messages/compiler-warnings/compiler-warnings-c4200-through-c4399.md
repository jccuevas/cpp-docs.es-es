...
|[Compilador advertencia (nivel 1, Error) C4226](../../error-messages/compiler-warnings/compiler-warning-level-1-c4226.md)|ha utilizado una extensión no estándar: 'keyword' es una palabra clave obsoleta|
...
|[Compilador advertencia (nivel 4, Error) C4233](../../error-messages/compiler-warnings/compiler-warning-level-4-c4233.md)|ha utilizado una extensión no estándar: ' palabra clave ' sólo se admite en C++, no en C|
|[Compilador advertencia (nivel 4, Error) C4234](../../error-messages/compiler-warnings/compiler-warning-level-4-c4234.md)|ha utilizado una extensión no estándar: 'palabra clave' palabra clave reservado para uso futuro|
|[(Nivel 4, Error) de advertencia del compilador C4235](../../error-messages/compiler-warnings/compiler-warning-level-4-c4235.md)|ha utilizado una extensión no estándar: ' palabra clave ' no se admite en esta arquitectura|
...
|[Advertencia del compilador (nivel 1) C4291](../../error-messages/compiler-warnings/compiler-warning-level-1-c4291.md)|'declaration': ninguna búsqueda de coincidencias operador delete se encuentra; no se liberará memoria si la inicialización produce una excepción|
...
|Advertencia del compilador (nivel 1) C4321|generar automáticamente un IID para la interfaz '%$S'|
|Advertencia del compilador (nivel 1) C4322|generar automáticamente un CLSID para la clase '%$S'|
...
|Advertencia del compilador (nivel 1) C4330|el atributo '%s' para la sección '%s' omitido|
...
|Advertencia del compilador (nivel 4) C4338|se utiliza #pragma % s: sección estándar '%s'|
...
|Advertencia del compilador (nivel 1) C4352|' % $I ': función intrínseca ya definido|
...
|Advertencia del compilador (nivel 2) C4362|'%$S': alineación superior a 8 bytes no es compatible con CLR|
|[Advertencia del compilador (nivel 1) C4364](../../error-messages/compiler-warnings/compiler-warning-level-1-c4364.md)|#using para el ensamblado 'ensamblado' aparece previamente en ' location'('line_number') sin el atributo as_friend; as_friend que no se aplica|
...
|Advertencia del compilador (nivel 3) C4367|La conversión de '%$T' a '%$T' puede producir la excepción de desalineación de tipo de datos|
|[(Error) de advertencia del compilador C4368](../../error-messages/compiler-warnings/compiler-warning-c4368.md)|no puede definir 'miembro' como miembro de 'tipo' administrado: no se admiten tipos mixtos|
...
|Advertencia del compilador (nivel 3) C4371|'classname': el diseño de clase puede haber cambiado desde una versión anterior del compilador debido a una mejora del empaquetado del miembro 'miembro'|
...
|Advertencia del compilador (nivel 1, Error) C4380|'%$S': un constructor predeterminado no puede estar en desuso|
...
|Advertencia del compilador (nivel 3) C4387|'%s': se consideran|
