---
title: Compilador advertencia (nivel 1) C4621 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
Esta advertencia puede evitarse definiendo un sufijo `--` operador. Crear una versión de dos argumentos de la `--` operador tal como se muestra a continuación:
