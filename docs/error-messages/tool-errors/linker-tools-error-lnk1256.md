---
title: Herramientas del vinculador LNK1256 Error | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Error de operación ALINK: razón  
 ...
 LNK1256 también puede producirse si ALINK no pudo encontrar el contenedor de claves nombrado. Eliminar el contenedor de claves y agregar nuevo a CSP de nombres seguros mediante [Sn.exe (herramienta de nombre seguro)](http://msdn.microsoft.com/Library/c1d2b532-1b8e-4c7a-8ac5-53b801135ec6).  
