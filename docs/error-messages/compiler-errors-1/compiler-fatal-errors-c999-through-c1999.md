...
---
# Errores graves del compilador: de C999 a C1999
...
|Error|Mensaje|  
|-----------|-------------|  
|[Fatal Error C999](../../error-messages/compiler-errors-1/fatal-error-c999.md)|MENSAJE DESCONOCIDO Elija el comando Soporte técnico en el menú Ayuda de Visual C\+\+, o abra el archivo de ayuda Soporte técnico para obtener más información|  
