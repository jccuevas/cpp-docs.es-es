...
|[Error irrecuperable C1016](fatal-error-c1016.md)|#ifdef/#ifndef esperaba un identificador|
...
|[Error irrecuperable C1018](fatal-error-c1018.md)|#elif inesperada|
|[Error irrecuperable C1019](fatal-error-c1019.md)|#else inesperada|
...
|[Error irrecuperable C1035](fatal-error-c1035.md)|expresión demasiado compleja; simplifique la expresión|
...
|[Error irrecuperable C1037](fatal-error-c1037.md)|no se puede abrir el archivo objeto '*file*'|
|[Error irrecuperable C1038](fatal-error-c1038.md)|límite del compilador: '*function*': el estado de flujo de control es demasiado complejo; simplifique la función|
...
|[Error irrecuperable C1045](fatal-error-c1045.md)|límite del compilador: las especificaciones de vinculación están demasiado anidadas|
...
|[Error irrecuperable C1091](fatal-error-c1091.md)|límite del compilador: la longitud de la cadena supera los *number* bytes|
...
|[Error irrecuperable C1208](fatal-error-c1208.md)|La versión del runtime instalada no admite la asignación de clases de referencia en la pila|
