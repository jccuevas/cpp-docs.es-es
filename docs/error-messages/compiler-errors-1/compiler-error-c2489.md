---
title: Error del compilador C2489
ms.date: 11/04/2016
f1_keywords:
- C2489
helpviewer_keywords:
...
ms.locfileid: "62361040"
---
# <a name="compiler-error-c2489"></a>Error del compilador C2489

'identifier': no se permite en el ámbito de función en la función 'naked' una variable auto o register inicializada
