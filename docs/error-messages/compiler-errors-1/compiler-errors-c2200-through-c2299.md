---
title: Errores de compilador C2200 a C2299
ms.date: 11/17/2017
f1_keywords:
- C2202
- C2209
...
ms.locfileid: "50432531"
---
# <a name="compiler-errors-c2200-through-c2299"></a>Errores de compilador C2200 a C2299
...
|C2210 de Error del compilador|'*identificador*': las expansiones del paquete no se puede usar como argumentos a parámetros sin empaquetar de plantillas de alias|
|C2211 de Error del compilador|Un destructor no virtual en una clase ref derivado de una clase ref con un destructor público también debe ser público|
...
|C2239 de Error del compilador|'*función*': si intenta eliminar una función __declspec (dllexport)|
...
|C2269 de Error del compilador|no se puede crear un puntero o referencia a un tipo de función cualificado (requiere el puntero a miembro)|
...
|C2282 de Error del compilador|'*función1*'no puede invalidar'*función2*'|
...
|C2294 de Error del compilador|no se puede exportar el símbolo '*identificador*' porque tiene vinculación interna|
