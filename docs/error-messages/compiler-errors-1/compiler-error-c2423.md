...
ms.locfileid: "74744672"
---
# <a name="compiler-error-c2423"></a>Error del compilador C2423

' número ': escala no válida

El código de ensamblado alineado usa un número distinto de 1, 2, 4 u 8 para escalar un registro.

En el ejemplo siguiente se genera C2423:
