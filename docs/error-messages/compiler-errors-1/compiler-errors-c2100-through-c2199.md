---
title: Errores del compilador C2100 a C2199 | Microsoft Docs
ms.custom: ''
ms.date: 11/17/2017
ms.technology:
- cpp-diagnostics
...
|[Error del compilador C2110](compiler-error-c2110.md)|'+': no se puede sumar dos punteros|
...
|C2131 de Error del compilador|expresión no se evaluaran como una constante|
