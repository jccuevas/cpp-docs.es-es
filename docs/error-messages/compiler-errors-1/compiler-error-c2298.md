---
title: "Error del compilador C2298 | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
manager: "ghogen"
---
# Error del compilador C2298
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

'operación' : operación no válida del puntero a expresión de función miembro  
  
 Un puntero a una expresión de función miembro debe llamar a la función miembro.  
  
## Ejemplo  
 El ejemplo siguiente genera el error C2298.  
