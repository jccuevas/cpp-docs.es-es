...
|[Error del compilador C2002](compiler-error-c2002.md)|constante de caracteres anchos no válido|
|[Error del compilador C2003](compiler-error-c2003.md)|se esperaba 'defined identificador'|
...
|C2016 de Error del compilador|C requiere que una estructura o unión tiene al menos un miembro|
...
|[Error del compilador C2050](compiler-error-c2050.md)|expresión switch no entero|
...
|[Error del compilador C2055](compiler-error-c2055.md)|se esperaba la lista de parámetros formales, no una lista de tipo|
...
|[Error del compilador C2066](compiler-error-c2066.md)|conversión al tipo de función no es válida|
