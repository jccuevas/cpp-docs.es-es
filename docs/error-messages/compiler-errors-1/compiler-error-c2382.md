...
'function': nueva definición; especificaciones de excepción diferentes  
 ...
 En [/Za](../../build/reference/za-ze-disable-language-extensions.md), este error indica que una sobrecarga de función se ha intentado solo en el [una especificación de excepción](../../cpp/exception-specifications-throw-cpp.md).  
