---
title: Errores de compilador C2400 a C2499
ms.date: 11/17/2017
f1_keywords:
- C2416
- C2442
...
ms.locfileid: "50476198"
---
# <a name="compiler-errors-c2400-through-c2499"></a>Errores de compilador C2400 a C2499
...
|C2442 de Error del compilador|'*identificador*': definición de espacio de nombres anidado no puede estar alineado ni tener atributos|
...
|[Error del compilador C2446](compiler-error-c2446.md)|'*operador*': no hay conversión de '*type_1*'para'*type_2*'|
...
|C2454 de Error del compilador|'*identificador*': nombre de alias de espacio de nombres no se puede declarar mediante un nombre completo|
...
|C2456 de Error del compilador|'*clase*' una clase ref no sellada no puede tener un constructor público visible. Selle la clase, o especifique el constructor como 'internal', 'protected private' o 'private' en su lugar.|
...
|C2468 de Error del compilador|el constructor no puede ser 'constexpr' en una clase o estructura con clases base virtuales|
...
|C2475 de Error del compilador|'*identificador*': redefinición; Error de coincidencia de especificador 'constexpr'|
...
|C2481 de Error del compilador|'*identificador*': thread_local solo es válido en miembros estáticos y las variables en ámbito de espacio de nombres o bloque|
...
|C2497 de Error del compilador|'*identificador*': 'implementation_key' solo se puede aplicar a declaraciones de función|
