---
title: Error irrecuperable C1310 | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
las optimizaciones guiadas por perfiles no están disponibles con OpenMP  
 ...
 No podrá vincular con [/LTCG: PGI](../../build/reference/ltcg-link-time-code-generation.md) cualquier módulo que se compiló con [/GL](../../build/reference/gl-whole-program-optimization.md).  
