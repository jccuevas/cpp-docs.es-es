...
| Type                     | Tipo del evento actual. Este valor es Activity o Property. |
...
| Invocaciones           | Active Directory               | Desplácese hacia abajo a través de una lista de invocaciones en la vista de gráfico ordenadas por hora de inicio. Puede usarlo junto con la vista CPU (muestreada) para buscar las invocaciones que se alinean con zonas de uso de CPU bajas. Detectar problemas de paralelismo. |
