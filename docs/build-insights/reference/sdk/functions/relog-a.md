---
title: RelogA
description: La C++ referencia de la función RELOGA del SDK de Build Insights.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
La función `RelogA` se usa para leer eventos MSVC desde un seguimiento de seguimiento de eventos para Windows (ETW) y escribirlos en un seguimiento ETW nuevo y modificado.
