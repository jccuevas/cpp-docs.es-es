---
title: Clase OptRef
description: Referencia C++ de la clase OPTREF del SDK de Build Insights.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
Junto con los miembros heredados de su clase base de [actividad](activity.md) , la clase `OptRef` contiene los siguientes miembros:
