---
title: Linker (clase)
description: Referencia C++ de la clase del enlazador del SDK de Build Insights.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
ms.locfileid: "78334713"
---
# <a name="linker-class"></a>Linker (clase)
...
Junto con los miembros heredados de la clase base de [invocación](invocation.md) , la clase `Linker` contiene los siguientes miembros:

### <a name="constructors"></a>Constructores

[Linker](#linker)

## <a name="linker"></a>Del vinculador
