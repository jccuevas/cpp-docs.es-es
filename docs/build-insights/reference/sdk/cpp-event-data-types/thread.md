---
title: Thread (clase)
description: Referencia C++ a la clase de subproceso del SDK de Build Insights.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
Junto con los miembros heredados de su clase base de [actividad](activity.md) , la clase `Thread` contiene los siguientes miembros:

### <a name="constructors"></a>Constructores

[Subproceso](#thread)

## <a name="thread"></a>Conversaciones
