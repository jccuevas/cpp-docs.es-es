...
## [Portabilidad y actualizaciones: ejemplos y casos prácticos](porting-and-upgrading-examples-and-case-studies.md)
...
### [Cómo: Uso de código C++ existente en una aplicación de la Plataforma universal de Windows](how-to-use-existing-cpp-code-in-a-universal-windows-platform-app.md)
