---
title: ELSEIF (MASM) | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
ms.locfileid: "32055806"
---
# <a name="elseif-masm"></a>ELSEIF (MASM)
Combina [ELSE](../../assembler/masm/else-masm.md) y [IF](../../assembler/masm/if-masm.md) en una instrucción.  
