...
ms.locfileid: "62198407"
---
# <a name="operator-this"></a>Operador THIS

Devuelve un operando de especificado `type` cuyos valores de offset y segmento son iguales al valor del contador de ubicación actual.
