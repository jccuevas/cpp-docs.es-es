---
title: DWORD | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
ms.locfileid: "32052526"
---
# <a name="dword"></a>DWORD
Asigna y, opcionalmente, inicializa una palabra doble (4 bytes) de almacenamiento para cada `initializer`.  
