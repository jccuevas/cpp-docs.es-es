---
title: Advertencia A4004 de ML | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
ms.locfileid: "32054395"
---
# <a name="ml-warning-a4004"></a>Advertencia A4004 de ML
**no se puede ASUMIR CS**  
  
 Se intentó suponga un valor para el registro CS. CS siempre se establece en el segmento actual o el grupo.  
