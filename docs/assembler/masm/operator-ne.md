---
title: operador NE | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="operator-ne"></a>Operador NE
Devuelve true (-1) si *expression1* no es igual a *expression2*, o devuelve false (0) si lo hace.  
