---
title: DF | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
ms.locfileid: "32051751"
---
# <a name="df"></a>DF
Asigna y, opcionalmente, inicializa 6 bytes de almacenamiento para cada `initializer`. `DF` es un sinónimo de [FWORD](../../assembler/masm/fword.md).  
