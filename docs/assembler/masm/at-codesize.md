---
title: '@CodeSize | Documentos de Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
ms.locfileid: "32049143"
---
# <a name="codesize"></a>@CodeSize
0 para **MINÚSCULO**, **pequeño**, **COMPACT**, y **FLAT** modelos y 1 para **medio**,  **GRANDES**, y **ENORME** modelos (equivaler numérico).  
