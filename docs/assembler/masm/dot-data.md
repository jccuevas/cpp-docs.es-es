---
title: . DATOS | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
---
# <a name="data"></a>.DATA
Cuando se utiliza con [. MODELO](../../assembler/masm/dot-model.md), inicia un segmento de datos casi para datos inicializados (_DATA de nombre de segmento).  
