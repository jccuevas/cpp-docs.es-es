---
title: operador PTR | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
El primer operador se fuerza la *expresión* tratará como si tuviera especificado `type`. El segundo operador especifica un puntero a `type`.  
