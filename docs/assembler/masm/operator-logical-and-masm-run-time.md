...
ms.locfileid: "75317908"
---
# <a name="operator-ampamp-masm-run-time"></a>operador &amp;&amp; (tiempo de ejecución de MASM)

**And**lógico. Se usa solo dentro de [. Si](dot-if.md)es, [. WHILE](dot-while.md), o [. REPETIR](dot-repeat.md) bloques y evaluarlos en tiempo de ejecución, no en tiempo de ensamblado.
