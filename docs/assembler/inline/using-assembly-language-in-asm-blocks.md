---
title: "Usar lenguaje de ensamblado en bloques __asm | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "__asm (palabra clave) [C++], lenguaje ensamblador en"
  - "lenguaje ensamblador [C++]"
  - "lenguaje ensamblador [C++], características"
...
manager: "ghogen"
---
# Usar lenguaje de ensamblado en bloques __asm
...
-   [Referencias de segmento de ensamblado insertado](../../assembler/inline/segment-references-in-inline-assembly.md)  
...
-   [Conjunto de instrucciones MMX Intel](../../assembler/inline/intel-s-mmx-instruction-set.md)  
