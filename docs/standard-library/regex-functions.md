...
*BidIt*<br/>
El tipo de iterador para subcoincidencias. Para casos comunes de `string::const_iterator`, `wstring::const_iterator`, `const char*` o `const wchar_t*`.
