...
`left` Un objeto de tipo `hash_set`.

`right` Un objeto de tipo `hash_set`.
...
`left` Un objeto de tipo `hash_multiset`.

`right` Un objeto de tipo `hash_multiset`.
