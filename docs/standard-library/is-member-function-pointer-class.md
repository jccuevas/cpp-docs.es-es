...
Una instancia del predicado de tipo contiene true si el tipo *Ty* es un puntero a función miembro o un `cv-qualified` puntero a función de miembro; en caso contrario, contiene false.
