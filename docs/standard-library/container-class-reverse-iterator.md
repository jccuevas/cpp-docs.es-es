...
Se describe como sinónimo del tipo sin especificar `T7` (normalmente `reverse_iterator` **\<** [iterador](../standard-library/container-class-iterator.md)**>**).
