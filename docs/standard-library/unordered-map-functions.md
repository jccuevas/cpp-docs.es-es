---
title: Funciones de &lt;unordered_map&gt; | Microsoft Docs
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
### <a name="remarks"></a>Comentarios  
 La función de plantilla ejecuta `left.`[unordered_map::swap](../standard-library/unordered-map-class.md#unordered_map__swap)`(right)`.  
...
### <a name="remarks"></a>Comentarios  
 La función de plantilla ejecuta `left.`[unordered_multimap::swap](../standard-library/unordered-multimap-class.md#unordered_multimap__swap)`(right)`.  
