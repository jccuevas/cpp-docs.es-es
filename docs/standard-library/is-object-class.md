...
Una instancia del predicado de tipo contiene false si el tipo *Ty* es un tipo de referencia, un tipo de función o un valor `cv-qualified` nulo, o un formulario de uno de ellos; de lo contrario, es true.
