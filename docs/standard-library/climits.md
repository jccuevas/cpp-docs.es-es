...
ms.locfileid: "68244802"
---
# <a name="ltclimitsgt"></a>&lt;climits&gt;

Incluye el encabezado de la biblioteca estándar de C \<limits.h > y agrega los nombres asociados a la `std` espacio de nombres. Incluir este encabezado también garantiza que los nombres declarados mediante vinculación externa en el encabezado de la biblioteca estándar de C se declaran en el `std` espacio de nombres.
