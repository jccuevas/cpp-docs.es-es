...
## <a name="remarks"></a>Comentarios  
 Los objetos de tipo `char *` pueden usar la funcionalidad de [\<strstream>](../standard-library/strstream.md) para streaming. Pero `<strstream>` está en desuso y se recomienda usar `<sstream>`.  
