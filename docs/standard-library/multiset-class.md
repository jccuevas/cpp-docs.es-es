...
Si el valor devuelto `find` de se asigna a `const_iterator`un, el objeto MultiSet no se puede modificar. Si el valor devuelto `find` de se asigna a `iterator`un, el objeto MultiSet se puede modificar.
