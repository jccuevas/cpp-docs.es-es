---
title: Clase de contenedor::size | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
ms.locfileid: "33842461"
---
# <a name="container-classsize"></a>Clase de contenedor::size
...
Devuelve la longitud de la secuencia controlada, en tiempo constante independientemente de la longitud de la secuencia controlada.
