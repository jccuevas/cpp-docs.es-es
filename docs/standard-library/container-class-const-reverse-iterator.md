...
Aquí se describe como sinónimo del tipo sin especificar **T8** (normalmente, [reverse_iterator](../standard-library/container-class-reverse-iterator.md) <[const_iterator](../standard-library/container-class-const-iterator.md)`>`).
