...
ms.locfileid: "68458303"
---
# <a name="randomaccessiteratortag-struct"></a>random_access_iterator_tag (Struct)

Una clase que proporciona un tipo de valor `iterator_category` devuelto para la función que representa un iterador de acceso aleatorio.
...
El tipo es el mismo que  \< el iterador **ITER**>  **:: iterator_category** cuando `Iter` describe un objeto que puede actuar como un iterador de acceso aleatorio.
