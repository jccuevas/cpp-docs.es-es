...
ms.locfileid: "38957378"
---
# <a name="randomaccessiteratortag-struct"></a>random_access_iterator_tag (Struct)

Una clase que proporciona un tipo de valor devuelto para `iterator_category` función que representa un iterador de acceso aleatorio.
...
El tipo es igual a **iterador** \< **Iter**> **:: iterator_category** cuando `Iter` describe un objeto que puede actuar como un iterador de acceso aleatorio.
