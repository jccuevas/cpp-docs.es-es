...
**false** si no se ha asignado ningún objeto de caché para este objeto o para *otros* en el subproceso actual. De lo contrario, devuelve el resultado de aplicar `operator==` a los dos objetos de caché.
