...
`Key` El tipo de datos de la clave que se almacenará en la asignación múltiple.

`Type` El tipo de datos de elemento que se almacenará en la asignación múltiple.
...
`key` La clave de los elementos que deben coincidir la asignación múltiple.
...
`key` Clave de argumento que se va a comparar con el criterio de ordenación de un elemento de la asignación múltiple que se va a buscar.
...
`Key` La clave de los elementos que se va a quitar.
...
`key` El valor de clave que debe coincidir el criterio de ordenación de un elemento de la asignación múltiple que se va a buscar.
