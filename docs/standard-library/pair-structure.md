...
## Valor devuelto  
 El primer constructor \(predeterminado\) inicializa el primer elemento del par en el valor predeterminado del tipo **T1** y el segundo elemento del par en el valor predeterminado del tipo **T2**.  
...
## Vea también  
 [Operador lógico pair](../misc/pair-logical-operator.md)   
