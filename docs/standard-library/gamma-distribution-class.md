---
title: gamma_distribution (Clase) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
Para obtener más información sobre la distribución gamma, vea el artículo de Wolfram MathWorld sobre la [distribución gamma](http://go.microsoft.com/fwlink/p/?linkid=401111).
...
*alfa* el `alpha` parámetro de distribución.
...
El primer constructor crea un objeto cuyo valor `alpha` almacenado contiene el valor *alpha* y cuyo valor `beta` almacenado contiene el valor *beta*.
