...
Crea una tupla de referencias a los argumentos en *t* adecuado para el reenvío como argumentos a una función.
...
Un objeto de tupla que se construye mediante la inicialización de cada elemento de tipo.
