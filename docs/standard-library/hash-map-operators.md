...
*izquierdo* un objeto de tipo `hash_map`.

*derecha* un objeto de tipo `hash_map`.
...
*izquierdo* un objeto de tipo `hash_multimap`.

*derecha* un objeto de tipo `hash_multimap`.
