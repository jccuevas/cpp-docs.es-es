---
title: Clase de contenedor::size_type | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
...
---
# <a name="container-classsizetype"></a>Clase de contenedor::size_type
...
Describe un objeto que puede representar la longitud de cualquier secuencia controlada.
...
Aquí se describe como sinónimo del tipo sin especificar **T0** (normalmente, **Alloc::size_type**).
