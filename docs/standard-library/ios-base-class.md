...
Un objeto de la clase ios_base también almacena información de estado de la secuencia, en un objeto de tipo [`iostate`](#iostate)y una pila de devolución de llamada.
