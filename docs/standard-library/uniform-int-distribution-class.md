...
## Salida  
  **Utilice CTRL\-Z para omitir la entrada de datos y ejecutarlo con los valores predeterminados.  Introduzca un valor entero para el límite inferior de la distribución: 0**  
