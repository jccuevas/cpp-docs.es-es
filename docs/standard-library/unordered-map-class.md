...
`operator[]` puede utilizarse para insertar elementos en un mapa *m* mediante *m*[*clave*] = `DataValue`; donde `DataValue` es el valor de la `mapped_type` del elemento con una clave valor de *clave*.
