...
*_LenArray* una matriz que especifica el número de elementos de cada segmento.

*_IncArray* una matriz que especifica el intervalo de cada segmento.
