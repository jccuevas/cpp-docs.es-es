...
|`weibull_distribution::operator()`|`weibull_distribution::b`|[weibull\_distribution::param\_type](../Topic/weibull_distribution::param_type.md)|  
 ...
 Para más detalles sobre el algoritmo de distribución F, vea el artículo de Wolfram MathWorld sobre la [distribución de Weibull](http://go.microsoft.com/fwlink/?LinkId=401115).  
