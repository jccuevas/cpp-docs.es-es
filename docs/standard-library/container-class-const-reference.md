...
ms.workload:
- cplusplus
ms.openlocfilehash: 11d9b56c18e383d1a9aa0d79040274aeab8a70f7
...
Aquí se describe como sinónimo del tipo sin especificar **T3** (normalmente, **Alloc::const_reference**).
