---
title: lognormal_distribution (Clase)
ms.date: 11/04/2016
f1_keywords:
...
La plantilla de clase describe una distribución que produce valores de un tipo entero especificado por el usuario, o tipo **double** si no se proporciona ninguno, distribuido según la distribución normal de registro. La tabla siguiente incluye vínculos a artículos sobre miembros individuales.
...
Para obtener más información sobre la distribución LogNormal, vea el artículo de Wolfram MathWorld sobre la [distribución LogNormal](https://go.microsoft.com/fwlink/p/?linkid=400917).
