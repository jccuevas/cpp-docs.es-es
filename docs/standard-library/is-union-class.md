...
Una instancia del predicado de tipo contiene true si el tipo *Ty* es un tipo de Unión `cv-qualified` o un formulario de tipo de Unión; en caso contrario, contiene false.
