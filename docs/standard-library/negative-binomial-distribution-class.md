...
Para obtener información detallada acerca de la función de probabilidad discreta de distribución binomial negativa, consulte el artículo de Wolfram [Distribución Binomial negativa](https://go.microsoft.com/fwlink/p/?linkid=400516).
