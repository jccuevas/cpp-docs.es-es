...
**true** si [rdstate](#rdstate) `== goodbit` (no se establecen marcas de estado); en caso contrario, **false**.
...
*Default*\
**Carácter** que se desea que se devuelva si no se encuentra ningún equivalente.
