...
-  Si *recuento* < 1,  **n**  = 1 y como tal, equivale al constructor predeterminado, siempre genera cero.  
-  Si *recuento* > 0,  **n**   =  *recuento*. Proporciona **d.** = (*alta* - *baja*) /  **n**  es mayor que cero, mediante **d.** subintervalos uniformes, cada peso se asigna como sigue: `weight[k] = weightfunc(x)`, donde **x** = *baja* + **k**  *  **d.** + **d.** / 2, para **k** = 0,...,  **n**  - 1.  
