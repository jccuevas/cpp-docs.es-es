---
title: "Clase de contenedor::const_iterator | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# Clase de contenedor::const_iterator
...
>  Este tema está en la documentación de Visual C\+\+ como ejemplo no funcional de contenedores utilizados en la biblioteca estándar de C\+\+.  Para obtener más información, vea [Contenedores STL](../standard-library/stl-containers.md).  
 ...
 Describe un objeto que puede actuar como iterador constante para la secuencia controlada.  
...
## Comentarios  
 Se describe aquí como sinónimo del tipo sin especificar **T6**.  
