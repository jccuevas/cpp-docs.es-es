...
|||  
|-|-|  
|[bitset](#bitset__bitset)|Construye un objeto de clase `bitset\<N>` e inicializa los bits a cero, hasta un valor especificado o hasta los valores obtenidos de los caracteres de una cadena.|  
  
### <a name="typedefs"></a>Definiciones de tipo  
  
|||  
|-|-|  
|[element_type](#bitset__element_type)|Tipo sinónimo del tipo de datos `bool` y que se puede usar para hacer referencia a los bits de elemento en un `bitset`.|  
  
### <a name="member-functions"></a>Funciones miembro  
  
|||  
|-|-|  
|[all](#bitset__all)|Comprueba todos los bits de este `bitset` para determinar si están establecidos en `true`.|  
|[any](#bitset__any)|Función miembro que comprueba si cualquiera de los bits de la secuencia está establecido en 1.|  
|[count](#bitset__count)|Función miembro que devuelve el número de bits establecidos en la secuencia de bits.|  
|[flip](#bitset__flip)|Invierte el valor de todos los bits de un `bitset` o de un solo bit en una posición especificada.|  
|[none](#bitset__none)|Comprueba si no se ha establecido ningún bit en 1 en un objeto `bitset`.|  
|[reset](#bitset__reset)|Restablece todos los bits en un `bitset` en 0 o restablece un bit en una posición especificada en 0.|  
|[set](#bitset__set)|Establece todos los bits en un `bitset` en 1 o establece un bit en una posición especificada en 1.|  
|[size](#bitset__size)|Devuelve el número de bits de un objeto `bitset`.|  
|[test](#bitset__test)|Comprueba si el bit de una posición especificada en un `bitset` está establecido en 1.|  
|[to_string](#bitset__to_string)|Convierte un objeto `bitset` en una representación de cadena.|  
|[to_ullong](#bitset__to_ullong)|Devuelve la suma de los valores de bits en el `bitset` como un `unsigned long long`.|  
|[to_ulong](#bitset__to_ulong)|Convierte un objeto `bitset` en el `unsigned long` que generaría la secuencia de bits contenida si se usase para inicializar el `bitset`.|  
  
### <a name="member-classes"></a>Clases de miembro  
  
|||  
|-|-|  
|[reference](#bitset__reference)|Clase de proxy que proporciona referencias a los bits que contiene un `bitset` y que se usa para acceder y manipular los bits individuales como una clase auxiliar para el `operator[]` de clase `bitset`.|  
  
### <a name="operators"></a>Operadores  
  
|||  
|-|-|  
|[operator!=](#bitset__operator_neq)|Comprueba si hay desigualdad entre un `bitset` de destino y un `bitset` especificado.|  
|[operator&=](#bitset__operator_and_eq)|Realiza una combinación bit a bit de los conjuntos de bits con la operación `AND` lógica.|  
|[operator<<](#bitset__operator_lshift)|Desplaza los bits de un `bitset` a la izquierda un número especificado de posiciones y devuelve el resultado a un nuevo `bitset`.|  
|[operator<<=](#bitset__operator_lshift_eq)|Desplaza los bits de un `bitset` a la izquierda un número especificado de posiciones y devuelve el resultado al `bitset` de destino.|  
|[operator==](#bitset__operator_eq_eq)|Comprueba si hay igualdad entre un `bitset` de destino y un `bitset` especificado.|  
|[operator>>](#bitset__operator_rshift)|Desplaza los bits de un `bitset` a la derecha un número especificado de posiciones y devuelve el resultado a un nuevo `bitset`.|  
|[operator>>=](#bitset__operator_rshift_eq)|Desplaza los bits de un `bitset` a la derecha un número especificado de posiciones y devuelve el resultado al `bitset` de destino.|  
|[operator&#91;&#93;](#bitset__operator_at)|Devuelve una referencia a un bit en una posición especificada en un `bitset` si el `bitset` es modificable; en caso contrario, devuelve el valor del bit en esa posición.|  
|[operator^=](#bitset__operator_xor_eq)|Realiza una combinación bit a bit de los conjuntos de bits con la operación `OR` exclusiva.|  
|[operator&#124;=](#bitset__operator_or_eq')|Realiza una combinación bit a bit de los conjuntos de bits con la operación `OR` inclusiva.|  
|[operator~](#bitset__operator_dtor)|Invierte todos los bits en un `bitset` de destino y devuelve el resultado.|  
...
### <a name="remarks"></a>Comentarios  
 La función de operador miembro devuelve **bitset**( **\*this**) **<<= pos,** donde [<<=](#bitset__operator_lshift_eq) desplaza los bits de un conjunto de bits a la izquierda un número especificado de posiciones y devuelve el resultado al conjunto de bits de destino.  
