...
La primera función de plantilla devuelve [is_sorted_until](https://msdn.microsoft.com/bbad99d0-deaa-4fe6-ae58-eb5b3e4dded0)`( first, last ) == last`. El `operator<` función realiza la comparación de orden.
