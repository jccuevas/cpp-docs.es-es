...
|[unordered_set::allocator_type](#unordered_set__allocator_type)|El tipo de un asignador para administrar el almacenamiento.|  
|[unordered_set::const_iterator](#unordered_set__const_iterator)|El tipo de un iterador constante para la secuencia controlada.|  
|[unordered_set::const_local_iterator](#unordered_set__const_local_iterator)|El tipo de un iterador de depósito constante para la secuencia controlada.|  
|[unordered_set::const_pointer](#unordered_set__const_pointer)|El tipo de un puntero constante a un elemento.|  
|[unordered_set::const_reference](#unordered_set__const_reference)|El tipo de una referencia constante a un elemento.|  
|[unordered_set::difference_type](#unordered_set__difference_type)|El tipo de una distancia con signo entre dos elementos.|  
|[unordered_set::hasher](#unordered_set__hasher)|El tipo de la función hash.|  
|[unordered_set::iterator](#unordered_set__iterator)|El tipo de un iterador para la secuencia controlada.|  
|[unordered_set::key_equal](#unordered_set__key_equal)|El tipo de la función de comparación.|  
|[unordered_set::key_type](#unordered_set__key_type)|El tipo de una clave de ordenación.|  
|[unordered_set::local_iterator](#unordered_set__local_iterator)|El tipo de un iterador de depósito para la secuencia controlada.|  
|[unordered_set::pointer](#unordered_set__pointer)|El tipo de un puntero a un elemento.|  
|[unordered_set::reference](#unordered_set__reference)|El tipo de una referencia a un elemento.|  
|[unordered_set::size_type](#unordered_set__size_type)|El tipo de una distancia sin signo entre dos elementos.|  
|[unordered_set::value_type](#unordered_set__value_type)|El tipo de un elemento.|  
  
|||  
|-|-|  
|Función miembro|Descripción|  
|[unordered_set::begin](#unordered_set__begin)|Designa el principio de la secuencia controlada.|  
|[unordered_set::bucket](#unordered_set__bucket)|Obtiene el número de depósito para un valor de clave.|  
|[unordered_set::bucket_count](#unordered_set__bucket_count)|Obtiene el número de depósitos.|  
|[unordered_set::bucket_size](#unordered_set__bucket_size)|Obtiene el tamaño de un depósito.|  
|[unordered_set::cbegin](#unordered_set__cbegin)|Designa el principio de la secuencia controlada.|  
|[unordered_set::cend](#unordered_set__cend)|Designa el final de la secuencia controlada.|  
|[unordered_set::clear](#unordered_set__clear)|Quita todos los elementos.|  
|[unordered_set::count](#unordered_set__count)|Busca el número de elementos que coinciden con una clave especificada.|  
|[unordered_set::emplace](#unordered_set__emplace)|Agrega un elemento construido en contexto.|  
|[unordered_set::emplace_hint](#unordered_set__emplace_hint)|Agrega un elemento construido en contexto, con sugerencia.|  
|[unordered_set::empty](#unordered_set__empty)|Comprueba si no hay ningún elemento presente.|  
|[unordered_set::end](#unordered_set__end)|Designa el final de la secuencia controlada.|  
|[unordered_set::equal_range](#unordered_set__equal_range)|Busca el intervalo que coincide con una clave especificada.|  
|[unordered_set::erase](#unordered_set__erase)|Quita los elementos de las posiciones especificadas.|  
|[unordered_set::find](#unordered_set__find)|Busca un elemento que coincide con una clave especificada.|  
|[unordered_set::get_allocator](#unordered_set__get_allocator)|Obtiene el objeto de asignador almacenado.|  
|[unordered_set::hash_function](#unordered_set__hash_function)|Obtiene el objeto de función hash almacenado.|  
|[unordered_set::insert](#unordered_set__insert)|Agrega elementos.|  
|[unordered_set::key_eq](#unordered_set__key_eq)|Obtiene el objeto de función de comparación almacenado.|  
|[unordered_set::load_factor](#unordered_set__load_factor)|Cuenta los elementos promedio por depósito.|  
|[unordered_set::max_bucket_count](#unordered_set__max_bucket_count)|Obtiene el número máximo de depósitos.|  
|[unordered_set::max_load_factor](#unordered_set__max_load_factor)|Obtiene o establece los elementos máximos por depósito.|  
|[unordered_set::max_size](#unordered_set__max_size)|Obtiene el tamaño máximo de la secuencia controlada.|  
|[unordered_set::rehash](#unordered_set__rehash)|Recompila la tabla hash.|  
|[unordered_set::size](#unordered_set__size)|Cuenta el número de elementos.|  
|[unordered_set::swap](#unordered_set__swap)|Intercambia el contenido de dos contenedores.|  
|[unordered_set::unordered_set](#unordered_set__unordered_set)|Construye un objeto contenedor.|  
  
|||  
|-|-|  
|Operadores|Descripción|  
|[unordered_set::operator=](#unordered_set__operator_eq)|Copia una tabla hash.|  
  
## <a name="remarks"></a>Comentarios  
 El objeto ordena la secuencia que controla llamando a dos objetos almacenados, un objeto de función de comparación de tipo [unordered_set::key_equal](#unordered_set__key_equal) y un objeto de función hash de tipo [unordered_set::hasher](#unordered_set__hasher). Se tiene acceso al primer objeto almacenado llamando a la función miembro [unordered_set::key_eq](#unordered_set__key_eq)`()` y se tiene acceso al segundo objeto almacenado llamando a la función miembro [unordered_set::hash_function](#unordered_set__hash_function)`()`. Concretamente, para todos los valores `X` e `Y` de tipo `Key`, la llamada a `key_eq()(X, Y)` solo devuelve true si los dos valores de argumento tienen una ordenación equivalente. La llamada a `hash_function()(keyval)` produce una distribución de valores de tipo `size_t`. A diferencia de la clase de plantilla [unordered_multiset](../standard-library/unordered-multiset-class.md), un objeto de clase de plantilla `unordered_set` garantiza que `key_eq()(X, Y)` es siempre false para cualquiera de los dos elementos de la secuencia controlada. (Las claves son únicas).  
 ...
 El objeto asigna y libera almacenamiento para la secuencia que controla a través de un objeto asignador almacenado de tipo [unordered_set::allocator_type](#unordered_set__allocator_type). Ese objeto de asignador debe tener la misma interfaz externa que un objeto de clase de plantilla `allocator`. Tenga en cuenta que el objeto de asignador almacenado no se copia cuando se asigna el objeto contenedor.  
...
##  <a name="a-nameunorderedsetcbegina--unorderedsetcbegin"></a><a name="unordered_set__cbegin"></a>  unordered_set::cbegin  
 Devuelve un iterador `const` que se dirige al primer elemento del intervalo.  
...
### <a name="return-value"></a>Valor devuelto  
 Un iterador `const` de acceso hacia delante que apunta al primer elemento del intervalo o la ubicación situada más allá del final de un intervalo vacío (para un intervalo vacío, `cbegin() == cend()`).  
...
##  <a name="a-nameunorderedsetcenda--unorderedsetcend"></a><a name="unordered_set__cend"></a>  unordered_set::cend  
 Devuelve un iterador `const` que se dirige a la ubicación situada más allá del último elemento de un intervalo.  
...
### <a name="remarks"></a>Comentarios  
 La función miembro llama a [unordered_set::erase](#unordered_set__erase)`(` [unordered_set::begin](#unordered_set__begin)`(),` [unordered_set::end](#unordered_set__end)`())`.  
...
### <a name="remarks"></a>Comentarios  
 La función miembro devuelve el número de elementos incluidos en el rango delimitado por [unordered_set::equal_range](#unordered_set__equal_range)`(keyval)`.  
...
### <a name="return-value"></a>Valor devuelto  
 Un `pair` cuyo componente `bool` devuelve true si se realizó una inserción y false si el `unordered_set` ya contenía un elemento cuya clave tenía un valor equivalente en la ordenación, y cuyo componente de iterador devuelve la dirección donde se insertó un nuevo elemento o donde ya estaba el elemento.  
  
 Para tener acceso al componente de iterador de un par `pr` devuelto por esta función miembro, use `pr.first` y, para desreferenciarlo, use `*(pr.first)`. Para tener acceso al componente `bool` de un par `pr` devuelto por esta función miembro, use `pr.second`.  
...
### <a name="remarks"></a>Comentarios  
 ...
 Para obtener un ejemplo de código, vea [set::emplace](../standard-library/set-class.md#set__emplace).  
...
### <a name="remarks"></a>Comentarios  
 La función miembro devuelve [unordered_set::equal_range](#unordered_set__equal_range)`(keyval).first`.  
...
|`ValTy`|Parámetro de plantilla que especifica el tipo de argumento que unordered_set puede usar para construir un elemento de [value_type](../standard-library/map-class.md#map__value_type) y realiza un reenvío directo de `Val` como argumento.|  
...
### <a name="remarks"></a>Comentarios  
 ...
 Para tener acceso al componente de iterador de un `pair``pr` devuelto por la función miembro de un único elemento, use `pr.first`. Para desreferenciar el iterador dentro del par devuelto, use `*pr.first`, lo que devuelve un elemento. Para tener acceso al componente `bool`, use `pr.second`. Para obtener un ejemplo, vea el código de ejemplo que se muestra más adelante en este artículo.  
  
 El objeto [value_type](../standard-library/map-class.md#map__value_type) de un contenedor es una definición de tipo que pertenece al contenedor y, para un conjunto, `unordered_set<V>::value_type` es del tipo `const V`.  
  
 La función miembro de intervalo (5) inserta la secuencia de valores de elemento en un unordered_set que corresponde a cada elemento direccionado por un iterador en el intervalo `[First, Last)`. Por tanto, `Last` no se inserta. La función miembro de contenedor `end()` hace referencia a la posición situada justo después del último elemento del contenedor. Por ejemplo, la instrucción `s.insert(v.begin(), v.end());` intenta insertar todos los elementos de `v` en `s`. Solo se insertan los elementos que tienen valores únicos en el intervalo; se omiten los duplicados. Para observar qué elementos se rechazan, use las versiones de un solo elemento de `insert`.  
 ...
 Para la inserción de un elemento construido en contexto (es decir, no se realiza ninguna operación de copia o movimiento), vea [set::emplace](../standard-library/set-class.md#set__emplace) y [set::emplace_hint](../standard-library/set-class.md#set__emplace_hint).  
  
 Para obtener un ejemplo de código, vea [set::insert](../standard-library/set-class.md#set__insert).  
...
### <a name="example"></a>Ejemplo  
  Vea el ejemplo de [begin](../standard-library/set-class.md#set__begin) para obtener un ejemplo de cómo declarar y usar un **iterador**.  
...
### <a name="remarks"></a>Comentarios  
 La función miembro devuelve `(float)`[unordered_set::size](#unordered_set__size)`() / (float)`[unordered_set::bucket_count](#unordered_set__bucket_count)`()`, el promedio de elementos por depósito.  
...
|-|-|  
|Parámetro|Descripción|  
|` right`|El [unordered_set](../standard-library/unordered-set-class.md) que se copia en el `unordered_set`.|  
