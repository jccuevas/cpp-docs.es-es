...
Una instancia del predicado de tipo contiene true si el tipo *Ty* es un tipo aritmético, es decir, un tipo entero o un tipo de punto flotante, `cv-qualified` o un formulario de uno de ellos; en caso contrario, contiene false.
