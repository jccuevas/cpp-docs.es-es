...
## Comentarios  
 La clase de plantilla describe una distribución que genera valores de un tipo integral especificado por el usuario \(o de tipo `double` si no se especifica ninguno\) distribuidos según la distribución de Cauchy.  En la siguiente tabla encontrará vínculos que llevan a artículos sobre miembros individuales.  
...
|`cauchy_distribution::operator()`|`cauchy_distribution::b`|[cauchy\_distribution::param\_type](../Topic/cauchy_distribution::param_type.md)|  
 ...
 Las funciones de propiedad `a()` y `b()` devuelven sus respectivos valores para los parámetros de distribución almacenados `a` y `b`.  
 ...
 Para más información relativa a la distribución de Cauchy, vea el artículo de Wolfram MathWorld sobre la [distribución de Cauchy](http://go.microsoft.com/fwlink/?LinkId=400523).  
