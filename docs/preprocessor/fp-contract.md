...
## <a name="example"></a>Ejemplo  
 El código generado a partir de este ejemplo no utiliza la multiplicación y suma fusionada (**fma**) instrucción en procesadores Itanium. Si marca como comentario `#pragma fp_contract (off)`, el código generado utilizará la **fma** instrucción.  
