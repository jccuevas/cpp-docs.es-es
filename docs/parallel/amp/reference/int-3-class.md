...
ms.locfileid: "77127821"
---
# <a name="int_3-class"></a>int_3 (Clase)
...
|Nombre|Descripción|
|----------|-----------------|
|[Constructor de int_3](#ctor)|Sobrecargado. El constructor predeterminado, inicializa todos los elementos con 0.|
