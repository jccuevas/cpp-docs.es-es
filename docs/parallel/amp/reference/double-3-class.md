...
ms.locfileid: "77126700"
---
# <a name="double_3-class"></a>double_3 (Clase)
...
|Nombre|Descripción|
|----------|-----------------|
|[Constructor de double_3](#ctor)|Sobrecargado. El constructor predeterminado, inicializa todos los elementos con 0.|
...
## <a name="double_3__size"></a>ajusta
