...
Devuelve el valor del objeto de índice.
...
### <a name="parameters"></a>Parámetros
Un entero comprendido entre 0 y el rango menos 1 _index.
...
``` 
### <a name="parameters"></a>Parámetros
_Otro para copiar desde el objeto de índice.
