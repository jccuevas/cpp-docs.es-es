---
title: "float_3 (Clase) | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
|Name|Descripción|  
|----------|-----------------|  
|[float\_3::float\_3 \(Constructor\)](../Topic/float_3::float_3%20Constructor.md)|Sobrecargado.  El constructor predeterminado, inicializa todos los elementos con 0.|  
  
### Métodos públicos  
  
|Name|Descripción|  
|----------|-----------------|  
|Método float\_3::get\_x||  
|Método float\_3::get\_xy||  
|Método float\_3::get\_xyz||  
|Método float\_3::get\_xz||  
|Método float\_3::get\_xzy||  
|Método float\_3::get\_y||  
|Método float\_3::get\_yx||  
|Método float\_3::get\_yxz||  
|Método float\_3::get\_yz||  
|Método float\_3::get\_yzx||  
|Método float\_3::get\_z||  
|Método float\_3::get\_zx||  
|Método float\_3::get\_zxy||  
|Método float\_3::get\_zy||  
|Método float\_3::get\_zyx||  
|Método float\_3::ref\_b||  
|Método float\_3::ref\_g||  
|Método float\_3::ref\_r||  
|Método float\_3::ref\_x||  
|Método float\_3::ref\_y||  
|Método float\_3::ref\_z||  
|Método float\_3::set\_x||  
|Método float\_3::set\_xy||  
|Método float\_3::set\_xyz||  
|Método float\_3::set\_xz||  
|Método float\_3::set\_xzy||  
|Método float\_3::set\_y||  
|Método float\_3::set\_yx||  
|Método float\_3::set\_yxz||  
|Método float\_3::set\_yz||  
|Método float\_3::set\_yzx||  
|Método float\_3::set\_z||  
|Método float\_3::set\_zx||  
|Método float\_3::set\_zxy||  
|Método float\_3::set\_zy||  
|Método float\_3::set\_zyx||  
  
### Operadores públicos  
  
|Name|Descripción|  
|----------|-----------------|  
|Operador float\_3::operator\-||  
|Operador float\_3::operator\-\-||  
|Operador float\_3::operator\*\=||  
|Operador float\_3::operator\/\=||  
|Operador float\_3::operator\+\+||  
...
|Name|Descripción|  
|----------|-----------------|  
|Miembro de datos float\_3::b||  
|Miembro de datos float\_3::bg||  
|Miembro de datos float\_3::bgr||  
|Miembro de datos float\_3::br||  
|Miembro de datos float\_3::brg||  
|Miembro de datos float\_3::g||  
|Miembro de datos float\_3::gb||  
|Miembro de datos float\_3::gbr||  
|Miembro de datos float\_3::gr||  
|Miembro de datos float\_3::grb||  
|Miembro de datos float\_3::r||  
|Miembro de datos float\_3::rb||  
|Miembro de datos float\_3::rbg||  
|Miembro de datos float\_3::rg||  
|Miembro de datos float\_3::rgb||  
|Miembro de datos float\_3::x||  
|Miembro de datos float\_3::xy||  
|Miembro de datos float\_3::xyz||  
|Miembro de datos float\_3::xz||  
|Miembro de datos float\_3::xzy||  
|Miembro de datos float\_3::y||  
|Miembro de datos float\_3::yx||  
|Miembro de datos float\_3::yxz||  
|Miembro de datos float\_3::yz||  
|Miembro de datos float\_3::yzx||  
|Miembro de datos float\_3::z||  
|Miembro de datos float\_3::zx||  
|Miembro de datos float\_3::zxy||  
|Miembro de datos float\_3::zy||  
|Miembro de datos float\_3::zyx||  
