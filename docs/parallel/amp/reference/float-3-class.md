...
|Name|Descripción|
|----------|-----------------|
|[float_3 Constructor](#ctor)|Sobrecargado. El constructor predeterminado, inicializa todos los elementos con 0.|
...
|Name|Descripción|
|----------|-----------------|
|[cambio de tamaño constante](#float_3__size)||
