---
title: double_4 (clase) | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|Nombre|Descripción|  
|----------|-----------------|  
|[Constructor double_4](#ctor)|Sobrecargado. El constructor predeterminado, inicializa todos los elementos con 0.|  
...
|Nombre|Descripción|  
|----------|-----------------|  
|[tamaño (constante)](#double_4__size)||  
