...
|[Uso de C++ AMP en aplicaciones de UWP](../../parallel/amp/using-cpp-amp-in-windows-store-apps.md)|Describe cómo usar C++ AMP en aplicaciones de plataforma Universal de Windows (UWP) que utilizan los tipos en tiempo de ejecución de Windows.|  
