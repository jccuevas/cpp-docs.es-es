...
ms.locfileid: "76821849"
---
# <a name="concurrency-namespace"></a>concurrency (Espacio de nombres)

El espacio de nombres `Concurrency` proporciona las clases y funciones que dan acceso al Runtime de simultaneidad, un marco de programación simultáneo para C++. Para obtener más información, consulta [Concurrency Runtime](../../../parallel/concrt/concurrency-runtime.md).
