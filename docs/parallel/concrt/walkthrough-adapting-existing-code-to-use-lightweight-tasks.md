...
4.  Modificar el `MyData` estructura para incluir un [Concurrency:: Event](../../parallel/concrt/reference/event-class.md) objeto que señala a la aplicación principal que la tarea ha finalizado.  
