...
|[Tutorial: Conectar mediante tareas y solicitudes HTTP XML](../../parallel/concrt/walkthrough-connecting-using-tasks-and-xml-http-requests.md)|Muestra cómo combinar tareas de PPL con las interfaces `IXMLHTTPRequest2` y `IXMLHTTPRequest2Callback` para enviar solicitudes HTTP GET y POST a un servicio Web en una aplicación de UWP.|
