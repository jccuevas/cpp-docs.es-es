---
title: 'Tutorial: Crear una red de procesamiento de imágenes | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-concrt
...
2.  Para cualquier imagen que tiene rojo como color dominante, quite los componentes verdes y azules y, a continuación, oscurecerlo.  
...
2.  En el `ProcessImages` función, cree un `countdown_event` variable. La `countdown_event` clase se muestra más adelante en este tutorial.  
  
     [!code-cpp[concrt-image-processing-filter#8](../../parallel/concrt/codesnippet/cpp/walkthrough-creating-an-image-processing-network_7.cpp)]  
  
3.  Crear un [std:: Map](../../standard-library/map-class.md) objeto que se asocia un `Bitmap` objeto con el nombre de archivo original.  
...
6.  Agregue el código siguiente para enviar la ruta de acceso completa de cada archivo JPEG en el encabezado de la red en el directorio.  
