---
title: Contenido | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-parallel
...
[1. Introducción](../../parallel/openmp/1-introduction.md)  
 ...
 [A.1 ejecuta un bucle Simple en paralelo](../../parallel/openmp/a-1-executing-a-simple-loop-in-parallel.md)  
  
 [A.2 Especificación de compilación condicional](../../parallel/openmp/a-2-specifying-conditional-compilation.md)  
  
 [A.3 con regiones en paralelo](../../parallel/openmp/a-3-using-parallel-regions.md)  
  
 [A.4 mediante la cláusula nowait](../../parallel/openmp/a-4-using-the-nowait-clause.md)  
  
 [A.5 mediante la directiva crítica](../../parallel/openmp/a-5-using-the-critical-directive.md)  
  
 [A.6 mediante la cláusula lastprivate](../../parallel/openmp/a-6-using-the-lastprivate-clause.md)  
  
 [A.7 mediante la cláusula de reducción](../../parallel/openmp/a-7-using-the-reduction-clause.md)  
  
 [A.8 especificar secciones paralelas](../../parallel/openmp/a-8-specifying-parallel-sections.md)  
  
 [A.9 Using Directives únicos](../../parallel/openmp/a-9-using-single-directives.md)  
  
 [Especificar el orden secuencial de A.10](../../parallel/openmp/a-10-specifying-sequential-ordering.md)  
  
 [A.11 especificando un número fijo de subprocesos](../../parallel/openmp/a-11-specifying-a-fixed-number-of-threads.md)  
  
 [A.12 mediante la directiva atómica](../../parallel/openmp/a-12-using-the-atomic-directive.md)  
  
 [A.13 mediante la directiva de vaciado con una lista](../../parallel/openmp/a-13-using-the-flush-directive-with-a-list.md)  
  
 [A.14 mediante la directiva de vaciado sin una lista](../../parallel/openmp/a-14-using-the-flush-directive-without-a-list.md)  
 ...
 [Bloquea A.17 mediante anidable](../../parallel/openmp/a-17-using-nestable-locks.md)  
  
 [A.18 anidados para directivas](../../parallel/openmp/a-18-nested-for-directives.md)  
  
 [Ejemplos A.19 que muestran el anidamiento incorrecto de directivas de uso compartido](../../parallel/openmp/a-19-examples-showing-incorrect-nesting-of-work-sharing-directives.md)  
  
 [Enlace de A.20 de directivas de barrera](../../parallel/openmp/a-20-binding-of-barrier-directives.md)  
  
 [Variables de ámbito de A.21 con la cláusula privada](../../parallel/openmp/a-21-scoping-variables-with-the-private-clause.md)  
  
 [A.22 mediante la cláusula default (None)](../../parallel/openmp/a-22-using-the-default-none-clause.md)  
  
 [Ejemplos A.23 de la directiva ordenada](../../parallel/openmp/a-23-examples-of-the-ordered-directive.md)  
  
 [En el ejemplo de la cláusula privada se A.24](../../parallel/openmp/a-24-example-of-the-private-clause.md)  
  
 [Ejemplos A.25 de la cláusula de atributo de datos copyprivate](../../parallel/openmp/a-25-examples-of-the-copyprivate-data-attribute-clause.md)  
  
 [A.26 mediante el threadprivate (directiva)](../../parallel/openmp/a-26-using-the-threadprivate-directive.md)  
  
 [Uso A.27 de matrices de longitud Variable de C99](../../parallel/openmp/a-27-use-of-c99-variable-length-arrays.md)  
  
 [Uso A.28 de num_threads cláusula](../../parallel/openmp/a-28-use-of-num-threads-clause.md)  
  
 [A.29 para compartir el uso de trabajo construye dentro de una critical (construcción)](../../parallel/openmp/a-29-use-of-work-sharing-constructs-inside-a-critical-construct.md)  
