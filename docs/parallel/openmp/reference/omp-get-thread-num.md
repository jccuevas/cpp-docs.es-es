---
title: omp_get_thread_num () | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-parallel
...
## <a name="example"></a>Ejemplo  
 Vea [paralelo](../../../parallel/openmp/reference/parallel.md) para obtener un ejemplo del uso de `omp_get_thread_num`.  
