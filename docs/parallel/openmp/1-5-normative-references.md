---
title: 1.5 referencias de normativa | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
-   ISO/IEC 14882: 1998, *información tecnología - lenguajes de programación - C++*. Esta especificación de API de OpenMP se refiere a ISO/IEC 14882: 1998 como C++.  
 ...
 Cuando esta especificación OpenMP API hace referencia a C, se hace referencia al idioma base compatible con la implementación.