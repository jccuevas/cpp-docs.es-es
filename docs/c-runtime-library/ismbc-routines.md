...
|-------------|--------------------|---------------------------|
|[_ismbcalnum, _ismbcalnum_l](../c-runtime-library/reference/ismbcalnum-functions.md)|Alfanumérico|Devuelve cero si y solo si `c` es una representación de un solo byte de una letra inglesa ASCII. Vea los ejemplos de `_ismbcdigit` y `_ismbcalpha`.|
...
|[_ismbcdigit, _ismbcdigit_l](../c-runtime-library/reference/ismbcalnum-functions.md)|Dígito|Devuelve cero si y solo si `c` es una representación de un solo byte de un dígito ASCII: 0x30<=`c`<=0x39.|
...
|[_ismbclower, _ismbclower_l](../c-runtime-library/reference/ismbclower-ismbclower-l-ismbcupper-ismbcupper-l.md)|Alfabético en minúscula|Devuelve cero si y solo si `c` es una representación de un solo byte de una letra inglesa minúscula ASCII: 0x61<=`c`<=0x7A.|
|[_ismbcprint, _ismbcprint_l](../c-runtime-library/reference/ismbcgraph-functions.md)|Carácter imprimible|Devuelve cero si y solo si `c` es una representación de un solo byte de cualquier carácter imprimible ASCII o katakana, incluido un espacio en blanco ( ). Vea los ejemplos de `_ismbcspace`, `_ismbcdigit`, `_ismbcalpha` y `_ismbcpunct`.|
...
|[_ismbcupper, _ismbcupper_l](../c-runtime-library/reference/ismbclower-ismbclower-l-ismbcupper-ismbcupper-l.md)|Alfabético en mayúscula|Devuelve cero si y solo si `c` es una representación de un solo byte de una letra inglesa mayúscula ASCII: 0x41<=`c`<=0x5A.|
