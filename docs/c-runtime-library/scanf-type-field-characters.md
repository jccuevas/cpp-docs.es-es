---
title: scanf (Caracteres de campo de tipo)
ms.date: 11/04/2016
helpviewer_keywords:
...
|--------------------------|-----------------------|----------------------------------|
|un solo byte|`scanf` funciones|`c`, `hc` o `hC`|
|un solo byte|`wscanf` funciones|`C`, `hc` o `hC`|
|anchos|`wscanf` funciones|`c`, `lc` o `lC`|
|anchos|`scanf` funciones|`C`, `lc` o `lC`|
