...
---
# <a name="run-time-routines-by-category"></a>Rutinas en tiempo de ejecución por categoría
...
## <a name="routine-categories"></a>Categorías de rutinas
...
|[Control de errores](../c-runtime-library/error-handling-crt.md)|[Rutinas para el control de excepciones](../c-runtime-library/exception-handling-routines.md)|
