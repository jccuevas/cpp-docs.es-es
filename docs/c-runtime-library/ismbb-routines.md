---
title: "_ismbb (Rutinas) | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
Prueba si el valor entero `c` dado cumple una determinada condición, utilizando la configuración regional actual o una categoría de estado de conversión LC\_CTYPE especificada.  
...
|[\_ismbbalpha, \_ismbbalpha\_l](http://msdn.microsoft.com/es-es/8e54cb92-fc2b-41f5-8ab4-b22ac8aa9ad0)|[\_ismbbkpunct, \_ismbbkpunct\_l](../c-runtime-library/reference/ismbbkpunct-ismbbkpunct-l.md)|  
...
|[\_ismbbalpha](http://msdn.microsoft.com/es-es/8e54cb92-fc2b-41f5-8ab4-b22ac8aa9ad0)|`isalpha` &#124;&#124; `_ismbbkalnum`.|  
...
|`_ismbbpunct`|—|—|—|x|—|—|x|  
 ...
 Las rutinas de `_ismbb` se implementan como funciones y como macros. Para más información sobre cómo elegir una de las implementaciones, vea [Recomendaciones para elegir entre funciones y macros](../c-runtime-library/recommendations-for-choosing-between-functions-and-macros.md).  
