...
## Comentarios  
 Contexto: Funciones de conversión de multibyte\- y de caracteres anchos ANSI  
  
 El valor de `MB_CUR_MAX` es el número de bytes máximo en un carácter multibyte para la configuración regional actual.  
