...
Dado que C++ permite las sobrecargas, puede llamar a sobrecargas de **norma** que toman **_Fcomplex** o **_Lcomplex** valores y devuelven **float**o **long double** valores. En un programa C, **norma** siempre toma un **_Dcomplex** valor y devuelve un **doble** valor.
