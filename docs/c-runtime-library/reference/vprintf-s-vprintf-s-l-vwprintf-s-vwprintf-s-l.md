...
**vwprintf_s** es la versión con caracteres anchos de **vprintf_s**; las dos funciones se comportan exactamente igual si la secuencia se abre en modo ANSI. **vprintf_s** no admite actualmente la salida en un flujo Unicode.
