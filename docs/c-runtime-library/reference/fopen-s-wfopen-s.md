...
La función **fopen_s** abre el archivo especificado por *filename*. **_wfopen_s** es una versión con caracteres anchos de **fopen_s**; los argumentos de **_wfopen_s** son cadenas de caracteres anchos. **_wfopen_s** y **fopen_s** se comportan de manera idéntica.
...
En la tabla siguiente se resumen los modos de las distintas marcas de *CCS* que se asignan a **fopen_s** y para las marcas de orden de bytes en el archivo.
...
|*mode*|Access|
|-|-|
| **"r"** | Abre para lectura. Si el archivo no existe o no se encuentra, se produce un error en la llamada a **fopen_s** . |
...
|Caracteres en cadena de *modo*|Valor *Oflag* equivalente para _ Open/_sopen|
|-------------------------------|----------------------------------------------------|
...
Las opciones de *modo* **c**, **n**y **t** son extensiones de Microsoft para **fopen_s** y [_fdopen](fdopen-wfdopen.md) y no deben usarse si se desea la portabilidad ANSI.
