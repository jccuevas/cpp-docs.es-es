...
## Comentarios  
 ...
 `_ismbblead` usa la configuración regional actual para el comportamiento que dependa de la configuración regional.`_ismbblead_l` es exactamente igual, salvo que usa la configuración regional que se pasa. Para obtener más información, consulta [Configuración regional](../../c-runtime-library/locale.md).  
