...
Dado que C++ permite las sobrecargas, puede llamar a sobrecargas de **conj** que toman y devuelven **_Fcomplex** y **_Lcomplex** valores. En un programa C, **conj** siempre toma y devuelve un **_Dcomplex** valor.
