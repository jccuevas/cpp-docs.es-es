...
**_aligned_free** está `__declspec(noalias)`marcada, lo que significa que se garantiza que la función no modifique las variables globales. Para obtener más información, consulte [noalias](../../cpp/noalias.md).
