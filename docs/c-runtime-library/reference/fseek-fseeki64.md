...
En el caso de las secuencias abiertas en modo de texto, **fseek** y **_fseeki64** tienen un uso limitado, porque las traducciones de retorno de carro y avance de línea pueden hacer que **fseek** y **_fseeki64** produzcan resultados inesperados. Las únicas operaciones **fseek** y **_fseeki64** que se garantiza que funcionan en secuencias abiertas en modo de texto son:
