...
## <a name="remarks"></a>Comentarios  
 Puesto que C++ permite las sobrecargas, es posible llamar a las sobrecargas de `ccosh` que toman y devuelven los valores `_Fcomplex` y `_Lcomplex`. En un programa de C, `ccosh` siempre toma y devuelve un valor `_Dcomplex` .  
