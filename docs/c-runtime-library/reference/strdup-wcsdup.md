...
Estas funciones POSIX están obsoletas. En su lugar, use las funciones [_strdup, _wcsdup, _mbsdup](../../c-runtime-library/reference/strdup-wcsdup-mbsdup.md), compatibles con ISO C++.