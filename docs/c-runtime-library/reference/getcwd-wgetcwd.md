...
description: Las funciones de la biblioteca en tiempo de ejecución de C _getcwd, _wgetcwd obtener el directorio de trabajo actual.
ms.date: 4/2/2020
api_name:
- _wgetcwd
- _getcwd
