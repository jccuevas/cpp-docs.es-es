...
El **_fpreset** función reinicializa el paquete matemático de punto flotante. **_fpreset** normalmente se utiliza con **señal**, **system**, o la **_exec** o **_spawn** funciones. Si un programa intercepta señales de error de punto flotante (**SIGFPE**) con **señal**, se puede recuperar con seguridad de los errores de punto flotante mediante la invocación de **_fpreset** y el uso de **longjmp**.
