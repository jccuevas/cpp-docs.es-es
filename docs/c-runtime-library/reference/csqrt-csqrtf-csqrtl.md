...
Como C++ permite las sobrecargas, puede llamar a sobrecargas de **csqrt** que toman y devuelven **_Fcomplex** y **_Lcomplex** valores. En un programa C, **csqrt** siempre toma y devuelve un **_Dcomplex** valor.
