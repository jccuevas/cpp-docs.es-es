...
Esta función POSIX está desusada.  En su lugar, use la función [\_ungetch](../../c-runtime-library/reference/ungetch-ungetwch-ungetch-nolock-ungetwch-nolock.md) compatible con ISO C\+\+.  
