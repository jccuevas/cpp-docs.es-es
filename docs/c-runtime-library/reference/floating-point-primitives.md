...
Para obtener detalles adicionales, puede usar las funciones [_fpclass, _fpclassf](fpclass-fpclassf.md) específicas de Microsoft. Use la macro o la función [fpclassify (](fpclassify.md) para la portabilidad.
