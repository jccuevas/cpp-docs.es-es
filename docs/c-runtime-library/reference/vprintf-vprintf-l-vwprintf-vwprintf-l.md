...
**vwprintf** es la versión con caracteres anchos de **vprintf**; las dos funciones se comportan exactamente igual si el flujo se abre en modo ANSI. **vprintf** no admite actualmente la salida en un flujo UNICODE.
