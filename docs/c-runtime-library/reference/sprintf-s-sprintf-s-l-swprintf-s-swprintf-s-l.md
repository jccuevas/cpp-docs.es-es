...
El número de caracteres escritos, o -1 si se produjo un error. Si *búfer* o *formato* es un puntero nulo, **sprintf_s** y **swprintf_s** y devuelven -1 y establecen **errno**a **EINVAL**.
...
Hay versiones de **sprintf_s** que proporcionan un control adicional sobre lo que sucede si el búfer es demasiado pequeño. Para obtener más información, vea [_snprintf_s, _snprintf_s_l, _snwprintf_s, _snwprintf_s_l](snprintf-s-snprintf-s-l-snwprintf-s-snwprintf-s-l.md).
