...
Copia bytes entre búferes. Hay disponibles versiones más seguras de estas funciones; vea [memcpy_s, wmemcpy_s](../../c-runtime-library/reference/memcpy-s-wmemcpy-s.md).  
...
## <a name="example"></a>Ejemplo  
 Vea en [memmove`memcpy` un ejemplo de cómo usar ](../../c-runtime-library/reference/memmove-wmemmove.md).  
