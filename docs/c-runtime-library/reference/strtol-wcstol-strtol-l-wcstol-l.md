...
|`_tcstol_l`|`_strtol_l`|`_strtol_l`|`_wcstol_l`|  
 ...
 El valor de la categoría `LC_NUMERIC`  de la configuración regional actual determina el reconocimiento de caracteres de base en `nptr`*.* Para obtener más información, vea [setlocale](../../c-runtime-library/reference/setlocale-wsetlocale.md).  Las funciones sin el sufijo `_l` usan la configuración regional actual; `_strtol_l` y `_wcstol_l` son idénticas a las funciones correspondientes sin el sufijo `_l`, salvo que usan la configuración regional que se pasa.  Para obtener más información, vea [Configuración regional](../../c-runtime-library/locale.md).  
