...
En el caso de **tmpnam_s**, puede almacenar este nombre de archivo generado en *Str*. La longitud máxima de una cadena devuelta por **tmpnam_s** es **L_tmpnam_s**, que se define en stdio. C. Si *Str* es **null**, **tmpnam_s** deja el resultado en un búfer estático interno. Por lo tanto, las siguientes llamadas destruyen este valor. El nombre generado por **tmpnam_s** consta de un nombre de archivo generado por el programa y, después de la primera llamada a **tmpnam_s**, es una extensión de archivo de números secuenciales en base 32 (. 1-. 1Vvvvvu, cuando se **TMP_MAX_S** en stdio. H es **INT_MAX**).
