...
Reasigna un puntero de archivo.  Hay disponibles versiones más seguras de estas funciones; vea [freopen\_s, \_wfreopen\_s](../../c-runtime-library/reference/freopen-s-wfreopen-s.md).  
...
## Comentarios  
 Existen versiones más seguras de estas funciones, vea [freopen\_s, \_wfreopen\_s](../../c-runtime-library/reference/freopen-s-wfreopen-s.md).  
