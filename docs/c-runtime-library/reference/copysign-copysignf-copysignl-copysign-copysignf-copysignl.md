...
Dado que C++ admite sobrecargas, puede llamar a sobrecargas de **copysign** que toman y devuelven **float** o **largo** **doble** valores. En un programa C, **copysign** siempre toma y devuelve un **doble**.
