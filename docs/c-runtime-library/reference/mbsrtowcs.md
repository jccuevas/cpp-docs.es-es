...
## Valor devuelto  
 Devuelve el número de caracteres convertidos correctamente, sin incluir el carácter nulo de terminación, de haberlo.  Devuelve \(size\_t\)\(\-1\) si se produce un error y establece `errno` a EILSEQ.  
