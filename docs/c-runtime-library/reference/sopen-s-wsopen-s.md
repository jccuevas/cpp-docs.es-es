...
Abre un archivo para compartirlo. Estas versiones de [_sopen y _wsopen](../../c-runtime-library/reference/sopen-wsopen.md) incluyen mejoras de seguridad, tal y como se describe en [Características de seguridad de CRT](../../c-runtime-library/security-features-in-the-crt.md).  
