...
| **EEXIST** |  Se especificaron marcas **_O_CREAT** y **_O_EXCL** , pero el *nombre de archivo* ya existe. |
...
La expresión de entero *Oflag* se forma combinando una o más constantes de manifiesto, que se definen en \<fcntl. h >. Cuando dos o más constantes forman el argumento *Oflag*, se combinan con el operador bit a bit or ( **&#124;** ).
