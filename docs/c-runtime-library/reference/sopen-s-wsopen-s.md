...
**_sopen_s** y **_wsopen_s** son extensiones de Microsoft. Para más información sobre compatibilidad, vea [Compatibilidad](../../c-runtime-library/compatibility.md).
