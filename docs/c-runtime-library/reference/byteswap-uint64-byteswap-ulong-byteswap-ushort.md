...
*Val*<br/>
Valor entero para invertir el orden de bytes.
...
[Rutinas en tiempo de ejecución de C universales por categoría](../../c-runtime-library/run-time-routines-by-category.md)<br/>
