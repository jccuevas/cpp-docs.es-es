...
Dado C++ que permite las sobrecargas, puede llamar a las sobrecargas de **CTAN** que toman y devuelven los valores **_Fcomplex** y **_Lcomplex** . En un programa de C, **CTAN** siempre toma y devuelve un valor de **_Dcomplex** .
