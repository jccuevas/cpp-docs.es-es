...
Esta función establece **errno en** **ENOMEM** si la asignación de memoria ha fallado o si el tamaño solicitado fue mayor que **_HEAP_MAXREQ**. Para obtener más información acerca de **errno**, vea [errno, _doserrno, _sys_errlist y _sys_nerr](../../c-runtime-library/errno-doserrno-sys-errlist-and-sys-nerr.md). Además, **_aligned_realloc** valida sus parámetros. Si *la alineación* no es una potencia de 2, esta función invoca el controlador de parámetros no válidos, como se describe en [Validación de parámetros](../../c-runtime-library/parameter-validation.md). Si la ejecución puede continuar, esta función devuelve **NULL** y establece **errno** en **EINVAL**.
