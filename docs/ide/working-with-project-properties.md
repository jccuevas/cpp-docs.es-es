...
- Cree un archivo .props en el que se especifiquen las propiedades que se quieren invalidar. 
- Desde el símbolo del sistema: establezca ForceImportBeforeCppTargets="C:\sources\my_props.props".
...
## <a name="see-also"></a>Vea también  
 [Creación y administración de proyectos de Visual C++](../ide/creating-and-managing-visual-cpp-projects.md) [Estructura de archivos .vcxproj y .props](vcxproj-file-structure.md) [Archivos XML de página de propiedades](property-page-xml-files.md)