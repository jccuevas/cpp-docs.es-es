...
3.  Si la función no tiene ninguna invalidación, haga clic en la celda de la columna de la derecha en la ventana Propiedades para mostrar el nombre sugerido de la función de invalidación como \<add>*NombreFunción*.  
  
4.  Haga clic en el nombre sugerido para agregar código auxiliar para la función.  
  
5.  Para modificar una función de invalidación, haga doble clic en el nombre de la función en la Vista de clases y modifique el código en la ventana de código fuente.  
