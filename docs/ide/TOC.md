...
# [CMake y otros proyectos que no son MSBuild en Visual C++](non-msbuild-projects.md)
## [Proyectos CMake en Visual C++](cmake-tools-for-visual-cpp.md)
# [Proyectos de MSBuild en Visual C++](creating-and-managing-visual-cpp-projects.md)
