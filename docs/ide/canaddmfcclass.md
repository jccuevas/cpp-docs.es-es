...
El asistente llama a esta función para comprobar si el usuario puede agregar una clase MFC al proyecto.  
...
## Valor devuelto  
 **true** si se puede agregar la clase; **false** si el usuario llama a la función para un proyecto que no es un proyecto MFC ni es compatible con MFC.  
