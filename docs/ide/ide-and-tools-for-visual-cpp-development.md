...
Implementar una aplicación de UWP en los clientes a través de la tienda de Windows a través de la **proyecto** > **almacén** opción de menú. La implementación de CRT se controla automáticamente en segundo plano. Para obtener más información, consulte [Llevar las aplicaciones al mercado](http://go.microsoft.com/fwlink/p/?LinkId=262280).
