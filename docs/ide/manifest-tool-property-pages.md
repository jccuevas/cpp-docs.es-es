---
title: "Páginas de propiedades de la herramienta manifiesto | Documentos de Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Use la **herramienta manifiesto** páginas de propiedades para establecer opciones de compilación de mt.exe.  
  
 Para obtener más información acerca de la herramienta manifiesto, consulte [Mt.exe](http://msdn.microsoft.com/library/aa375649).  
