...
|.idl|Compilación|Archivo de lenguaje de definición de interfaz. Consulte [Archivo de definición de interfaz \(IDL\)](http://msdn.microsoft.com/library/windows/desktop/aa378712) en [!INCLUDE[winsdkshort](../atl/reference/includes/winsdkshort_md.md)] para obtener más información.|  
...
|.mfcribbon\-ms|Recurso|Archivo de recursos que contiene el código XML que define los botones, los controles y los atributos de la cinta de opciones. Para obtener más información, vea [Diseñador de la cinta de opciones \(MFC\)](../mfc/ribbon-designer-mfc.md).|  
|.obj, .o||Archivos de objeto, compilados pero no vinculados.|  
|.pch|Depuración|Archivo de encabezado precompilado.|  
|.rc, .rc2|Recurso|[Archivos de script de recursos](../mfc/working-with-resource-files.md) para generar recursos.|  
...
|.sln|Solución|Archivo de [solución](http://msdn.microsoft.com/es-es/a45c299d-69f5-4b67-879d-1383417df0a7).|  
