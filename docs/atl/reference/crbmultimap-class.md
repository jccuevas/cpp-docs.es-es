---
title: CRBMultiMap (clase) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
## <a name="see-also"></a>Vea también  
 [CRBTree (clase)](../../atl/reference/crbtree-class.md)   
 [CAtlMap (clase)](../../atl/reference/catlmap-class.md)   
 [CRBMap (clase)](../../atl/reference/crbmap-class.md)   
