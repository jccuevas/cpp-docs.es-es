...
3. En el [Agregar clase](../../ide/add-class-dialog-box.md) cuadro de diálogo, en el panel Plantillas, haga clic en **Control ATL**y, a continuación, haga clic en **agregar** para mostrar el [Asistente para controles ATL](../../atl/reference/atl-control-wizard.md).
