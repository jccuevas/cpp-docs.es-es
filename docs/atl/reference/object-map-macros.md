...
*clsid*<br/>
[in] El CLSID de una clase COM implementada por el C++ clase denominada *clase*.

*class*<br/>
[in] El nombre de la C++ clase que implementa la clase COM representada por *clsid*.
