...
Esta clase es utilizada por las macros de conversión de cadena `CT2AEX`, `CW2TEX`, `CW2CTEX`, y `CT2CAEX`y la definición de tipo **CW2A**.  
...
## <a name="remarks"></a>Comentarios  
 A menos que se requiere funcionalidad adicional, use `CT2AEX`, `CW2TEX`, `CW2CTEX`, `CT2CAEX`, o **CW2A** en el código.  
