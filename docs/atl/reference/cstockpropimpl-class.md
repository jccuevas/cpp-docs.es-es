...
Visual Studio proporciona compatibilidad para las propiedades estándar a través de sus asistentes. Para obtener más información acerca de cómo agregar propiedades estándar a un control, vea el [Tutorial de ATL](../../atl/active-template-library-atl-tutorial.md).
