...
Vea [ACE_HEADER](/windows/desktop/api/winnt/ns-winnt-ace_header) para obtener una descripción de las distintas marcas que se pueden establecer en `AceFlags` el parámetro.
