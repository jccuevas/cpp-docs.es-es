...
|[COMMAND_CODE_HANDLER](#command_code_handler)|Asigna un mensaje WM_COMMAND a una función de controlador, basándose en el código de notificación.|
|[COMMAND_HANDLER](#command_handler)|Asigna un mensaje WM_COMMAND a una función de controlador, basándose en el código de notificación y el identificador del elemento de menú, el control o el acelerador.|
|[COMMAND_ID_HANDLER](#command_id_handler)|Asigna un mensaje WM_COMMAND a una función de controlador, basándose en el identificador del elemento de menú, el control o el acelerador.|
|[COMMAND_RANGE_CODE_HANDLER](#command_range_code_handler)|Asigna un mensaje WM_COMMAND a una función de controlador, basándose en el código de notificación y en un intervalo contiguo de identificadores de control.|
|[COMMAND_RANGE_HANDLER](#command_range_handler)|Asigna un mensaje WM_COMMAND a una función de controlador, basándose en un intervalo de identificadores de control contiguos.|
...
|[NOTIFY_CODE_HANDLER](#notify_code_handler)|Asigna un mensaje WM_NOTIFY a una función de controlador, basándose en el código de notificación.|
|[NOTIFY_HANDLER](#notify_handler)|Asigna un mensaje WM_NOTIFY a una función de controlador, basándose en el código de notificación y en el identificador de control.|
|[NOTIFY_ID_HANDLER](#notify_id_handler)|Asigna un mensaje WM_NOTIFY a una función de controlador, basándose en el identificador de control.|
|[NOTIFY_RANGE_CODE_HANDLER](#notify_range_code_handler)|Asigna un mensaje WM_NOTIFY a una función de controlador, basándose en el código de notificación y en un intervalo contiguo de identificadores de control.|
|[NOTIFY_RANGE_HANDLER](#notify_range_handler)|Asigna un mensaje WM_NOTIFY a una función de controlador, basándose en un intervalo de identificadores de control contiguos.|
|[REFLECT_NOTIFICATIONS](#reflect_notifications)|Refleje los mensajes de notificación de nuevo en la ventana que los envió.|
|[REFLECTED_COMMAND_CODE_HANDLER](#reflected_command_code_handler)|Asigna un mensaje WM_COMMAND reflejado a una función de controlador, basándose en el código de notificación.|
...
|[REFLECTED_COMMAND_ID_HANDLER](#reflected_command_id_handler)|Asigna un mensaje WM_COMMAND reflejado a una función de controlador, basándose en el identificador del elemento de menú, el control o el acelerador.|
...
|[REFLECTED_COMMAND_RANGE_HANDLER](#reflected_command_range_handler)|Asigna un mensaje WM_COMMAND reflejado a una función de controlador, basándose en un intervalo de identificadores de control contiguos.|
|[REFLECTED_NOTIFY_CODE_HANDLER](#reflected_notify_code_handler)|Asigna un mensaje WM_NOTIFY reflejado a una función de controlador, basándose en el código de notificación.|
|[REFLECTED_NOTIFY_HANDLER](#reflected_notify_handler)|Asigna un mensaje WM_NOTIFY reflejado a una función de controlador, basándose en el código de notificación y en el identificador de control.|
|[REFLECTED_NOTIFY_ID_HANDLER](#reflected_notify_id_handler)|Asigna un mensaje WM_NOTIFY reflejado a una función de controlador, basándose en el identificador de control.|
...
|[REFLECTED_NOTIFY_RANGE_HANDLER](#reflected_notify_range_handler)|Asigna un mensaje WM_NOTIFY reflejado a una función de controlador, basándose en un intervalo de identificadores de control contiguos.|
...
|[COMMAND_HANDLER](#command_handler)|Asigna un mensaje WM_COMMAND a una función de controlador, basándose en el código de notificación y el identificador del elemento de menú, el control o el acelerador.|
|[COMMAND_ID_HANDLER](#command_id_handler)|Asigna un mensaje WM_COMMAND a una función de controlador, basándose en el identificador del elemento de menú, el control o el acelerador.|
|[COMMAND_CODE_HANDLER](#command_handler)|Asigna un mensaje WM_COMMAND a una función de controlador, basándose en el código de notificación.|
|[COMMAND_RANGE_HANDLER](#command_range_handler)|Asigna un intervalo contiguo de mensajes WM_COMMAND a una función de controlador, basándose en el identificador del elemento de menú, el control o el acelerador.|
|[NOTIFY_HANDLER](#notify_handler)|Asigna un mensaje WM_NOTIFY a una función de controlador, basándose en el código de notificación y en el identificador de control.|
|[NOTIFY_ID_HANDLER](#notify_id_handler)|Asigna un mensaje WM_NOTIFY a una función de controlador, basándose en el identificador de control.|
|[NOTIFY_CODE_HANDLER](#notify_code_handler)|Asigna un mensaje WM_NOTIFY a una función de controlador, basándose en el código de notificación.|
|[NOTIFY_RANGE_HANDLER](#notify_range_handler)|Asigna un intervalo contiguo de mensajes WM_NOTIFY a una función de controlador, basándose en el identificador de control.|
...
Cuando un `CMyExtWindow` objeto recibe un mensaje WM_PAINT, el mensaje se dirige a `CMyExtWindow::OnPaint` para el procesamiento real. Si `OnPaint` indica que el mensaje requiere un procesamiento posterior, el mensaje se dirigirá a la asignación de mensajes `CMyBaseWindow`predeterminada en.
...
CHAIN_MSG_MAP_ALT dirige los mensajes a un mapa de mensajes alternativo en una clase base. Debe haber declarado este mapa de mensajes alternativo con [ALT_MSG_MAP (msgMapID)](#alt_msg_map). Para dirigir los mensajes al mapa de mensajes predeterminado de una clase base (declarado con [BEGIN_MSG_MAP](#begin_msg_map)), use CHAIN_MSG_MAP. Para obtener un ejemplo, vea [CHAIN_MSG_MAP](#chain_msg_map).
...
CHAIN_MSG_MAP dirige los mensajes al mapa de mensajes predeterminado de una clase base (declarado con [BEGIN_MSG_MAP](#begin_msg_map)). Para dirigir los mensajes a un mapa de mensajes alternativo de una clase base (declarado con [ALT_MSG_MAP](#alt_msg_map)), use [CHAIN_MSG_MAP_ALT](#chain_msg_map_alt).
...
- Si un procedimiento de ventana usa `CMyClass`el mapa de mensajes predeterminado `OnPaint` de y no controla un mensaje, el mensaje se dirige `CMyBaseClass`al mapa de mensajes predeterminado de para su procesamiento.

- Si un procedimiento de ventana usa el primer mapa de mensajes alternativo `CMyClass`en, todos los mensajes se `CMyBaseClass`dirigen al mapa de mensajes predeterminado de.

- Si un procedimiento de ventana usa `CMyClass`el segundo mapa de mensajes alternativo `OnChar` y no controla un mensaje, el mensaje se dirige al mapa de mensajes alternativo especificado en `CMyBaseClass`. `CMyBaseClass`debe haber declarado este mapa de mensajes con ALT_MSG_MAP (1).
...
- Si un procedimiento de ventana usa `CMyClass`el mapa de mensajes predeterminado `OnPaint` de y no controla un mensaje, el mensaje se dirige `m_obj`al mapa de mensajes predeterminado de para su procesamiento.

- Si un procedimiento de ventana usa el primer mapa de mensajes alternativo `CMyClass`en, todos los mensajes se `m_obj`dirigen al mapa de mensajes predeterminado de.

- Si un procedimiento de ventana usa `CMyClass`el segundo mapa de mensajes alternativo `OnChar` y no controla un mensaje, el mensaje se dirige al mapa de mensajes alternativo especificado de `m_obj`. La `CMyContainedClass` clase debe haber declarado este mapa de mensajes con ALT_MSG_MAP (1).
...
COMMAND_HANDLER asigna un mensaje [WM_COMMAND](/windows/win32/menurc/wm-command) a la función de controlador especificada, según el código de notificación y el identificador de control. Por ejemplo:
...
El mapa de mensajes `bHandled` establece en true `CommandHandler` antes de llamar a. Si `CommandHandler` no controla por completo el mensaje, debe establecerse `bHandled` en false para indicar que el mensaje necesita más procesamiento.
...
Además de COMMAND_HANDLER, puede usar [MESSAGE_HANDLER](#message_handler) para asignar un mensaje WM_COMMAND sin tener en cuenta un identificador o código. En este caso, `MESSAGE_HANDLER(WM_COMMAND, OnHandlerFunction)` dirigirá todos los mensajes WM_COMMAND `OnHandlerFunction`a.
...
Similar a [COMMAND_RANGE_HANDLER](#command_range_handler), pero asigna mensajes [WM_COMMAND](/windows/win32/menurc/wm-command) con un código de notificación específico de un intervalo de controles a una única función de controlador.
...
Similar a [COMMAND_HANDLER](#command_handler), pero asigna mensajes [WM_COMMAND](/windows/win32/menurc/wm-command) de un intervalo de controles a una sola función de controlador.
...
El mapa de mensajes `bHandled` establece en true `MessageHandler` antes de llamar a. Si `MessageHandler` no controla por completo el mensaje, debe establecerse `bHandled` en false para indicar que el mensaje necesita más procesamiento.
...
NOTIFY_HANDLER asigna un mensaje [WM_NOTIFY](/windows/win32/controls/wm-notify) a la función de controlador especificada, según el código de notificación y el identificador de control.

Cualquier función especificada en una macro NOTIFY_HANDLER debe definirse de la siguiente manera:

`LRESULT NotifyHandler(int idCtrl, LPNMHDR pnmh, BOOL& bHandled);`

El mapa de mensajes `bHandled` establece en true `NotifyHandler` antes de llamar a. Si `NotifyHandler` no controla por completo el mensaje, debe establecerse `bHandled` en false para indicar que el mensaje necesita más procesamiento.

> [!NOTE]
>  Comience siempre un mapa de mensajes con [BEGIN_MSG_MAP](#begin_msg_map). Después, puede declarar las siguientes asignaciones de mensajes alternativos con [ALT_MSG_MAP](#alt_msg_map). La macro [END_MSG_MAP](#end_msg_map) marca el final del mapa de mensajes. Cada mapa de mensajes debe tener exactamente una instancia de BEGIN_MSG_MAP y END_MSG_MAP.

Además de NOTIFY_HANDLER, puede usar [MESSAGE_HANDLER](#message_handler) para asignar un mensaje WM_NOTIFY sin tener en cuenta un identificador o código. En este caso, `MESSAGE_HANDLER(WM_NOTIFY, OnHandlerFunction)` dirigirá todos los mensajes WM_NOTIFY `OnHandlerFunction`a.
...
Similar a [NOTIFY_HANDLER](#notify_handler), pero asigna un mensaje [WM_NOTIFY](/windows/win32/controls/wm-notify) basado únicamente en el identificador de control.
...
Similar a [NOTIFY_RANGE_HANDLER](#notify_range_handler), pero asigna los mensajes [WM_NOTIFY](/windows/win32/controls/wm-notify) con un código de notificación específico de un intervalo de controles a una única función de controlador.
...
Similar a [NOTIFY_HANDLER](#notify_handler), pero asigna los mensajes [WM_NOTIFY](/windows/win32/controls/wm-notify) de un intervalo de controles a una sola función de controlador.
