...
### <a name="remarks"></a>Comentarios  
 ...
 Pasadas (HBITMAP) 1 del mapa de bits manejar el parámetro a la función de Win32.  
...
##  <a name="a-namedestroywindowa--cwindowdestroywindow"></a><a name="destroywindow"></a>API CWindow:: DestroyWindow  
...
### <a name="parameters"></a>Parámetros  
 ...
 `bRedraw`  
 [in] Si **TRUE** (valor predeterminado), la ventana se vuelve a dibujar. De lo contrario, no lo es.  
...
### <a name="parameters"></a>Parámetros  
 ...
 `wModifiers`  
 [in] Los modificadores de la tecla de acceso rápido. Para obtener una lista de valores posibles, consulte **mensaje WM_SETHOTKEY** en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
### <a name="return-value"></a>Valor devuelto  
 Para obtener una lista de posibles valores devueltos, consulte [mensaje WM_SETHOTKEY](http://msdn.microsoft.com/library/windows/desktop/ms646284) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
##  <a name="a-nameseticona--cwindowseticon"></a><a name="seticon"></a>CWindow::SetIcon  
 Icono grande o pequeño de la ventana se establece en el icono identificado por `hIcon`.  
...
### <a name="parameters"></a>Parámetros  
 ...
 `bBigIcon`  
 [in] Si **TRUE** (valor predeterminado), el método establece un icono grande. En caso contrario, establece un icono pequeño.  
...
### <a name="remarks"></a>Comentarios  
 Consulte [SetMenu](http://msdn.microsoft.com/library/windows/desktop/ms647995) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Consulte [SetParent](http://msdn.microsoft.com/library/windows/desktop/ms633541) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="a-namesetredrawa--cwindowsetredraw"></a><a name="setredraw"></a>CWindow::SetRedraw  
 Establece o borra la marca de actualización mediante el envío de un [WM_SETREDRAW](http://msdn.microsoft.com/library/windows/desktop/dd145219) mensaje en la ventana.  
...
### <a name="parameters"></a>Parámetros  
 `bRedraw`  
 [in] Especifica el estado de la marca de actualización. Si **TRUE** (valor predeterminado), el indicador de actualización se establece; si **FALSE**, se borra el indicador.  
  
### <a name="remarks"></a>Comentarios  
 Llame a `SetRedraw` para permitir que los cambios se vuelva a dibujar o para impedir que los cambios que se va a dibujar.  
  
### <a name="example"></a>Ejemplo  
 [!code-cpp[NVC_ATL_Windowing Nº&33;](../../atl/codesnippet/cpp/cwindow-class_33.cpp)]  
...
### <a name="remarks"></a>Comentarios  
 Consulte [SetScrollInfo](http://msdn.microsoft.com/library/windows/desktop/bb787595) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Consulte [SetScrollPos](http://msdn.microsoft.com/library/windows/desktop/bb787597) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Consulte [SetScrollRange](http://msdn.microsoft.com/library/windows/desktop/bb787599) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Consulte [SetTimer](http://msdn.microsoft.com/library/windows/desktop/ms644906) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Consulte [SetWindowContextHelpId](http://msdn.microsoft.com/library/windows/desktop/bb762101) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Consulte [SetWindowLong](http://msdn.microsoft.com/library/windows/desktop/ms633591) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Consulte [SetWindowLongPtr](http://msdn.microsoft.com/library/windows/desktop/ms644898) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="a-namesetwindowplacementa--cwindowsetwindowplacement"></a><a name="setwindowplacement"></a>CWindow::SetWindowPlacement  
 Establece el estado de mostrar y posiciones.  
...
### <a name="remarks"></a>Comentarios  
 Consulte [SetWindowPlacement](http://msdn.microsoft.com/library/windows/desktop/ms633544) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Consulte [SetWindowPos](http://msdn.microsoft.com/library/windows/desktop/ms633545) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
 La segunda versión de este método utiliza un [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) estructura para establecer la nueva posición, ancho y alto de la ventana.  
...
### <a name="remarks"></a>Comentarios  
 Consulte [SetWindowRgn](http://msdn.microsoft.com/library/windows/desktop/dd145102) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Consulte [SetWindowText](http://msdn.microsoft.com/library/windows/desktop/ms633546) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Consulte [ShowCaret](http://msdn.microsoft.com/library/windows/desktop/ms648406) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="a-nameshowownedpopupsa--cwindowshowownedpopups"></a><a name="showownedpopups"></a>CWindow::ShowOwnedPopups  
 Muestra u oculta las ventanas emergentes que pertenece a la ventana.  
...
### <a name="remarks"></a>Comentarios  
 Consulte [ShowOwnedPopups](http://msdn.microsoft.com/library/windows/desktop/ms633547) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Consulte [ShowScrollBar](http://msdn.microsoft.com/library/windows/desktop/bb787601) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Consulte [ShowWindow](http://msdn.microsoft.com/library/windows/desktop/ms633548) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Consulte [ShowWindowAsync](http://msdn.microsoft.com/library/windows/desktop/ms633549) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Consulte [UpdateWindow](http://msdn.microsoft.com/library/windows/desktop/dd145167) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="a-namevalidaterecta--cwindowvalidaterect"></a><a name="validaterect"></a>CWindow::ValidateRect  
 Valida el área del cliente dentro del rectángulo especificado.  
...
### <a name="remarks"></a>Comentarios  
 Consulte [ValidateRect](http://msdn.microsoft.com/library/windows/desktop/dd145194) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
##  <a name="a-namevalidatergna--cwindowvalidatergn"></a><a name="validatergn"></a>CWindow::ValidateRgn  
 Valida el área de cliente dentro de la región especificada.  
...
### <a name="remarks"></a>Comentarios  
 Consulte [ValidateRgn](http://msdn.microsoft.com/library/windows/desktop/dd145195) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Comentarios  
 Consulte [WinHelp](http://msdn.microsoft.com/library/windows/desktop/bb762267) en el [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
