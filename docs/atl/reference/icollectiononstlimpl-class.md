---
title: ICollectionOnSTLImpl (clase) | Documentos de Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Esta clase proporciona métodos usados por una clase de colección.  
...
```
STDMETHOD(GetCount) (larga * pcount);
```  
