...
`cf` Declara como el generador de clases.
...
[CComCoClass](../../atl/reference/ccomcoclass-class.md) incluye la macro [DECLARE_CLASSFACTORY](#declare_classfactory) , que especifica [CComClassFactory](../../atl/reference/ccomclassfactory-class.md) como generador de clases predeterminado. Sin embargo, si se incluye la macro DECLARE_CLASSFACTORY2 en la definición de clase del objeto, se invalida este valor predeterminado.
...
[CComCoClass](../../atl/reference/ccomcoclass-class.md) incluye la macro [DECLARE_CLASSFACTORY](#declare_classfactory) , que especifica [CComClassFactory](../../atl/reference/ccomclassfactory-class.md) como generador de clases predeterminado. Sin embargo, si se incluye la macro DECLARE_CLASSFACTORY_AUTO_THREAD en la definición de clase del objeto, se invalida este valor predeterminado.
...
[CComCoClass](../../atl/reference/ccomcoclass-class.md) incluye la macro [DECLARE_CLASSFACTORY](#declare_classfactory) , que especifica [CComClassFactory](../../atl/reference/ccomclassfactory-class.md) como generador de clases predeterminado. Sin embargo, si se incluye la macro DECLARE_CLASSFACTORY_SINGLETON en la definición de clase del objeto, se invalida este valor predeterminado.
...
DECLARE_NOT_AGGREGATABLE hace `CreateInstance` que devuelva un error (CLASS_E_NOAGGREGATION) si se realiza un intento de agregar en el objeto.
...
La macro DECLARE_POLY_AGGREGATABLE se declara automáticamente en el objeto si se usa el Asistente para controles ATL para crear un control total.
