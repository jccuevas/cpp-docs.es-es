...
#### <a name="parameters"></a>Parámetros  
 ...
 `plibid`  
 Un puntero a la biblioteca de tipos que define la interfaz de envío que señala `pdiid`. Si **siguiente GUID_NULL**, la biblioteca de tipos se cargará desde el objeto de origen de los eventos.  
