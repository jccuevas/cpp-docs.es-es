---
title: Clase IAtlAutoThreadModule | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
## <a name="remarks"></a>Comentarios  
 La clase [CAtlAutoThreadModuleT](../../atl/reference/catlautothreadmodulet-class.md) deriva de `IAtlAutoThreadModule`, usarlo para proporcionar código para crear un objeto y recuperar un puntero de interfaz.  
