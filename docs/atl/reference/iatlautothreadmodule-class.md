...
## Comentarios  
 La clase [CAtlAutoThreadModuleT](../../atl/reference/catlautothreadmodulet-class.md) deriva de `IAtlAutoThreadModule`, su uso para proporcionar código para crear un objeto y recuperar un puntero de interfaz.  
