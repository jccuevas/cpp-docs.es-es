...
|--------------|-----------------|  
|[operador ==](#operator_eq_eq)|Compara dos `CSid` objetos o `SID` estructuras de igualdad.|  
|[operador! =](#operator_neq)|Compara dos `CSid` objetos o `SID` estructuras no son iguales.|  
