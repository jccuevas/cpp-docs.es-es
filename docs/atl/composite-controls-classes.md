---
title: Compuesto controla las clases (ATL) | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
## <a name="see-also"></a>Vea también  
 ...
 [Macros de controles compuestos](../atl/reference/composite-control-macros.md)   
