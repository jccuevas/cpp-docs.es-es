---
title: Clases de seguridad (ATL) | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
-   [CAcl](../atl/reference/cacl-class.md) esta clase es un contenedor para una **ACL** estructura (lista de control de acceso).  
...
-   [CSecurityDesc](../atl/reference/csecuritydesc-class.md) esta clase es un contenedor para la **SECURITY_DESCRIPTOR** estructura.  
  
-   [CSid](../atl/reference/csid-class.md) esta clase es un contenedor para un `SID` estructura (identificador de seguridad).  
  
-   [CTokenGroups](../atl/reference/ctokengroups-class.md) esta clase es un contenedor para la **TOKEN_GROUPS** estructura.  
  
-   [CTokenPrivileges](../atl/reference/ctokenprivileges-class.md) esta clase es un contenedor para la **TOKEN_PRIVILEGES** estructura.  
