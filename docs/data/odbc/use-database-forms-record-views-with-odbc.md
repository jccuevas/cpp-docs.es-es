---
title: Utilizar formularios de base de datos (vistas de registros) con ODBC | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
-   [Mostrar los datos de base de datos en un formulario](../../data/record-views-mfc-data-access.md)  
