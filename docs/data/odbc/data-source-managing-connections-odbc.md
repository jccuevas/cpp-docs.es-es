...
2.  En el **DSN de archivo** , haga clic **agregar**.  
  
3.  En el **crear nuevo origen de datos** cuadro de diálogo, seleccione un controlador de Excel y, a continuación, haga clic en **siguiente**.  
...
2.  En el **configuración de ODBC Microsoft Excel** cuadro de diálogo, seleccione la versión de la base de datos y el libro.  
...
2.  Llame a su `OpenEx` o `Open` función miembro.  
...
2.  Destruya el objeto a menos que desee volver a usarla.  
...
2.  En lugar de destruir el objeto, llame a su `OpenEx` o `Open` volver a la función miembro.  
