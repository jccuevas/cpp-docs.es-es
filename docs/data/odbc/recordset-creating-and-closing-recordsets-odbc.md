...
2.  Opcionalmente, modifique el comportamiento del conjunto de registros de forma predeterminada. Para las opciones disponibles, consulte [establecer las opciones de conjunto de registros](#_core_setting_recordset_options).  
  
3.  Llamar al objeto [abierto](../../mfc/reference/crecordset-class.md#open) función miembro.  
