...
3.  Establecer otras opciones que necesite, como un filtro, el modo de bloqueo o parámetros.  
  
4.  Llame a `Open` para el nuevo objeto (o `Requery` para un objeto existente).  
