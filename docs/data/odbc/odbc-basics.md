---
title: Conceptos básicos de ODBC | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
-   [¿Qué componentes ODBC necesarios para redistribuir con las aplicaciones](../../data/odbc/redistributing-odbc-components-to-your-customers.md)  
 ...
 También deberá leer el tema relacionado [ODBC: biblioteca de cursores ODBC](../../data/odbc/odbc-the-odbc-cursor-library.md).  
...
-   API de ODBC  
     ...
     Llama a una biblioteca de función, un conjunto de códigos de error y una norma [SQL](../../data/odbc/sql.md) sintaxis para tener acceso a datos de los DBMS.  
