---
title: 'SQL: Personalizar la instrucción de SQL del conjunto de registros (ODBC) | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
