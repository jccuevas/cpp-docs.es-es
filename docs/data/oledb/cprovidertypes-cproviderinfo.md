...
helpviewer_keywords: 
  - "COLUMN_SIZE"
  - "CProviderInfo (clase de parámetro)"
  - "CProviderTypes (clase de definiciones de tipo)"
  - "DATA_TYPE"
  - "FIXED_PREC_SCALE"
  - "IS_LONG"
  - "IS_NULLABLE"
...
Asigne a la clase **CProviderTypes** typedef para implementar la clase **CProviderInfo**del parámetro.  
...
## Comentarios  
 ...
 La tabla siguiente se enumeran los miembros de datos de la clase y sus columnas correspondientes de OLE DB.  Vea [Conjunto de filas PROVIDER\_TYPES](https://msdn.microsoft.com/en-us/library/ms709785.aspx) en *la referencia del* programador para obtener más información sobre el esquema y las columnas.  
