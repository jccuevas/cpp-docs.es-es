---
title: 'CCommand:: SetParameterInfo | Documentos de Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
#### <a name="parameters"></a>Parámetros  
 Vea [ICommandWithParameters:: SetParameterInfo](https://msdn.microsoft.com/en-us/library/ms725393.aspx) en el *referencia del programador OLE DB*.  
