---
title: 'ICommandImpl:: Cancel | Documentos de Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
## <a name="remarks"></a>Comentarios  
 Vea [ICommand::Cancel](https://msdn.microsoft.com/en-us/library/ms714402.aspx) en el *referencia del programador OLE DB*.  
