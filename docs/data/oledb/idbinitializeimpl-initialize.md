...
Inicializa el objeto de origen de datos preparar su compatibilidad con la propiedad.  
...
## Comentarios  
 Vea [IDBInitialize::Initialize](https://msdn.microsoft.com/en-us/library/ms718026.aspx) en *la referencia del*programador.  
