---
title: CProcedures, CProcedureInfo | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "33096137"
---
# <a name="cprocedures-cprocedureinfo"></a>CProcedures, CProcedureInfo
Llamar a la clase de typedef **CProcedures** para implementar su clase de parámetro **CProcedureInfo**.  
...
## <a name="remarks"></a>Comentarios  
 ...
 En la tabla siguiente se enumera los miembros de datos de la clase y sus columnas OLE DB correspondiente. Vea [conjunto de filas PROCEDURES](https://msdn.microsoft.com/en-us/library/ms724021.aspx) en el *referencia del programador de OLE DB* para obtener más información sobre el esquema y las columnas.  
