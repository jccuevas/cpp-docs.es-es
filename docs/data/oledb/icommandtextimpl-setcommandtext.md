...
Establece el texto de comando, reemplazando el texto existente del comando.  
...
#### Parámetros  
 Vea [ICommandText::SetCommandText](https://msdn.microsoft.com/en-us/library/ms709757.aspx) en *la referencia del*programador.  
