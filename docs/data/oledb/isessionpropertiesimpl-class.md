...
ms.locfileid: "39337260"
---
# <a name="isessionpropertiesimpl-class"></a>ISessionPropertiesImpl (Clase)
Proporciona una implementación de la [ISessionProperties](https://msdn.microsoft.com/library/ms713721.aspx) interfaz.  
...
#### <a name="parameters"></a>Parámetros  
 Consulte [ISessionProperties::GetProperties](https://msdn.microsoft.com/library/ms723643.aspx) en el *referencia del programador OLE DB*. 
...
#### <a name="parameters"></a>Parámetros  
 Consulte [ISessionProperties::SetProperties](https://msdn.microsoft.com/library/ms714405.aspx) en el *referencia del programador OLE DB*.  
