...
Consulte [ISourcesRowset:: GetSourcesRowset](https://docs.microsoft.com/previous-versions/windows/desktop/ms711200(v=vs.85)) en el *referencia del programador de OLE DB* para obtener más información.
