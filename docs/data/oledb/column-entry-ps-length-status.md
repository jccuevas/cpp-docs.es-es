...
## Comentarios  
 Permite especificar la precisión y la escala de la columna que desea enlazar.  Use esta macro cuando desee admitir variables de longitud y estado.  Se utiliza en los lugares siguientes:  
