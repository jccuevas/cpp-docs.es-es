...
Implementa OLE DB [IRowsetLocate](https://docs.microsoft.com/previous-versions/windows/desktop/ms721190(v=vs.85)) interfaz, que recupera filas arbitrarias de un conjunto de filas.
...
*BookmarkKeyType*<br/>
El tipo del marcador, como un valor largo o una cadena. Los marcadores normales deben tener una longitud de al menos dos bytes. (Longitud de un byte está reservado para OLE DB [marcadores estándares](https://docs.microsoft.com/previous-versions/windows/desktop/ms712954(v=vs.85))`DBBMK_FIRST`, `DBBMK_LAST`, y `DBBMK_INVALID`.)
...
Para obtener información sobre la compatibilidad con marcadores de implementación, consulte [proveedor admite marcadores](../../data/oledb/provider-support-for-bookmarks.md) en el *Guía del programador de Visual C++* y [marcadores](https://docs.microsoft.com/previous-versions/windows/desktop/ms709728(v=vs.85)) en el *Referencia del programador OLE DB* en Platform SDK.
...
Consulte [IRowsetLocate:: Compare](https://docs.microsoft.com/previous-versions/windows/desktop/ms709539(v=vs.85)) en el *referencia del programador OLE DB*.

### <a name="remarks"></a>Comentarios

Cualquiera de los marcadores pueden ser un estándar definido por OLE DB [marcador estándar](https://docs.microsoft.com/previous-versions/windows/desktop/ms712954(v=vs.85)) (`DBBMK_FIRST`, `DBBMK_LAST`, o `DBBMK_INVALID`). El valor devuelto en `pComparison` indica la relación entre los dos marcadores:
...
Consulte [IRowsetLocate:: GetRowsAt](https://docs.microsoft.com/previous-versions/windows/desktop/ms723031(v=vs.85)) en el *referencia del programador OLE DB*.

### <a name="remarks"></a>Comentarios

Para capturar desde la posición del cursor en su lugar, use [IRowset::GetRowsAt](https://docs.microsoft.com/previous-versions/windows/desktop/ms723031(v=vs.85)).
...
*hReserved*<br/>
[in] Corresponde a *hChapter* parámetro [IRowsetLocate:: Getrowsbybookmark](https://docs.microsoft.com/previous-versions/windows/desktop/ms725420(v=vs.85)).

Para otros parámetros, vea [IRowsetLocate:: Getrowsbybookmark](https://docs.microsoft.com/previous-versions/windows/desktop/ms725420(v=vs.85)) en el *referencia del programador de OLE DB*.

### <a name="remarks"></a>Comentarios

El marcador puede ser un valor que defina u OLE DB [marcadores estándares](https://docs.microsoft.com/previous-versions/windows/desktop/ms712954(v=vs.85)) (`DBBMK_FIRST` o `DBBMK_LAST`). no cambia la posición del cursor.
...
*hReserved*<br/>
[in] Corresponde a *hChapter* parámetro [IRowsetLocate::Hash](https://docs.microsoft.com/previous-versions/windows/desktop/ms709697(v=vs.85)).

Para otros parámetros, vea [IRowsetLocate::Hash](https://docs.microsoft.com/previous-versions/windows/desktop/ms709697(v=vs.85)) en el *referencia del programador de OLE DB*.
...
[Marcadores](https://docs.microsoft.com/previous-versions/windows/desktop/ms709728(v=vs.85))