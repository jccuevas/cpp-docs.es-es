---
title: Eliminar un botón de barra de herramientas | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33871606"
---
# <a name="deleting-a-toolbar-button"></a>Eliminar un botón de la barra de herramientas
### <a name="to-delete-a-toolbar-button"></a>Para eliminar un botón de barra de herramientas  
  
1.  Seleccione el botón de barra de herramientas y arrástrela fuera de la barra de herramientas.  
