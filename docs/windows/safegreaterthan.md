...
## Valor devuelto  
 `true` si `t` es mayor que `u`; si no `false`.  
  
## Comentarios  
 `SafeGreaterThan` extiende el operador de comparación regular la funcionalidad para comparar dos tipos diferentes de números.  
