 ...
 ***version***  \(opcional\)  
 ...
 `uuid`  
 Identificador único para la biblioteca. Si omite este parámetro, se generará automáticamente un identificador para la biblioteca. Es posible que necesite recuperar el *uuid* del bloque de biblioteca, lo que puede hacer con el identificador **\_\_uuidof \(***nombreDeBiblioteca***\)**.  
...
## Comentarios  
 ...
 Se creará un bloque de biblioteca si, además del atributo **module**, el código fuente también usa [dispinterface](../windows/dispinterface.md), [dual](../Topic/dual.md), [object](../Topic/object%20\(C++\).md) o un atributo que implique [coclase](../windows/coclass.md).  
