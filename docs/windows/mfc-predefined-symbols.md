...
Los proyectos de MFC siempre incluyen varios archivos de encabezado compatibles con ventanas,  que se agregan mediante instrucciones \#include en el archivo StdAfx.h:  
...
```  
 ...
 Los archivos de encabezado incluyen valores de ID de símbolo para valores comunes de MFC.  Estos símbolos están disponibles únicamente cuando se trabaja en un proyecto de MFC.  Observe que el prefijo AFX\_ va seguido por los prefijos de nombre de símbolo estándar.  
