...
2.  Seleccione la cadena que desee editar y haga doble clic en la columna **ID**, **Value** o **Caption**.  Ahora se puede:  
  
    -   Seleccionar un **identificador** de la lista desplegable **ID** o escribirlo directamente en el lugar correspondiente.  
  
    -   Escribir un número diferente en la columna **Value**.  
  
    -   Cambiar el contenido de la columna **Caption**.  
  
        > [!NOTE]
        >  También pueden editarse las propiedades de una cadena en la [ventana Propiedades](../Topic/Properties%20Window.md).  
