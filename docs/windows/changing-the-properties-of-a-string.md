---
title: Cambiar las propiedades de una cadena | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2.  Seleccione la cadena que desea editar y haga doble clic en el **identificador**, **valor**, o **título** columna. Ahora puede:  
  
    -   Seleccione un **identificador** desde el **Id. de lista desplegable** lista o escriba un identificador directamente en su lugar.  
  
    -   Escriba un número diferente de la **valor** columna.  
  
    -   Escriba modificaciones en el **título** columna.  
