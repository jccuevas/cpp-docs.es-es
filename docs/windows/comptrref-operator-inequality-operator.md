...
#### Parámetros  
 ...
 `b`  
 Una referencia a otro objeto de ComPtrRef, o un puntero a un objeto anónimo \(`void*`\).  
...
## Valor devuelto  
 ...
 Los cuartos y quintos operadores producen `true` si el objeto `a` no es igual al objeto `b`; si no, `false`.  
