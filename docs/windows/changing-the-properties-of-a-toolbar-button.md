...
### Para cambiar las propiedades de un botón de la barra de herramientas  
  
1.  Seleccione el botón de la barra de herramientas.  
  
2.  Escriba el nuevo Id. en la propiedad **ID** de la [ventana Propiedades](../Topic/Properties%20Window.md) o selecciónelo en la lista desplegable.  
