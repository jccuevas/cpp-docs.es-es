---
title: Eliminación de un Control | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "44313370"
---
# <a name="deleting-a-control"></a>Eliminar un control

### <a name="to-delete-a-control"></a>Para eliminar un control

1. En el cuadro de diálogo, seleccione el control y presione la **eliminar** clave.
