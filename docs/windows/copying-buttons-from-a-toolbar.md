---
title: Copiar botones de una barra de herramientas (C++) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "44318686"
---
# <a name="copying-buttons-from-a-toolbar-c"></a>Copiar botones de una barra de herramientas (C++)

### <a name="to-copy-buttons-from-a-toolbar"></a>Copiar botones de una barra de herramientas

1. Mantenga presionada la **Ctrl** clave.

2. En el **barra de herramientas Vista** panel, arrastre el botón a su nueva ubicación en la barra de herramientas o en una ubicación en otra barra de herramientas.
