...
Consulte [clases y structs Ref](../cppcx/ref-classes-and-structs-c-cx.md) y [clases y structs de valor](http://msdn.microsoft.com/library/windows/apps/hh699861.aspx).
