---
title: Las extensiones específicas de c++ / CLI | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33872619"
---
# <a name="extensions-that-are-specific-to-ccli"></a>Extensiones específicas de C++/CLI
Las siguientes características de lenguaje, que se describen en esta sección de la documentación, solo se aplican a C++ / CLI.  
