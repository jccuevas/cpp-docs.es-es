...
El **requestedit** atributo de C++ tiene la misma funcionalidad que el [requestedit](http://msdn.microsoft.com/library/windows/desktop/aa367155) atributo MIDL.
