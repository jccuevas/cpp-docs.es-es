...
2.  En el [barra de herramientas del Editor de imágenes](../windows/toolbar-image-editor-for-icons.md), haga clic en la flecha situada a la derecha de la [herramienta aumentar](../windows/toolbar-image-editor-for-icons.md) y seleccione el factor de ampliación desde el submenú: **1 X**, **2 X**, **6 X**, o **8 X**.  
