---
title: Convertir una imagen de un formato a otro (Editor de imágenes para iconos) | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
3.  En el **Guardar archivo como** cuadro de diálogo, en la **nombre de archivo** , escriba el nombre de archivo y la extensión que indica el formato que desee.  
