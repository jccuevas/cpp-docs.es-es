...
1.  Con la tecla **CTRL** presionada, seleccione un control en la [ventana Cuadro de herramientas](../Topic/Toolbox.md).  
  
2.  Suelte la tecla **CTRL** y haga clic en el cuadro de diálogo el número de veces que desee agregar el control concreto.  
