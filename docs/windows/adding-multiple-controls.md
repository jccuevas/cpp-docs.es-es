---
title: Agregar varios controles | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "42589470"
---
# <a name="adding-multiple-controls"></a>Agregar varios controles
...
2. Versión del **Ctrl** clave y haga clic en el cuadro de diálogo tantas veces como desee agregar un control determinado.

3. Presione **Esc** para finalizar la colocación de controles.
