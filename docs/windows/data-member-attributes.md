---
title: Atributos de miembro de datos | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
|---------------|-----------------|  
|[db_accessor](../windows/db-accessor.md)|Grupos de **db_column** atributos que participan en `IAccessor`-basados en el enlace.|  
