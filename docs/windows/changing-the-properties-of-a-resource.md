...
2.  En la [Ventana de propiedades](../Topic/Properties%20Window.md), cambie las propiedades de su recurso.  
  
### Para deshacer los cambios realizados en las propiedades de un recurso  
  
1.  Asegúrese de que el recurso tiene el foco en Vista de recursos.  
  
2.  En el menú **Editar**, elija **Deshacer**.  
