...
- Colocar la imagen al revés.

- Girar la imagen a la derecha 90 grados a la vez.

### <a name="to-flip-the-image-horizontally-mirror-image"></a>La imagen se voltea horizontalmente (imagen reflejada)

1. Desde el **imagen** menú, elija **Voltear horizontalmente**.

### <a name="to-flip-the-image-vertically-turn-upside-down"></a>La imagen se voltea verticalmente (colocar al revés)
