...
Visual C++ se incluye en todas las ediciones de Visual Studio, pero no está instalado de forma predeterminada. Para obtener información sobre cómo instalar Visual Studio y las herramientas de desarrollo de C++, vea [compatibilidad instalar C++ en Visual Studio](../build/vscpp-step-0-installation.md).  
  
Para Windows 8.1 y versiones posteriores, el SDK de DirectX se incluye en el SDK de Windows. No tiene que descargar ningún elemento adicional. Para obtener más información, consulte [donde es el SDK de DirectX?](http://msdn.microsoft.com/library/windows/desktop/ee663275.aspx).  
