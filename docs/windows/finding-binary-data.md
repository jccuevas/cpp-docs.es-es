---
title: Buscar datos binarios (C++) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1. Desde el **editar** menú, haga clic en [encontrar](/visualstudio/ide/reference/find-command).

2. En el **buscar** cuadro, seleccione una cadena de búsqueda anterior en la lista desplegable o escriba los datos que desea buscar.
