 ...
 *calificadores* [opcional]  
 Uno o varios de estos especificadores de clase de almacenamiento: [mutable](../cpp/mutable-data-members-cpp.md), [volátil](../cpp/volatile-cpp.md), [const](../cpp/const-cpp.md), [extern](../cpp/using-extern-to-specify-linkage.md), [estático](../cpp/static-members-cpp.md).  
 ...
 *lista de inicialización* [opcional]  
 Una lista delimitada por comas de valores entre llaves que inicializar los elementos de la matriz. Por ejemplo, si *rango en la lista de tamaño* eran `(3)`, que declara una matriz unidimensional de 3 elementos *lista de inicialización* podría ser `{1,2,3}`.  
 ...
 *rango* [opcional]  
 El número de dimensiones de la matriz. El valor predeterminado es 1; el máximo es 32. Cada dimensión de la matriz es una matriz.  
 ...
 *lista de inicialización* [opcional]  
 Una lista delimitada por comas de valores entre llaves que inicializar los elementos de la matriz. O una lista delimitada por comas de anidado *lista de inicialización* elementos que inicializan los elementos de una matriz multidimensional.  
...
### <a name="remarks"></a>Comentarios  
 ...
 `array` en el [de plataforma, predeterminado y cli de espacios de nombres](../windows/platform-default-and-cli-namespaces-cpp-component-extensions.md) espacio de nombres.  
