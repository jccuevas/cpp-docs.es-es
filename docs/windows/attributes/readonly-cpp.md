---
title: ReadOnly (atributo de COM de C++) | Microsoft Docs
ms.custom: ''
ms.date: 10/02/2018
ms.technology:
- cpp-windows
...
Si desea prohibir la modificación de un parámetro de método, a continuación, utilice el [en](in-cpp.md) atributo.
