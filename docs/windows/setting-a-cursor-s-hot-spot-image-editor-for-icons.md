...
1.  En el [barra de herramientas del Editor de imágenes](../windows/toolbar-image-editor-for-icons.md), haga clic en el **establecer zonas** herramienta.  
  
2.  Haga clic en el píxel que desee designar como zona activa del cursor.  
  
     El **zonas** propiedad en el **propiedades** ventana muestra las nuevas coordenadas.  
