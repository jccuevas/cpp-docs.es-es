---
title: 'CriticalSection:: ~ CriticalSection (destructor) | Documentos de Microsoft'
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="criticalsectioncriticalsection-destructor"></a>CriticalSection::~CriticalSection (Destructor)
