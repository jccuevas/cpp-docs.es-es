...
## <a name="select-foreground-or-background-colors"></a>Seleccionar los colores de primer plano o en segundo plano
...
### <a name="to-select-a-foreground-color"></a>Para seleccionar un color de primer plano:

Con el botón primario del mouse, seleccione el color que desee en el **colores** paleta.

### <a name="to-select-a-background-color"></a>Para seleccionar un color de fondo:

Con el botón secundario del mouse, seleccione el color que desee en el **colores** paleta.

## <a name="filling-a-bounded-area-of-an-image-with-a-color"></a>Llenar un área delimitada de una imagen con un color
...
1. En el **Editor de imágenes** barra de herramientas (o el **imagen** menú, **herramientas** comando), seleccione el **rellenar** herramienta.
...
## <a name="pick-up-a-color-from-an-image-to-use-elsewhere"></a>Elegir un color de una imagen para usar en otro lugar
...
## <a name="choose-a-transparent-or-opaque-background"></a>Elegir un fondo transparente u opaco
...
## <a name="invert-the-colors-in-a-selection"></a>Invertir los colores de una selección
...
## <a name="save-and-load-different-color-palettes"></a>Guardar y cargar diferentes paletas de color
...
## <a name="colors-window"></a>Ventana Colores
...
### <a name="to-display-the-colors-window"></a>Para mostrar la ventana colores

Haga clic en un **Editor de imágenes** panel y elija **Mostrar ventana colores** en el menú contextual.

   \- o -

Seleccione **Mostrar ventana colores** en el [menú imagen](../windows/image-menu-image-editor-for-icons.md).

### <a name="to-hide-the-colors-window"></a>Para ocultar la ventana colores

Desanclar la ventana. Esta acción permitirá que la ventana de ocultación automática cuando no está en uso.

\- o -

Seleccione el **cerrar** botón.
