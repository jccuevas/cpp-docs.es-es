...
### <a name="to-move-a-toolbar-button-c"></a>Para mover un botón de barra de herramientas (C++)

1. En el **barra de herramientas Vista** panel, arrastre el botón que desea mover a su nueva ubicación en la barra de herramientas.
