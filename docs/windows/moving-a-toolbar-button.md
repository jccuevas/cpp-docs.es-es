---
title: Mover un botón de barra de herramientas | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1.  En el **vista de la barra de herramientas** panel, arrastre el botón que desea mover a su nueva ubicación en la barra de herramientas.  
