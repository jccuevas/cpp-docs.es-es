...
1.  En el **Editor de imágenes** barra de herramientas (o el **imagen** menú, **herramientas** comando), haga clic en el **rellenar** herramienta.  
  
2.  Si es necesario, elija los colores de dibujo: en el [paleta de colores](../windows/colors-window-image-editor-for-icons.md), haga clic en el botón primario del mouse para seleccionar un color de primer plano o el botón secundario del mouse para seleccionar un color de fondo.  
  
3.  Mover el **relleno** herramienta para el área que desea rellenar.  
