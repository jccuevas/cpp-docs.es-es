...
El **predeterminada** atributo de C++ tiene la misma funcionalidad que el [predeterminada](/windows/desktop/Midl/default) atributo MIDL. El atributo **default** también se usa con el atributo [case](../windows/case-cpp.md) .
