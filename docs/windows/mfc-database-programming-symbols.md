...
Los símbolos de esta tabla sólo aparecen un proyecto MFC si se ha agregado compatibilidad con bases de datos.  Aceptan la conexión de MFC con servidores SQL y programación de bases de datos.  
...
|AFX\_IDP\_SQL\_NO\_POSITIONED\_ UPDATES|AFX\_SQL\_ERROR\_NO\_ROWS\_AFFECTED|  
