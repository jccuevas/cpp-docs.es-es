...
[Tutorial: Creación de una aplicación para UWP mediante WRL y Media Foundation](walkthrough-creating-a-windows-store-app-using-wrl-and-media-foundation.md)<br/>
