...
1. Haga doble clic en el control. Se abre el editor de texto.

2. Agregue el código de controlador de notificación de control en el editor de texto.
...
3. En el **propiedades** , haga clic en la columna derecha junto al evento para controlar y, a continuación, seleccione el nombre de evento de notificación sugerido (por ejemplo, **OnBnClickedOK** identificadores **BN_CLICKED** ).
