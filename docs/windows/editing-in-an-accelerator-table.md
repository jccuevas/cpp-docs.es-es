---
title: Edición en una tabla de aceleradores | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
3.  Seleccione en el cuadro combinado desplegable o escriba para realizar cambios.  
    ...
    -   Para [identificador](id-property.md), seleccione en la lista o escriba para editar.  
