---
title: Organizar botones de comando a la derecha o inferior de un cuadro de diálogo | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
### <a name="to-arrange-push-buttons-along-the-right-or-bottom-of-a-dialog-box"></a>Para organizar los botones de comando a la derecha o inferior de un cuadro de diálogo  
  
1.  Seleccione uno o varios botones de comando.  
  
2.  Desde el **formato** menú, elija **organizar botones**y, a continuación, elija una de las organizaciones siguientes:  
