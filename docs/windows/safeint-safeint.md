...
### <a name="parameters"></a>Parámetros  
 ...
 U  
 El tipo de datos almacenados en el **SafeInt**. Esto puede ser el tipo de un valor booleano, carácter o entero. Si es un tipo entero, puede ser con o sin signo y tener entre 8 y 64 bits.  
