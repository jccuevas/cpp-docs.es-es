...
Si la cadena de comandos contiene uno o varios parámetros como \[db_column] o \[bindto], **db_command** genera un conjunto de filas y una asignación de descriptor de acceso para atender estas variables enlazadas. Consulte [db_accessor](../windows/db-accessor.md) para obtener más información.
