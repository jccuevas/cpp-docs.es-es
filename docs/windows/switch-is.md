...
## Comentarios  
 el atributo de **switch\_is** C\+\+ tiene la misma funcionalidad que el atributo de [switch\_is](http://msdn.microsoft.com/library/windows/desktop/aa367275) MIDL.  
  
## Ejemplo  
 Vea el ejemplo de [mayúsculas\/minúsculas](../windows/case-cpp.md) para un ejemplo de uso de **switch\_is**.  
