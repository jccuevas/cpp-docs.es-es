...
|[Atributo](../windows/attribute.md)|Permite crear un atributo personalizado.|  
...
|[db\_accessor](../windows/db-accessor.md)|Enlaza las columnas de un conjunto de filas y los enlaza a los mapas correspondientes de descriptor de acceso.|  
|[db\_column](../windows/db-column.md)|Enlaza una columna especificada al conjunto de filas.|  
|[db\_command](../windows/db-command.md)|Ejecuta un comando OLE DB.|  
|[db\_param](../windows/db-param.md)|Asociado a la variable miembro especificada a una entrada o parámetro de salida.|  
|[db\_source](../windows/db-source.md)|Crea y encapsula una conexión, a través de un proveedor, un origen de datos.|  
...
|[emitidl](../windows/emitidl.md)|Determina si todos los atributos siguientes IDL se procesarán y colocados en el archivo generado .idl.|  
...
|[helpstring](../windows/helpstring.md)|Especifica el identificador de un tema de Ayuda en un archivo de .hlp o .chm.|  
...
|[importidl](../windows/importidl.md)|Inserta el archivo especificado .idl en el archivo generado .idl.|  
...
|[rdx](../windows/rdx.md)|Crear o modificar una clave del Registro.|  
...
|[requires\_category](../windows/requires-category.md)|Especifica requería categorías componentes para la clase.|  
...
|[satype](../windows/satype.md)|especifica el tipo de datos de **SAFEARRAY**.|  
...
|[sincronizar](../windows/synchronize.md)|sincroniza el acceso a un método.|  
...
|[version](../windows/version-cpp.md)|Identifica una determinada versión entre varias versiones de una interfaz o una clase.|  
