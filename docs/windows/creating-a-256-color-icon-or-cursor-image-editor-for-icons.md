---
title: Crear un nuevo icono de 256 colores o Cursor (Editor de imágenes para iconos) | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
### <a name="to-create-a-256-color-icon-or-cursor"></a>Para crear un nuevo icono de 256 colores o cursor  
...
2.  En el [cuadro de diálogo Insertar recurso](../windows/add-resource-dialog-box.md), seleccione **icono** o **Cursor** y haga clic en **nuevo**.  
...
## <a name="see-also"></a>Vea también  
 [Utilizar la paleta de 256 colores](../windows/using-the-256-color-palette-image-editor-for-icons.md)   
