...
ms.locfileid: "55764082"
---
# <a name="how-to-include-resources-at-compile-time"></a>Filtrar Incluir recursos en tiempo de compilación
...
## <a name="to-specify-include-directories-for-a-specific-resource-rc-file-c"></a>Para especificar directorios de inclusión para un recurso específico (archivo .rc) (C++)
