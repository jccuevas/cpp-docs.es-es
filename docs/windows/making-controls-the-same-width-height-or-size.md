...
### <a name="to-make-controls-the-same-width-height-or-size"></a>Para hacer que controla el mismo ancho, alto o el tamaño  
  
1.  [Seleccione los controles](../windows/selecting-multiple-controls.md) desee cambiar.  
  
     El control seleccionado en primer lugar en la serie es el control dominante. El tamaño final de los controles en el grupo depende del tamaño del control dominante. Para obtener más información sobre cómo seleccionar el control dominante, vea [especificar el Control dominante](../windows/specifying-the-dominant-control.md).  
