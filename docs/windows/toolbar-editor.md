...
-   [Crear nuevos botones y barras de herramientas](../mfc/creating-new-toolbars.md)  
  
-   [Convertir mapas de bits a recursos de la barra de herramientas](../mfc/converting-bitmaps-to-toolbars.md)  
  
-   [Crear, mover y editar botones de la barra de herramientas](../mfc/creating-moving-and-editing-toolbar-buttons.md)  
  
-   [Crear información sobre herramientas](../mfc/creating-a-tool-tip-for-a-toolbar-button.md)  
