...
El **barra de herramientas** editor le permite:
...
### <a name="to-create-move-and-edit-toolbar-buttons"></a>Para crear, mover y editar botones de barra de herramientas
