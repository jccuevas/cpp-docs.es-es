---
title: Buscar una entrada en una tabla de aceleradores | Documentos de Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2.  Haga clic en un encabezado de columna para ordenar alfabéticamente su contenido. Por ejemplo, haga clic en **identificador** para mostrar alfabéticamente todos los identificadores de la tabla de aceleradores.  
