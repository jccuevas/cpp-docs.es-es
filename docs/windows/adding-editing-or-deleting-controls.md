---
title: Agregar, editar o eliminar controles | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
- [Tamaño de un control al agregarlo](sizing-a-control-while-you-add-it.md)
...
[Adición de controladores de eventos para controles de cuadros de diálogo](adding-event-handlers-for-dialog-box-controls.md)<br/>
