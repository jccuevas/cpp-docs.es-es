...
| &nbsp;&nbsp;[`N1653 C99 preprocessor`](https://wg21.link/N1653) | Parcialmente <sup>[C](#note_C)</sup> |
...
__VS 2019 16.6__ indica las características que se admiten en Visual Studio 2019, versión 16.6.
...
<a name="note_D"></a>__G__ Compatible con [`/std:c++14`](../build/reference/std-specify-language-standard-version.md) con una advertencia que se puede suprimir, [`C4984`](../error-messages/compiler-warnings/compiler-warning-c4984.md).
